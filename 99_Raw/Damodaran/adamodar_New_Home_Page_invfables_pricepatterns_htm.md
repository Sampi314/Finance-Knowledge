...
**Source:** https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm
...
There were 18 runs in this price series of 33 periods. The actual number of runs in the price series is compared against the number that can be expected[\[4\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftn4)
 in a series of this length, assuming that price changes are random. If the actual number of runs is greater than the expected number, there is evidence of negative correlation in price changes. If it is lower, there is evidence of positive correlation. A study of price changes in the Dow 30 stocks, assuming daily, four-day, nine-day and sixteen day return intervals provided the following results -
...
            While most of the earlier studies of price behavior focused on shorter return intervals, more attention has been paid to price movements over longer periods (six months to five-year) in recent years. Here, there is an interesting dichotomy in the results. When long term is defined as months rather than years, there seems to be a tendency towards positive serial correlation. Jegadeesh and Titman present evidence of what they call “price momentum” in stock prices over time periods of up to eight months – stocks that have gone up in the last six months tend to continue to go up whereas stocks that have gone down in the last six months tend to continue to go down. The momentum effect is just as strong in the European markets, though it seems to be weaker in emerging markets.[\[5\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftn5)
 What may cause this momentum? One potential explanation is that mutual funds are more likely to buy past winners and dump past losers, thus generating price continuity.[\[6\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftn6)
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns_files/image003.gif)
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns_files/image006.gif)
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns_files/image015.gif)The returns on Mondays are significantly negative, whereas the returns on every day of the week are not.  In addition, returns on Mondays are negative more often than returns on any other trading day. There are a number of other findings on the Monday effect that researchers have fleshed out.
...
*   Monday returns are more likely to be negative if the returns on the previous Friday were negative. In fact, Monday returns are, on average, positive following positive Friday returns, and are negative 80% of the time following negative Friday returns.[\[11\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftn11)
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns_files/image018.gif)The returns on Monday are lower than returns on other days of the week for every international market examined. The presence of a strong weekend effect in Japan, which allowed Saturday trading for a portion of the period studies here indicates that there might be a more direct reason for negative returns on Mondays than bad information over the weekend.
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns_files/image021.gif)

In fact, the returns on the first trading day after a holiday tend to be much more positive than returns on other trading days.[\[12\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftn12)
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns_files/image024.gif)
...
[\[1\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref1)
 Alexander (1964), Cootner (1962)and Fama (1965) all estimated serial correlation in stock prices. Given the difficulty of obtaining data, they worked with small samples over short periods.

[\[2\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref2)
 Roll (1984) provides a simple measure of this relationship,
...
[\[3\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref3)
 See “Volume and Autocovariances in Short-Horizon Individual Security Returns”, Conrad, Hameed and Niden, in Journal of Finance, 1994.

[\[4\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref4)
 There are statistical tables that summarize the expected number of runs, assuming randomness, in a series of any length.

[\[5\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref5)
 Rouwenhorst (1997) studied 12 European markets and finds evidence of momentum in each market. In 1999, he presented evidence of momentum in emerging markets. Another paper by Bekaert, Erb, Harvey and Viskanta (1997) finds that momentum investing is not consistently profitable in emerging markets.

[\[6\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref6)
 Grinblatt, Titman and Wermers (1995) present evidence that is consistent with this explanation.

[\[7\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref7)
 This finding is from Haugen, R. and J. Lakonishok, The Incredible January Effect, Dow-Jones Irwin.

[\[8\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref8)
 It is to prevent this type of trading that the internal revenue service has a “wash sale rule” that prevent you from ~Since wash sales rules would prevent an investor from~ selling and buying back the same stock within 45 days. To get around this rule,~,~ there has to be some substitution among the stocks. Thus investor 1 sells stock A and investor 2 sells stock B, but when it comes time to buy back the stock, investor 1 buys stock B and investor 2 buys stock A.

[\[9\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref9)
 Insti~i~tutional buying drops off in the last 10 days of the calendar year, and picks up again in ~teh~the first 10 days of ~teh~the next calendar year.

[\[10\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref10)
 This is also from Haugen, R. and j. Lakonishok, The Incredible January Effect, Dow Jones Irwin.

[\[11\]](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref11)
 See “The Individual Investor and the Weekend Effect”, Abraham and Ikenberry, Journal of Financial and Quantitative Analysis.

[](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/invfables/pricepatterns.htm#_ftnref12)