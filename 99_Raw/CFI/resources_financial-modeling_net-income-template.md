...
**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/net-income-template
...
Below is a screenshot of the net income template:

![Net Income Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/00270-Net-Income-Example.png)
...
Net income is the amount of accounting profit a company has left over after paying off all its expenses. Net income is found by taking [sales revenue](https://corporatefinanceinstitute.com/resources/accounting/sales-revenue/)
 and subtracting [COGS,](https://corporatefinanceinstitute.com/resources/accounting/cost-of-goods-sold-cogs/)
 [SG&A](https://corporatefinanceinstitute.com/resources/accounting/what-is-sga/)
, depreciation and amortization, [interest expense](https://corporatefinanceinstitute.com/resources/accounting/interest-expense/)
, taxes, and any other expenses.

Net income is the last line item on the [income statement](https://corporatefinanceinstitute.com/resources/knowledge/accounting/income-statement/)
. Some income statements, however, will have a separate section at the bottom reconciling beginning [retained earnings](https://corporatefinanceinstitute.com/resources/accounting/retained-earnings-guide/)
 with ending retained earnings through net income and [dividends](https://corporatefinanceinstitute.com/resources/accounting/dividend-per-share/)
.

The net income is very important in that it is a central line item to all [three financial statements](https://corporatefinanceinstitute.com/resources/accounting/three-financial-statements/)
. While it is arrived at through the income statement, the net profit is also used in both the [balance sheet](https://corporatefinanceinstitute.com/resources/accounting/balance-sheet/)
 and the [cash flow statement](https://corporatefinanceinstitute.com/resources/accounting/statement-of-cash-flows/)
.
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnet-income-template%2F&summary=Net+Income+Template "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnet-income-template%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Net+Income+Template&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnet-income-template%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnet-income-template%2F&summary=Net+Income+Template "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/net-income-template/ "Copy link")
