# Inventory Turnover Calculator - Download Free Excel Template

**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/inventory-turnover-calculator
...
Download our inventory turnover calculator
...
This [inventory turnover](https://corporatefinanceinstitute.com/resources/accounting/inventory-turnover/)
 calculator will help you calculate the number of times a business sells and replaces its stock of products within a set period.

Below is a preview of CFI’s inventory turnover calculator:

![Inventory Turnover Calculator Preview](https://cdn.corporatefinanceinstitute.com/assets/inventory-turnover-calculator-excel1.png)

### Download the Free Template

   Download NowDownload Now

### Calculating and Using Inventory Turnover

The [inventory turnover ratio](https://corporatefinanceinstitute.com/resources/accounting/inventory-turnover-ratio/)
 is calculated using the formula below. CFI’s inventory turnover calculator pulls data from a sample financial statement and uses this formula to calculate the ratio.

![Inventory Turnover Ratio Formula](https://cdn.corporatefinanceinstitute.com/assets/inventory-turnover-ratio.png)

The inventory turnover ratio is an important measure in financial modeling. The inventory turnover ratio can be manipulated to give [inventory turnover days](https://corporatefinanceinstitute.com/resources/accounting/days-of-inventory-on-hand-doh/)
 instead. This is done by taking the inverse of the ratio and multiplying it by the number of days in the time period.

For example, take the following information:

*   **Cost of Goods Sold**: $300,000
*   **Average Inventory:** $60,000
*   **\# of Days in Period:** 365

With this, we calculate 60,000/300,000\*365 = 73 days. This means that on average, it takes 73 days for the company to sell an entire stock of inventory. However, an alternative use is that we can make assumptions on inventory turnover days to forecast future [inventory](https://corporatefinanceinstitute.com/resources/accounting/inventory/)
.

For example, consider a company who consistently has inventory turnover days of around 62. This company has no plans to expand warehouse operations. Thus, it is relatively safe to assume that inventory held will not change and that inventory turnover days will remain constant into the future. Using the forecast numbers, we can manipulate the formula into **Average Inventory = Inventory Turnover Days\*[Cost of Goods Sold](https://corporatefinanceinstitute.com/resources/accounting/cost-of-goods-sold-cogs/)
/365**. This would allow us to calculate the average inventory and thus the inventory for the forecast year.

Additionally, by knowing how quickly this company sells a stock of inventory, we can assess how well it meets market [demand](https://corporatefinanceinstitute.com/resources/economics/supply-demand/)
 and how its sales compare to other companies. A higher inventory turnover ratio (or lower inventory days) shows efficiency in sales and cost savings from holding lower levels of inventory.
...
*   [Excel Modeling Templates](https://corporatefinanceinstitute.com/topic/financial-modeling/)
    
*   [PowerPoint Presentation Templates](https://corporatefinanceinstitute.com/topic/valuation/)
    
*   [Transaction Document Templates](https://corporatefinanceinstitute.com/resources/)
...
[![Financial Analyst certification curriculum](https://corporatefinanceinstitute.com/resources/financial-modeling/inventory-turnover-calculator)](https://corporatefinanceinstitute.com/certifications/financial-modeling-valuation-analyst-fmva-program/)
...
[![Excel Course](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 116 25.5938" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/course/excel-fundamentals-formulas-for-finance/)
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Finventory-turnover-calculator%2F&summary=Inventory+Turnover+Calculator "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Finventory-turnover-calculator%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Inventory+Turnover+Calculator&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Finventory-turnover-calculator%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Finventory-turnover-calculator%2F&summary=Inventory+Turnover+Calculator "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/inventory-turnover-calculator/ "Copy link")
