# Gantt Chart Template - Download Free Excel Template

**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/gantt-chart-template
...
This Gantt chart template will help you use Excel to build a project schedule using a bar chart.

Below is a screenshot of the Gantt chart template:

![Gantt Chart Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/00517-Gantt-Chart-Template.png)
...
The Gantt Chart is a type of a bar chart used to depict a [project schedule](https://corporatefinanceinstitute.com/resources/commercial-lending/project-finance-primer/)
. The Gantt Chart is a powerful project management tool that illustrates the start and finish dates of [project elements](https://corporatefinanceinstitute.com/resources/financial-modeling/resources/knowledge/other/project-budget-overview/)
, as well as the sequence and dependencies between project elements. The chart provides project managers with the opportunity to monitor and manage tasks and resources in a project, as well as the opportunity to check whether the project remains on the track.

### Elements of a Gantt Chart

To use a Gantt Chart effectively, you must know the key elements of this type of chart.

*   **Tasks and sub-tasks** are listed on the left side
*   **Dates** are located at the top
*   **Bars** represent the length of each task and sub-task
*   **Milestones** are the tasks crucial to a project’s success and are represented as diamonds on the chart
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fgantt-chart-template%2F&summary=Gantt+Chart+Template "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fgantt-chart-template%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Gantt+Chart+Template&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fgantt-chart-template%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fgantt-chart-template%2F&summary=Gantt+Chart+Template "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/gantt-chart-template/ "Copy link")
