# Unlevered Cost of Capital Template - Download Free Template

**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/unlevered-cost-of-capital-template
...
This unlevered cost of capital template shows you how to compute the unlevered cost of capital given the risk-free rate, unlevered beta, and expected market return.

Below is a screenshot of the unlevered cost of capital template:

![Unlevered Cost of Capital Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/00227-Unlevered-Cost-of-Capital-Template.png)
...
The unlevered cost of capital is the implied rate of return a company expects to earn on its assets, without the effect of debt.

A company that wants to undertake a project will have to allocate capital or money for it. Theoretically, the capital could be generated either through debt or through equity. The [weighted average cost of capital (WACC)](https://corporatefinanceinstitute.com/resources/valuation/what-is-wacc-formula/)
 assumes the company’s current capital structure is used for the analysis, while the unlevered cost of capital assumes the company is 100% equity financed.
