# Cash Ratio - Definition, Free Download, Template

**Source:** https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula
...
The cash ratio, sometimes referred to as the cash asset ratio, is a liquidity metric that indicates a company’s capacity to pay off [short-term debt obligations](https://corporatefinanceinstitute.com/resources/accounting/current-liabilities/)
 with its cash and cash equivalents. Compared to other liquidity ratios such as the [current ratio](https://corporatefinanceinstitute.com/resources/accounting/current-ratio-formula/)
 and [quick ratio](https://corporatefinanceinstitute.com/resources/accounting/quick-ratio-definition/)
...
![Cash Ratio - Wads of US Dollars](https://cdn.corporatefinanceinstitute.com/assets/cash-ratio.jpg)

### Formula

The formula for calculating the cash ratio is as follows:

![Cash Ratio Formula](https://cdn.corporatefinanceinstitute.com/assets/cash-ratio1.png)

Where:

*   **Cash** includes [legal tender](https://en.wikipedia.org/wiki/Legal_tender)
     (coins and currency) and demand deposits (checks, checking account, bank drafts, etc.).
*   **Cash equivalents** are assets that can be converted into cash quickly. [Cash equivalents](https://corporatefinanceinstitute.com/resources/accounting/cash-equivalents/)
     are readily convertible and subject to insignificant risk. Examples include savings accounts, [T-bills](https://corporatefinanceinstitute.com/resources/fixed-income/treasury-bills-t-bills/)
    , and money market instruments.
*   **Current liabilities** are obligations due within one year. Examples include short-term debt, [accounts payable](https://corporatefinanceinstitute.com/resources/accounting/what-is-accounts-payable/)
...
![Example of Cash Ratio Calculation ](https://cdn.corporatefinanceinstitute.com/assets/cash-ratio2.png)
...
![Cash Ratio Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/01226-Cash-Ratio-Template.png)

### Download the Free Template

Enter your name and email in the form below and download the free ratio template now!
...
The cash ratio indicates to creditors, analysts, and investors the percentage of a company’s current liabilities that [cash](https://corporatefinanceinstitute.com/resources/accounting/cash-money/)
 and cash equivalents will cover. A ratio above 1 means that a company will be able to pay off its current liabilities with cash and cash equivalents, and have funds left over.
...
*   [Acid-Test Ratio](https://corporatefinanceinstitute.com/resources/accounting/acid-test-ratio/)
    
*   [Cash Ratio Template](https://corporatefinanceinstitute.com/resources/financial-modeling/cash-ratio-template/)
...
*   [Guide to Financial Modeling](https://corporatefinanceinstitute.com/resources/financial-modeling/what-is-financial-modeling/)
...
[![Financial Analyst certification curriculum](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)](https://corporatefinanceinstitute.com/certifications/financial-modeling-valuation-analyst-fmva-program/)
...
*   Share this article
*   [![Share on LinkedIn](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Faccounting%2Fcash-ratio-formula%2F&summary=Cash+Ratio "Share on LinkedIn")
    
*   [![Share on Facebook](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Faccounting%2Fcash-ratio-formula%2F "Share on Facebook")
    
*   [![Share on Twitter](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)](https://twitter.com/intent/tweet?text=Cash+Ratio&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Faccounting%2Fcash-ratio-formula%2F "Share on Twitter")
    
*   [![Share on WhatsApp](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Faccounting%2Fcash-ratio-formula%2F&summary=Cash+Ratio "Share on WhatsApp")
    
*   [![Copy link](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/ "Copy link")
...
Popular Courses
 ...
 [![Excel Fundamentals - Formulas for Finance](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)BIDA Prep Course 2h 14min Excel Fundamentals - Formulas for Finance](https://corporatefinanceinstitute.com/course/excel-fundamentals-formulas-for-finance/)

 [![3-Statement Modeling](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)FMVA Required 3h 15min 3-Statement Modeling](https://corporatefinanceinstitute.com/course/3-statement-modeling/)

 [![Introduction to Business Valuation](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)FMVA Required 3h 9min Introduction to Business Valuation](https://corporatefinanceinstitute.com/course/intro-business-valuation/)

 [![Scenario & Sensitivity Analysis in Excel](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)FMVA Required 49min Scenario & Sensitivity Analysis in Excel](https://corporatefinanceinstitute.com/course/sensitivity-analysis-financial-modeling/)

 [![Excel Data Visualization and Dashboards](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)FMVA Required 1h 32min Excel Data Visualization and Dashboards](https://corporatefinanceinstitute.com/course/dashboards-and-data-visualization/)

 [![Leveraged Buyout (LBO) Modeling](https://corporatefinanceinstitute.com/resources/accounting/cash-ratio-formula/)4h 33min Leveraged Buyout (LBO) Modeling](https://corporatefinanceinstitute.com/course/leveraged-buyout-lbo-modeling/)
