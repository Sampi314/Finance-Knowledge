...
**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/net-present-value-template
...
![Net Present Value Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/00889-Net-Present-Value.png)
...
Net Present Value (NPV) is the value of all future [cash flows](https://corporatefinanceinstitute.com/resources/accounting/statement-of-cash-flows/)
 (positive and negative) over the entire life of an investment discounted to the present. NPV analysis is a form of intrinsic valuation and is used extensively across [finance](https://corporatefinanceinstitute.com/resources/fpa/corporate-finance-industry/)
 and accounting for determining the value of a business, investment security, capital project, new venture, cost reduction program, and anything that involves cash flow.

The formula for Net Present Value is:

![Net Present Value (NPV) Formula](https://cdn.corporatefinanceinstitute.com/assets/net-present-value3.png)
...
NPV analysis is used to help determine how much an investment, project, or any series of cash flows is worth. It is an all-encompassing metric, as it takes into account all [revenues](https://corporatefinanceinstitute.com/resources/accounting/sales-revenue/)
, expenses, and capital costs associated with an investment in its [Free Cash Flow (FCF)](https://corporatefinanceinstitute.com/resources/valuation/what-is-free-cash-flow-fcf/)
.

### More Free Templates

Thank you for reading CFI’s guide to the Net Present Value Template. For more resources, check out our business templates library to download numerous free Excel modeling, PowerPoint presentations, and Word document templates.
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnet-present-value-template%2F&summary=Net+Present+Value+Template "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnet-present-value-template%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Net+Present+Value+Template&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnet-present-value-template%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnet-present-value-template%2F&summary=Net+Present+Value+Template "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/net-present-value-template/ "Copy link")
