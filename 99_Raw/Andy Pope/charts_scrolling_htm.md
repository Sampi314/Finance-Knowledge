...
**Source:** https://www.andypope.info/charts/scrolling.htm
...
|     |     |
| --- | --- |
|     | ![](https://www.andypope.info/charts/scroller.gif)<br>-------------------------------------------------- |
|     | ##### The chart uses Named Ranges to define the data to be included in the chart. The scroller allows the user to dynamically change the chart.<br><br>##### The [workbook](https://www.andypope.info/charts/scroller.zip)<br> contains an explanation on how to construct the chart. |
|     |     |

    
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/charts/scroller.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/charts/scrolling.htm#Top "Return to top of page")
