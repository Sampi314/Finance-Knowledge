...
**Source:** https://www.andypope.info/ngs/ng16.htm
...
|     |     |
| --- | --- |
|     | Re: Macro to Add Labels to Points in XY (Scatter) or Bubble Charts<br>------------------------------------------------------------------<br><br>![](https://www.andypope.info/ngs/msgraph_xy.gif)<br>------------------------------------------------- |
|     | ##### The [PowerPoint](https://www.andypope.info/ngs/xylabeller.zip)<br> file contains an 4 example MS Graphs demonstrating how to set data labels to text stored on the Datasheet.  <br>You can use a series on markers to change the position of the data label whilst updating it. |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng16.htm#Top "Return to top of page")
