...
**Source:** https://www.andypope.info/ngs/ng64.htm
...
|     |     |
| --- | --- |
|     | ![Animated column chart](https://www.andypope.info/ngs/animate_columns.png) |
|     | ##### With the file downloaded and opened with macros enabled you can click on the 5 buttons at the top to animate between different data sets.  <br>The dropdown control will highlight the selected country.  <br><br>![animated detail chart](https://www.andypope.info/ngs/animated_detailchart.png)<br><br>##### You can click any country to see a detailed chart. You can change the selected country while the chart is visible by simply clicking another country.  <br><br>##### Oxfam\_GoodEnough\_onsheet.xlsm [![](https://www.andypope.info/Images/download.gif)](https://www.andypope.info/ngs/Oxfam_GoodEnough_onsheet.xlsm)<br> (232kb) |
|     |
|     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng64.htm#Top "Return to top of page")
