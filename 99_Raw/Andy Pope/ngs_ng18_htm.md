...
**Source:** https://www.andypope.info/ngs/ng18.htm
...
|     |     |
| --- | --- |
|     | Re: single out x-axis value<br>---------------------------<br><br>![](https://www.andypope.info/ngs/customnumber.gif)<br>--------------------------------------------------- |
|     | ##### The example [workbook](https://www.andypope.info/ngs/customformat.zip)<br> uses customer number formats to colour a single item in the x axis. |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng18.htm#Top "Return to top of page")
