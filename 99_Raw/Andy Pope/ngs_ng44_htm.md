...
**Source:** https://www.andypope.info/ngs/ng44.htm
...
| --- | --- |
|     | RE: Soft edges<br>-------------- |     |
|     | ##### To create the appearance of soft edges around an inserted image you could use 4 gradient filled rectangles.  <br>In this example to blend with a white background I used a fill going from white to white with 100% transparency.<br><br>![](https://www.andypope.info/ngs/ng44a.gif)![](https://www.andypope.info/ngs/ng44b.gif)<br><br>##### Here you can see the before and after effect. I deliberately kept the left hand sides border so you can see how it is positioned.  <br>  <br>Note: This will only work in PowerPoint 2002 and above as Transparency was not available in PPT 2000. |     |
| ##### Here is an example rectangle with 2 colour gradient.  <br>This uses the colours black and white. | ![](https://www.andypope.info/ngs/ng44c.gif) |
|     |     |     |
| ##### This shows the format settings for the fill effect. | ![](https://www.andypope.info/ngs/ng44d.gif) |
|     |     |
|     |     |
|     |     |
|     |     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng44.htm#Top "Return to top of page")
