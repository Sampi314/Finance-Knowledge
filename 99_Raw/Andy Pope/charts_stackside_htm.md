...
**Source:** https://www.andypope.info/charts/stackside.htm
...
|     |     |
| --- | --- |
|     | [![Stacked side by side chart](https://www.andypope.info/charts/stackedside.jpg)](https://www.andypope.info/charts/stackedsidebyside.zip)<br><br>------------------------------------------------------------------------------------------------------------------------------------------ |
|     | ##### The [download](https://www.andypope.info/charts/stackedsidebyside.zip)<br> contains a step by step example of how to create side by side stacked column chart.<br><br>##### I have added an additional example to this chart for use with xl97.  <br>The built-in formatting of the category labels is not as smart as it is in xl2000. The xl97 version requires the use of dummy series data labels to hold the month names under and between department names. |
|     |     |

    
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/charts/stackedsidebyside.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/charts/stackside.htm#Top "Return to top of page")
