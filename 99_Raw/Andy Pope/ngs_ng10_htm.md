...
**Source:** https://www.andypope.info/ngs/ng10.htm
...
|     |     |
| --- | --- |
|     | Re: XY Line Chart<br>-----------------<br><br>![](https://www.andypope.info/ngs/linedirection.GIF)<br>---------------------------------------------------- |
|     | ##### The [workbook](https://www.andypope.info/ngs/line_direction.zip)<br> contains example chart a code for adding directional arrows to a xy scatter chart.<br><br>##### The arrows are created using an auto-shape. The shape is then rotated and used as the customer marker for an additional dummy data series. Currently the dummy data series plots the mid point. |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng10.htm#Top "Return to top of page")
