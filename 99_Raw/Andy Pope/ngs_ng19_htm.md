...
**Source:** https://www.andypope.info/ngs/ng19.htm
...
|     |     |
| --- | --- |
|     | Re: How do I re-position chart data labels?<br>-------------------------------------------<br><br>![](https://www.andypope.info/ngs/afteralign.GIF) |
|     | ##### The example [workbook](https://www.andypope.info/ngs/align3dlabels.zip)<br> has a routine to center data labels between the base line and there current position. It will work for all 3D clustered bar and column chart types, including cylinders, cones and pyramids. |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng19.htm#Top "Return to top of page")
