...
**Source:** https://www.andypope.info/ngs/ng17.htm
...
|     |     |
| --- | --- |
|     | Re: End label only<br>------------------<br><br>![](https://www.andypope.info/ngs/lastpoint.gif)<br>------------------------------------------------ |
|     | ##### The example [workbook](https://www.andypope.info/ngs/lastpoint.zip)<br> uses an additional data series to plot the value of the last point only. |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng17.htm#Top "Return to top of page")
