...
**Source:** https://www.andypope.info/vba/whatsthishelp.htm
...
|     |     |
| --- | --- |
|     | ![](https://www.andypope.info/vba/whatthishelp.jpg)<br>--------------------------------------------------- |
|     | ##### The [download](https://www.andypope.info/vba/whatsthishelp.zip)<br> contains a demonstration of how to mimic What's This Help.  <br>I have written a class to handle the help and help text.  <br>  <br>All the code is available for view.<br><br>##### I have updated the code to allow for selection of controls within frames.  <br>The tip text is now displayed in relation to the cursor click rather than at the bottom of the control. By using the frame I can display the information above all controls. |
|     |     |
|     |

    
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/vba/whatsthishelp.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/vba/whatsthishelp.htm#Top "Return to top of page")
