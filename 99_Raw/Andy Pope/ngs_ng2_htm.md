...
**Source:** https://www.andypope.info/ngs/ng2.htm
...
|     |     |
| --- | --- |
|     | Re: conditional chart formatting: specific colors<br>-------------------------------------------------<br><br>[![](https://www.andypope.info/ngs/trafficlight.jpg)](https://www.andypope.info/charts/trafficlight.zip)<br><br>--------------------------------------------------------------------------------------------------------- |
|     | ##### This traffic light chart is based on a bubble chart  <br>  <br>The colour displayed is based upon cell formula.  <br>  <br>The [download](https://www.andypope.info/charts/trafficlight.zip)<br> includes the example also another version of a single stop based around a pie chart. There is explanation in the workbook. |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng2.htm#Top "Return to top of page")
