...
**Source:** https://www.andypope.info/ngs/ng14.htm
...
|     |     |
| --- | --- |
|     | Re: Connector lines from chart labels to chart point<br>----------------------------------------------------<br><br>![](https://www.andypope.info/ngs/leaderlines.GIF)<br>-------------------------------------------------- |
|     | ##### The [workbook](https://www.andypope.info/ngs/leaderlines.zip)<br> contains an example chart.  <br>Lines a created using custom X and Y Error bars |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng14.htm#Top "Return to top of page")
