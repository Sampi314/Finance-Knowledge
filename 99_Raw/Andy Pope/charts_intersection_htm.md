...
**Source:** https://www.andypope.info/charts/intersection.htm
...
### Complex Line Intersection

 

|     |     |
| --- | --- |
|     | [![Complex line intersection](https://www.andypope.info/charts/intersection_ss.gif)](https://www.andypope.info/charts/intersection.zip)<br><br>---------------------------------------------------------------------------------------------------------------------------------------- |
|     | ##### This chart shows the intersection points of 2 lines.  <br>The Intersections series is the result of a user defined function.  <br>  <br>The [download](https://www.andypope.info/charts/intersection.zip)<br> illustrates the use of the functions and the layout of the series data. |
|     |     |

    
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/charts/intersection.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/charts/intersection.htm#Top "Return to top of page")
