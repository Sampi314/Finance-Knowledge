...
**Source:** https://www.andypope.info/tips/tip010.htm
...
### Installing Add-Ins 2007 ![](https://www.andypope.info/Images/xl2007.bmp)

To install an Add-In in Excel 2007 you need to click the Office button ![](https://www.andypope.info/Images/officepearl.jpg) and press the Excel Options button.

![](https://www.andypope.info/tips/tip010a.bmp)

From the options dialog select the Add-In section. Select Excel-Add-ins from the Manage drop list and then press the Go... button

![](https://www.andypope.info/tips/tip010b.bmp)

From the Add-Ins dialog you can use the browse button to locate the add-in you wish to install.

![](https://www.andypope.info/tips/tip010c.bmp)  
To uninstall an add-in simply uncheck the appropriate add-in within the list.

Created 6th October 2007
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/tips/tip010.htm#Top "Return to top of page")
