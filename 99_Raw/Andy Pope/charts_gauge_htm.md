...
**Source:** https://www.andypope.info/charts/gauge.htm
...
|     |     |
| --- | --- |
|     | [![Gauge chart](https://www.andypope.info/charts/gauge.gif)](https://www.andypope.info/charts/gauge.zip)<br><br>--------------------------------------------------------------------------------------------------------- |
|     | ##### This gauge chart is constructed on an XY Scatter chart. The dial, numbers and needle positions are calculated using some simple math functions.  <br>The dial number labels are linked to text values.  <br>The [download](https://www.andypope.info/charts/gauge.zip)<br> also includes a variations which will allow for the construction of a dashboard effect.<br><br>##### The workbook has been updated to include a step by step example of how to build the gauge. |
|     |     |

    
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/charts/gauge.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/charts/gauge.htm#Top "Return to top of page")
