...
**Source:** https://www.andypope.info/charts/colwidth.htm
...
|     |     |
| --- | --- |
|     | ![](https://www.andypope.info/charts/colwidth.GIF) |
|     | ##### The column chart has bars of varying width. The effect is achieved using Error bars.<br><br>##### With some additional data it is possible to add colour.<br><br>![](https://www.andypope.info/charts/colwidth2.GIF)<br><br>##### The [workbook](https://www.andypope.info/charts/columnwidths.zip)<br> contains a step by step explanation of the chart construction. |

  
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/charts/columnwidths.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/charts/colwidth.htm#Top "Return to top of page")
