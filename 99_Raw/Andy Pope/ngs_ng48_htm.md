...
**Source:** https://www.andypope.info/ngs/ng48.htm
...
|     |     |
| --- | --- |
|     | RE: replace axis text with graphics on excel chart (excel 2003)<br>--------------------------------------------------------------- |
|     | ##### You can use additional data series plotted as xy scatter. The data label then displays the series name formatted in Wingdings font.![](https://www.andypope.info/ngs/ng48.gif)<br><br>  <br>Here is a  [example](https://www.andypope.info/ngs/ng48.zip) |
|     |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng48.htm#Top "Return to top of page")
