...
**Source:** https://www.andypope.info/fun/pointinarea.htm
...
|     |     |
| --- | --- |
|     | ![](https://www.andypope.info/fun/pointinarea.gif)<br>-------------------------------------------------- |
|     | ##### The [workbook](https://www.andypope.info/fun/pointinarea.zip)<br> contains 3 user defined functions for determining whether a given point is within a Circle, Triangle or polygon.  <br>  <br>I have update the file with a new udf, kindy provided by fellow MVP Rick Rothstein, for caluclating point in polygon.  <br>  <br>The zip file also includes a version in xlsm format. |

    
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/fun/pointinarea.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/fun/pointinarea.htm#Top "Return to top of page")
