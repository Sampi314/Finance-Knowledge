...
**Source:** https://www.andypope.info/fun/jawbreak.htm
...
![](https://www.andypope.info/fun/jawbreak.gif)  
The idea is to get the highest score by creating chains of the same coloured marbles.  
The more marbles in your chain the higher the score.  
  
Click a marble and all adjacent marbles will be selected  
Click again and the marbles will be removed and your score incremented accordingly.  
Double clicking a marble will automatically remove any adjacent marbles  
  
Select another coloured marble to clear the current selection  
  
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/fun/jawbreak.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/fun/jawbreak.htm#Top "Return to top of page")
