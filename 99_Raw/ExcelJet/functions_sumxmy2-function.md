...
**Source:** https://exceljet.net/functions/sumxmy2-function

---

[Skip to main content](https://exceljet.net/functions/sumxmy2-function#main-content)

[](https://exceljet.net/functions/sumxmy2-function#)

*   [Previous](https://exceljet.net/functions/sumx2py2-function)
    
*   [Next](https://exceljet.net/functions/trunc-function)
...
![Excel SUMXMY2 function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet%20sumxmy2.png "Excel SUMXMY2 function")
...
The Excel SUMXMY2 function returns the sum of squares of differences between corresponding values in two arrays. The "m" in the function name stands for "minus", as in "sum x _minus_ y squared". 

SUMXMY2 takes two [arguments](https://exceljet.net/glossary/function-argument)
...
*   [Microsoft SUMXMY2 function documentation](https://support.office.com/en-us/article/sumxmy2-function-9d144ac1-4d79-43de-b524-e2ecee23b299)
