# Excel COUPDAYS function | Exceljet

**Source:** https://exceljet.net/functions/coupdays-function

---

[Skip to main content](https://exceljet.net/functions/coupdays-function#main-content)

[](https://exceljet.net/functions/coupdays-function#)

*   [Previous](https://exceljet.net/functions/coupdaybs-function)
    
*   [Next](https://exceljet.net/functions/coupdaysnc-function)
...
![Excel COUPDAYS function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_coupdays_function2.png "Excel COUPDAYS function")
...
The settlement date is the date the investor takes possession of a security. The maturity date is the date when the investment ends and the principle plus accrued interest is returned to the investor.  The _frequency_ is the number of interest payments per year. In the example shown, the formula in F4 is:

    =COUPDAYS(C6,C7,C10,C11)
    

COUPDAYS returns an integer, so use a [number format](https://exceljet.net/articles/custom-number-formats)
...
. Below is the formula in F4 reworked with hardcoded values and the DATE function:
...
The _basis_ argument controls how days are counted. The COUPDAYS function allows 5 options (0-4) and defaults to zero, which specifies US 30/360 _basis_. This [article on wikipedia](https://en.wikipedia.org/wiki/Day_count_convention)
...
*   If _basis_ is out-of-range , COUPDAYS returns #NUM!
...
*   [Microsoft COUPDAYS function documentation](https://support.office.com/en-us/article/coupdays-function-cc64380b-315b-4e7b-950c-b30b0a76f671)
