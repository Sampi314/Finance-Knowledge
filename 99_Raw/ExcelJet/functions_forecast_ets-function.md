...
**Source:** https://exceljet.net/functions/forecast.ets-function

---

[Skip to main content](https://exceljet.net/functions/forecast.ets-function#main-content)

[](https://exceljet.net/functions/forecast.ets-function#)

*   [Previous](https://exceljet.net/functions/forecast-function)
    
*   [Next](https://exceljet.net/functions/forecast.ets.confint-function)
...
![Excel FORECAST.ETS function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/forecast.ets%20function.png "Excel FORECAST.ETS function")
...
. With these inputs, the FORECAST.ETS function returns 618.29 in cell D13. As the formula is copied down the table, FORECAST.ETS returns predicted values in D13:D16, using values in column B for target date.

The chart to the right shows this data plotted in a [scatter plot](https://exceljet.net/chart-types/scatter-plot)
.

_Note: Cell D12 is set equal to C12 to connect the existing values to the predicted values in the chart._

### Argument notes

The _target\_date_ argument represents the point on the timeline that a prediction should be calculated.
...
_Note: It is better to perform aggregation before using FORECAST.ETS to make forecasting as accurate as possible._
...
*   [Microsoft FORECAST.ETS function documentation](https://support.office.com/en-us/article/forecasting-functions-reference-897a2fe9-6595-4680-a0b0-93e0308d5f6e)
