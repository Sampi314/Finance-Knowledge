# Excel COUPNUM function | Exceljet

**Source:** https://exceljet.net/functions/coupnum-function

---

[Skip to main content](https://exceljet.net/functions/coupnum-function#main-content)

[](https://exceljet.net/functions/coupnum-function#)

*   [Previous](https://exceljet.net/functions/coupncd-function)
    
*   [Next](https://exceljet.net/functions/couppcd-function)
...
![Excel COUPNUM function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_coupnum_function.png "Excel COUPNUM function")
...
The _basis_ argument controls how days are counted. The COUPNUM function allows 5 options (0-4) and defaults to zero, which specifies US 30/360 _basis_. This [article on wikipedia](https://en.wikipedia.org/wiki/Day_count_convention)
...
*   If _basis_ is out-of-range , COUPNUM returns #NUM!
...
*   [Microsoft COUPNUM function documentation](https://support.office.com/en-us/article/coupnum-function-a90af57b-de53-4969-9c99-dd6139db2522)
