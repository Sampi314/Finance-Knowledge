...
**Source:** https://exceljet.net/functions/dsum-function

---

[Skip to main content](https://exceljet.net/functions/dsum-function#main-content)

[](https://exceljet.net/functions/dsum-function#)

*   [Previous](https://exceljet.net/functions/dstdevp-function)
    
*   [Next](https://exceljet.net/functions/dvar-function)
...
![Excel DSUM function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_dsum_function.png "Excel DSUM function")
...
The Excel DSUM function calculates a sum of values in a set of records that match criteria. The values to sum are extracted from a given field in the database, specified as an argument. The _database_ argument is a range of cells that includes field headers. The _field_ is the name or index of the field to query, and the _criteria_ is a range of cells with headers that match those in _database._ Note that _field_ can be specified with a name or index. Using the example above, you can get the sum of all "Blue" sales with either of the formulas below:
...
 is not as extensive as with other functions like COUNTIFS, SUMIFS, MATCH, etc. For example, the pattern "???" will match strings with exactly 3 characters in more modern functions, but not in the database functions. If you are using wildcards, test carefully.
...
*   DSUM supports [wildcards](https://exceljet.net/glossary/wildcard)
     in criteria
...
*   [Microsoft DSUM function documentation](https://support.office.com/en-us/article/dsum-function-53181285-0c4b-4f5a-aaa3-529a322be41b)
