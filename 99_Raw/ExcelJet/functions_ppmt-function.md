...
**Source:** https://exceljet.net/functions/ppmt-function

---

[Skip to main content](https://exceljet.net/functions/ppmt-function#main-content)

[](https://exceljet.net/functions/ppmt-function#)

*   [Previous](https://exceljet.net/functions/pmt-function)
    
*   [Next](https://exceljet.net/functions/price-function)
...
![Excel PPMT function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_ppmt_function.png "Excel PPMT function")
...
*   _per_ - the given payment period as a number (i.e. 1, 2, 3, etc.)
...
The result is 147.05. This is the principal portion of the payment for period 1 of the loan. Notice we have provided the loan balance as a negative value to get a positive result from PPMT. If we provide 10,000 as a positive number, PPMT will return -147.05. In practice, the decision to use a positive or negative value for _pv_ depends on the specific scenario.
...
![Example of the PPMT function to calculate the principal amount in period 1](https://exceljet.net/sites/default/files/images/functions/inline/excel_ppmt_function_example.png "Example of the PPMT function to calculate the principal amount in period 1")
...
Also, notice that the PPMT function does not need the monthly payment. This is because PPMT calculates the principal portion of a payment based on the original principal (or present value), the interest rate, and the number of periods. To calculate the payment for a loan you can use the [PMT function](https://exceljet.net/functions/pmt-function)
.

### Notes

1.  Use the [IPMT function](https://exceljet.net/functions/ipmt-function)
     to get the interest portion of a loan payment for a given period.
...
*   [Microsoft PPMT function documentation](https://support.office.com/en-us/article/ppmt-function-c370d9e3-7749-4ca4-beea-b06c6ac95e1b)
