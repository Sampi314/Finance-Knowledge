# Excel PERCENTRANK.INC function | Exceljet

**Source:** https://exceljet.net/functions/percentrank.inc-function

---

[Skip to main content](https://exceljet.net/functions/percentrank.inc-function#main-content)

[](https://exceljet.net/functions/percentrank.inc-function#)

*   [Previous](https://exceljet.net/functions/percentrank.exc-function)
    
*   [Next](https://exceljet.net/functions/permut-function)
...
![Excel PERCENTRANK.INC function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_percentrank.inc_.png "Excel PERCENTRANK.INC function")
...
_Note: The PERCENTRANK.INC function replaces [PERCENTRANK](https://exceljet.net/functions/percentrank-function)
, which is now classified as a "[compatibility function](https://exceljet.net/glossary/compatibility-function)
"._

### Interpolation

When x does not exist within the array, the function interpolates a value between data points. For example, when the _x_ value of 4.00 is passed as an argument to the function, the percentage is interpolated to 42.4%, which lies between the percent ranks of 3.3 and 4.56, which are 33.3% and 50.0%, respectively.

![Interpolation data for PERCENTRANK.INC function.](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/inline/exceljet_percentrank.inc_interpolation_data.png?itok=ppWgVTnH "Interpolation data for PERCENTRANK.INC function.")

In the graph below, solid blue dots represent _x_ values contained within the input array, while the outlined blue dots represent interpolated values.

![Interpolation of values in PERCENTRANK.INC function.](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/inline/exceljet_percentrank.inc_interpolation.png?itok=F9opCjUt "Interpolation of values in PERCENTRANK.INC function.")
...
![percentrank.inc vs percentrank.exc](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/inline/percentrank.inc%20vs%20percentrank.exc%20kurt.png?itok=IyHQsdUB "percentrank.inc vs percentrank.exc")

![percentrank.inc vs percentrank.exc graph](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/inline/percentrank.inc%20vs%20percentrank.exc%20graph.png?itok=Ot1n1Fow "percentrank.inc vs percentrank.exc graph")
...
*   If _x_ does not exist in the array, PERCENTRANK.INC interpolates to find the percentage rank.
...
*   [Microsoft PERCENTRANK.INC function documentation](https://support.office.com/en-us/article/percentrank-inc-function-149592c9-00c0-49ba-86c1-c1f45b80463a)
