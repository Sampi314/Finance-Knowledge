...
**Source:** https://exceljet.net/formulas/unique-values-ignore-blanks

---

[Skip to main content](https://exceljet.net/formulas/unique-values-ignore-blanks#main-content)

[](https://exceljet.net/formulas/unique-values-ignore-blanks#)

*   [Previous](https://exceljet.net/formulas/unique-values-from-multiple-ranges)
    
*   [Next](https://exceljet.net/formulas/unique-values-with-criteria)
...
![Excel formula: Unique values ignore blanks](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/unique%20values%20ignore%20blanks.png "Excel formula: Unique values ignore blanks")

Summary
-------

To extract a list of unique values from a set of data, ignoring blank cells, you can use the [UNIQUE function](https://exceljet.net/functions/unique-function)
...
The <> symbol is a [logical operator](https://exceljet.net/glossary/logical-operators)
 that means "does not equal". For more examples of operators in formula criteria [see this page](https://exceljet.net/articles/how-to-use-formula-criteria)
.

FILTER returns an array of values, excluding [empty strings](https://exceljet.net/glossary/empty-string)
:
...
Because the range B5:B15 is hardcoded directly into the formula, it won't change if data is added or deleted. To use a dynamic range that will automatically resize as needed, you can use an [Excel Table](https://exceljet.net/articles/excel-tables)
