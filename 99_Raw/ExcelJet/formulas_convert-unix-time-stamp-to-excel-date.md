...
**Source:** https://exceljet.net/formulas/convert-unix-time-stamp-to-excel-date

---

[Skip to main content](https://exceljet.net/formulas/convert-unix-time-stamp-to-excel-date#main-content)

[](https://exceljet.net/formulas/convert-unix-time-stamp-to-excel-date#)

*   [Previous](https://exceljet.net/formulas/convert-time-to-time-zone)
    
*   [Next](https://exceljet.net/formulas/convert-utc-timestamp-to-excel-datetime)
...
by Dave Bruns · Updated 2 May 2023
...
![Excel formula: Convert Unix time stamp to Excel date](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/convert%20unix%20time%20stamp%20to%20excel%20date.png "Excel formula: Convert Unix time stamp to Excel date")

Summary
-------

To convert a Unix timestamp to [Excel's date format](https://exceljet.net/glossary/excel-date)
, you can use a formula based on the [DATE function](https://exceljet.net/functions/date-function)
...
When C5 is [formatted](https://exceljet.net/articles/custom-number-formats)
 with the Excel date "d-mmm-yyyy", the date is displayed as 1-Oct-2018.
