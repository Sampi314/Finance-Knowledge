...
**Source:** https://exceljet.net/functions/coupncd-function

---

[Skip to main content](https://exceljet.net/functions/coupncd-function#main-content)

[](https://exceljet.net/functions/coupncd-function#)

*   [Previous](https://exceljet.net/functions/coupdaysnc-function)
    
*   [Next](https://exceljet.net/functions/coupnum-function)
...
![Excel COUPNCD function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_coupncd_function.png "Excel COUPNCD function")
...
*   _frequency_ - Coupon payments per year (annual = 1, semi-annual = 2, quarterly = 4).
...
COUPNCD will return a valid Excel date, so use a [date format](https://exceljet.net/articles/custom-number-formats)
 to display properly.
...
The _basis_ argument controls how days are counted. The COUPNCD function allows 5 options (0-4) and defaults to zero, which specifies US 30/360 _basis_. This [article on wikipedia](https://en.wikipedia.org/wiki/Day_count_convention)
...
*   If _basis_ is out-of-range , COUPNCD returns #NUM!
...
*   [Microsoft COUPNCD function documentation](https://support.office.com/en-us/article/coupncd-function-fd962fef-506b-4d9d-8590-16df5393691f)
