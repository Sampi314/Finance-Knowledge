# Excel STDEV.S function | Exceljet

**Source:** https://exceljet.net/functions/stdev.s-function

---

[Skip to main content](https://exceljet.net/functions/stdev.s-function#main-content)

[](https://exceljet.net/functions/stdev.s-function#)

*   [Previous](https://exceljet.net/functions/stdev.p-function)
    
*   [Next](https://exceljet.net/functions/stdeva-function)
...
by Dave Bruns · Updated 6 Mar 2019
...
![Excel STDEV.S function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_stdev.s.png "Excel STDEV.S function")
...
_Note: STDEV.S replaces the older STDEV function, but has identical behavior. Although STDEV still exists for backwards compatibility, Microsoft recommends that people use the newer STDEV.S function instead._
...
*   [Microsoft STDEV.S function documentation](https://support.office.com/en-us/article/stdev-s-function-7d69cf97-0c1f-4acf-be27-f3e83904cc23)
