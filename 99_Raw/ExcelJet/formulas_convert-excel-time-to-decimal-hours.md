# Convert Excel time to decimal hours - Excel formula | Exceljet

**Source:** https://exceljet.net/formulas/convert-excel-time-to-decimal-hours

---

[Skip to main content](https://exceljet.net/formulas/convert-excel-time-to-decimal-hours#main-content)

[](https://exceljet.net/formulas/convert-excel-time-to-decimal-hours#)

*   [Previous](https://exceljet.net/formulas/convert-decimal-seconds-to-excel-time)
    
*   [Next](https://exceljet.net/formulas/convert-excel-time-to-decimal-minutes)
...
by Dave Bruns · Updated 17 Jun 2024

![Excel formula: Convert Excel time to decimal hours](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/convert%20excel%20time%20to%20decimal%20hours.png "Excel formula: Convert Excel time to decimal hours")
...
_Note: to figure out the number of hours between a start time and an end time, see: [Calculate hours between two times](https://exceljet.net/formulas/calculate-hours-between-two-times)
._ 
...
When you multiply a time value by 24, Excel may automatically format the result using a time format like h:mm, which will display the value incorrectly. To display the result as a regular number, apply the [General or Number format](https://exceljet.net/articles/custom-number-formats)
.
