# Excel DSTDEVP function | Exceljet

**Source:** https://exceljet.net/functions/dstdevp-function

---

[Skip to main content](https://exceljet.net/functions/dstdevp-function#main-content)

[](https://exceljet.net/functions/dstdevp-function#)

*   [Previous](https://exceljet.net/functions/dstdev-function)
    
*   [Next](https://exceljet.net/functions/dsum-function)
...
![Excel DSTDEVP function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_dstdevp.png "Excel DSTDEVP function")
...
*   DSTDEVP is the mean to calculate variance for an entire population. If data represents a sample, use the [DSTDEV function](https://exceljet.net/functions/dstdev-function)
    .
*   DSTDEVP supports [wildcards](https://exceljet.net/glossary/wildcard)
     in criteria.
...
*   [Microsoft DSTDEVP function documentation](https://support.office.com/en-us/article/dstdevp-function-04b78995-da03-4813-bbd9-d74fd0f5d94b)
