# Running total in Table - Excel formula | Exceljet

**Source:** https://exceljet.net/formulas/running-total-in-table

---

[Skip to main content](https://exceljet.net/formulas/running-total-in-table#main-content)

[](https://exceljet.net/formulas/running-total-in-table#)

*   [Previous](https://exceljet.net/formulas/running-count-in-table)
    
*   [Next](https://exceljet.net/formulas/sum-multiple-tables)
...
![Excel formula: Running total in Table](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/running%20total%20in%20table2.png "Excel formula: Running total in Table")

Summary
-------

To create a running total in an [Excel Table](https://exceljet.net/glossary/excel-table)
, you can use the INDEX function set up with a [structured reference](https://exceljet.net/glossary/structured-reference)
...
To get the a reference to the first cell, we use [INDEX](https://exceljet.net/functions/index-function)
 like this:
