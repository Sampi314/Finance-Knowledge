...
**Source:** https://exceljet.net/formulas/data-validation-date-in-specific-year

---

[Skip to main content](https://exceljet.net/formulas/data-validation-date-in-specific-year#main-content)

[](https://exceljet.net/formulas/data-validation-date-in-specific-year#)

*   [Previous](https://exceljet.net/formulas/data-validation-date-in-next-30-days)
    
*   [Next](https://exceljet.net/formulas/data-validation-dont-exceed-total)
...
![Excel formula: Data validation date in specific year](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/data%20validation%20date%20in%20specific%20year.png "Excel formula: Data validation date in specific year")

Summary
-------

_Note: Excel has several built-in data validation rules for dates. This page explains how to create a your own validation rule based on a custom formula in case you want or need more control and flexibility._
