...
**Source:** https://exceljet.net/functions/yielddisc-function

---

[Skip to main content](https://exceljet.net/functions/yielddisc-function#main-content)

[](https://exceljet.net/functions/yielddisc-function#)

*   [Previous](https://exceljet.net/functions/yield-function)
    
*   [Next](https://exceljet.net/functions/yieldmat-function)
...
![Excel YIELDDISC function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_%20yielddisc_function.png "Excel YIELDDISC function")
...
with these inputs, the YIELDDISC function returns 0.03264023 which, or 3.26% when formatted with the [percentage number format](https://exceljet.net/articles/custom-number-formats)
.
...
*   If _settlement_ or _maturity_ dates are not valid, YIELDDISC returns #VALUE!
...
*   [Microsoft YIELDDISC function documentation](https://support.office.com/en-us/article/yielddisc-function-a9dbdbae-7dae-46de-b995-615faffaaed7)
