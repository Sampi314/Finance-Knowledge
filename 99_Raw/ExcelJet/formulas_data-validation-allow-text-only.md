# Data validation allow text only - Excel formula | Exceljet

**Source:** https://exceljet.net/formulas/data-validation-allow-text-only

---

[Skip to main content](https://exceljet.net/formulas/data-validation-allow-text-only#main-content)

[](https://exceljet.net/formulas/data-validation-allow-text-only#)

*   [Previous](https://exceljet.net/formulas/data-validation-allow-numbers-only)
    
*   [Next](https://exceljet.net/formulas/data-validation-allow-uppercase-only)
...
![Excel formula: Data validation allow text only](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/data%20validation%20allow%20text%20only.png "Excel formula: Data validation allow text only")
