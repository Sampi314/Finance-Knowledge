# Convert decimal minutes to Excel time - Excel formula | Exceljet

**Source:** https://exceljet.net/formulas/convert-decimal-minutes-to-excel-time

---

[Skip to main content](https://exceljet.net/formulas/convert-decimal-minutes-to-excel-time#main-content)

[](https://exceljet.net/formulas/convert-decimal-minutes-to-excel-time#)

*   [Previous](https://exceljet.net/formulas/convert-decimal-hours-to-excel-time)
    
*   [Next](https://exceljet.net/formulas/convert-decimal-seconds-to-excel-time)
...
by Dave Bruns · Updated 23 Sep 2018

![Excel formula: Convert decimal minutes to Excel time](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/convert%20decimal%20minutes%20to%20excel%20time.png "Excel formula: Convert decimal minutes to Excel time")

Summary
-------

To convert minutes in decimal format to a proper Excel time, divide by 1440. In the example shown, the formula in C6 is:
...
To display hours that represent a duration longer than 24 hours, or minutes in durations longer than 60 minutes, you'll need to adjust the [number format](https://exceljet.net/articles/custom-number-formats)
