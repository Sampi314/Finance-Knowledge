# The A to Z of DAX Functions – INFO.PERSPECTIVETABLES

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivetables/
...
Power Pivot Principles: The A to Z of DAX Functions – INFO.PERSPECTIVETABLES
============================================================================

28 January 2025

_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (DAX) functions. This week, we look at **INFO.PERSPECTIVETABLES**._

**_The_** _**INFO.PERSPECTIVETABLES**_ **_function_**
...
), the **PerspectiveTable** object includes a **Table** object into the **Perspective** object. It is a child of a **Perspective** object. The child **PerspectiveColumns**, **PerspectiveMeasures**, and **PerspectiveHierarchies** objects allow customizing which parts of the Table are visible in the **Perspective**.

We can write this **INFO.PERSPECTIVETABLES** function on DAX query viewto get the sameinformation on the **TMSCHEMA\_PERSPECTIVE\_TABLES**:

![](<Base64-Image-Removed>)

Itwill query the **$SYSTEM.****TMSCHEMA\_PERSPECTIVE\_TABLES** and return an entire table with five \[5\] columns:
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivetables/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivetables/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivetables/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivetables/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivetables/#0 "close")
