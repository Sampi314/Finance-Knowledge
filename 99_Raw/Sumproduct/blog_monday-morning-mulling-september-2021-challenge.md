...
**Source:** https://sumproduct.com/blog/monday-morning-mulling-september-2021-challenge/
...
Thanks once again to **Abbott Katz** who brought this challenge to our attention. The [Microsoft Research Blog](https://www.microsoft.com/en-us/research/blog/lambda-the-ultimatae-excel-worksheet-function)
 discussed [**LAMBDA**](https://www.sumproduct.com/news/article/lambda-slaughter-creating-custom-functions-using-lambda)
 at the beginning of the year. They highlighted the power of this new Office 365 (Beta) function with this particular example:

![](<Base64-Image-Removed>)

![](<Base64-Image-Removed>)

Aside from the fact that there is a mistake in the formula for **REVERSE**, having one too many closed brackets (they really should use **[FORMULATEXT](https://www.sumproduct.com/blog/article/a-to-z-of-excel-functions/the-formulatext-function)
!)**, the Research Team has erroneously stated that “…reversing a string is beyond the built-in functions of Excel and could only previously _(sic)_ be written outside the formula language…”.
...
For **all** current versions of Excel (not just Office 365, Excel on the web and Insider / Beta variants), write a formula that will reverse the text in a cell (_i.e._ reverse the text string). You cannot use VBA, dynamic arrays, JavaScript, TypeScript or [Office Scripts](https://www.sumproduct.com/news/article/office-scripts-preview-rolling-out-now)
.
...
Hang on a minute: this is _spilling_ – we are using dynamic arrays, and these are not allowed for the purposes of the challenge. Well, yes and no; you may use **\=INDIRECT(“1:3”)** in all current versions of Excel, it’s just this formula cannot be _rendered_ in all versions. But that’s not what we want in any case.
...
The [attached Excel file](https://sumproduct.com/assets/blog-pictures/2021/fff-mmm/sep/mmm/sp-reversing-text.xlsx)
...
_The Final Friday Fix will return on Friday 24 September 2021 with a new Excel Challenge. In the meantime, please look out for the Daily Excel Tip on our home page and watch out for a new blog every business workday._

[More Blog Articles](https://www.sumproduct.com/blog)

*   [Log in](https://sumproduct.com/blog/monday-morning-mulling-september-2021-challenge/#0)
    
*   [Register](https://sumproduct.com/blog/monday-morning-mulling-september-2021-challenge/#0)
...
[Forgot your password?](https://sumproduct.com/blog/monday-morning-mulling-september-2021-challenge/#0)
...
[Back to login](https://sumproduct.com/blog/monday-morning-mulling-september-2021-challenge/#0)

[](https://sumproduct.com/blog/monday-morning-mulling-september-2021-challenge/#0 "close")
