# The A to Z of DAX Functions – DATESYTD

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-datesytd/
...
_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (DAX) functions. This week, we look at **DATESYTD**._

**_The_** _**DATESYTD**_ **_function_**

The **DATESYTD** functionis one of the time intelligence functions. It returns a set of dates in the year up to the last date visible in the filter context. This function is similar to the **[DATESMTD](https://www.sumproduct.com/blog/article/power-pivot-principles/the-a-to-z-of-dax-functions-datesmtd)
** and the **[DATESQTD](https://www.sumproduct.com/blog/article/power-pivot-principles/the-a-to-z-of-dax-functions-datesqtd)
**. It operates under the following syntax:
...
*   **year\_end\_date:** this is an optional, literal string that defines the year-end date. If omitted, the default is 31 December. It may be specified using **\=DATESYTD(Calendar\[Date\], “30 June 1976”)**, for example.
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-datesytd/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-datesytd/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-datesytd/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-datesytd/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-datesytd/#0 "close")
