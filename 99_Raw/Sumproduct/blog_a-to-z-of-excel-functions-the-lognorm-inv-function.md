...
**Source:** https://sumproduct.com/blog/a-to-z-of-excel-functions-the-lognorm-inv-function/
...
_Welcome back to our regular A to Z of Excel Functions blog. Today we look at the **LOGNORM.INV** function._
...
The **LOGNORM.INV** function returns the inverse of the Lognormal cumulative distribution function of **x**, where **LN(x)** is Normally distributed with parameters **mean** and **standard\_deviation**.

If **p = LOGNORM.DIST(x, …)** then **LOGNORM.INV(p, …) = x**.

The **LOGNORM.INV** function employs the following syntax to operate:

**LOGNORM.INV(probability, mean, standard\_deviation)**
...
*   if any argument is nonnumeric, **LOGNORM.INV** returns the _#VALUE!_ error value
*   if **probability** ≤ 0 or **probability** ≥ 1, **LOGNORM.INV** returns the _#NUM!_ error value
*   if **x** ≤ 0 or if **standard\_deviation** ≤ 0, **LOGNORM.INV** returns the _#NUM!_ error value.
...
*   [Log in](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-lognorm-inv-function/#0)
    
*   [Register](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-lognorm-inv-function/#0)
...
[Forgot your password?](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-lognorm-inv-function/#0)
...
[Back to login](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-lognorm-inv-function/#0)

[](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-lognorm-inv-function/#0 "close")
