# The A to Z of DAX Functions – INFO.PERSPECTIVECOLUMNS

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivecolumns/
...
Power Pivot Principles: The A to Z of DAX Functions – INFO.PERSPECTIVECOLUMNS
=============================================================================

31 December 2024

_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (DAX) functions. This week, we look at **INFO.PERSPECTIVECOLUMNS**._

**_The_** _**INFO.PERSPECTIVECOLUMNS**_ **_function_**

![](https://sumproduct.com/wp-content/uploads/2025/05/6a456a8603139a29b6a0a4d040c43533.jpg)
...
The **INFO.PERSPECTIVECOLUMNS** function is one of the system functions. It employs the following syntax:
...
), the **PerspectiveColumn**object includes a Column object of a **Table** object into the **Perspective**object. It is a child of a **PerspectiveTable**object.

We can write this **INFO.PERSPECTIVECOLUMNS** function on DAX query viewto get the sameinformation on the **TMSCHEMA\_PERSPECTIVE\_COLUMNS**:

![](https://sumproduct.com/wp-content/uploads/2025/05/ce6c7057c4b3d5e82fbaff58b6bb9e8f.jpg)

Itwill query the **$SYSTEM.****TMSCHEMA\_PERSPECTIVE\_COLUMNS** and return an entire table with four \[4\] columns:

![](https://sumproduct.com/wp-content/uploads/2025/05/671692a51ddfcbebe641dd63e3bc6b1d.jpg)

*   **ID:** this is a reference to the object
*   **PerspectiveTableID:** this is an ID-based reference to a **PerspectiveTable** object
*   **ColumnID:** this isan ID-based reference to a **Column**object
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivecolumns/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivecolumns/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivecolumns/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivecolumns/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivecolumns/#0 "close")
