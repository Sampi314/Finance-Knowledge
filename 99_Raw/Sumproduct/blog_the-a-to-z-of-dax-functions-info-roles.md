# The A to Z of DAX Functions – INFO.ROLES

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-roles/
...
Power Pivot Principles: The A to Z of DAX Functions – INFO.ROLES
================================================================

1 April 2025

_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (**DAX**) functions. This week, we look at **INFO.ROLES**._

**_The_** _**INFO.ROLES**_ **_function_**
...
The **INFO.ROLES** function is one of the system functions. It employs the following syntax:

**INFO.ROLES(\[RestrictionName1\],\[RestrictionValue1\],…)**
...
), the **Role** object defines a set of user principals for whom security rules are applied. It is a child of a **Model** object.

We can write this **INFO.ROLES** function on DAX query viewto get the sameinformation on the **TMSCHEMA\_ROLES**:

![](<Base64-Image-Removed>)

Itwill query the **$SYSTEM.****TMSCHEMA\_ROLES** and return an entire table with six \[6\] columns:
...
*   **ModelPermission:** this is the level of access for this role. The possible values are as follows:
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-roles/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-roles/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-roles/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-roles/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-roles/#0 "close")
