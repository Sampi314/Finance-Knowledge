# A to Z of Excel Functions: The IMCOSH Function

**Source:** https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcosh-function/
...
_Welcome back to our regular A to Z of Excel Functions blog. Today we look at the **IMCOSH** function._
...
*   **inumber:** this is required and represents the complex number for which you want to calculate the hyperbolic cosine.
...
*   if **inumber** is a value that is not in the **x + yi** or **x + yj** text format, **IMCOSH** returns the _#NUM!_ error value
*   if **inumber** is a logical value, **IMCOSH** returns the _#VALUE!_ error value
*   if the complex number ends in +**i** or –**i** (or **j**), _i.e._ there is no coefficient between the operator and the imaginary unit, there must be no space, otherwise **IMCOSH** will return an _#NUM!_ error.
...
*   [Log in](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcosh-function/#0)
    
*   [Register](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcosh-function/#0)
...
[Forgot your password?](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcosh-function/#0)
...
[Back to login](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcosh-function/#0)

[](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcosh-function/#0 "close")
