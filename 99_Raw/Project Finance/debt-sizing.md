...
1.  Higher cash flow means that debt to capital will more likely be a constraint.
2.  Shorter debt tenure means that DSCR will morel likely be a constraint.
3.  A higher interest rate will mean the the DSCR will more likely be a constraint.
4.  Sculpting will mean the the debt to capital will more probably be a constraint.
...
![](https://pixel.wp.com/g.gif?v=ext&blog=182904628&post=227&tz=0&srv=edbodmer.com&j=1%3A13.2.3&host=edbodmer.com&ref=&fcp=0&rand=0.9164491625964052)