# Traffic Project Finance (Toll Roads, Bridges, Air, Sea & Bus Ports)

**Source:** https://edbodmer.com/traffic-project-finance-toll-roads-bridges-air-ports-sea-ports-bus-terminals

---

The articles described as part of this section explains how various selected completed project finance models work for Toll Roads, Bridges, Terminals, Sea Ports and Airports.  The boxes below summarise the pages with the various models that are available from the menu. I am in the process of putting more real world examples together.  If you are bench-marking a new model or you want to see the structures of alternative models, I can send you an e-mail with some real world examples. My e-mail address is edwardbodmer@gmail.com.
...
![](https://pixel.wp.com/g.gif?v=ext&blog=182904628&post=3202&tz=0&srv=edbodmer.com&j=1%3A13.2.3&host=edbodmer.com&ref=&fcp=9504&rand=0.41502171332956084)