# How to find sum of top 3 values based on filtered criteria [video] » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/sum-of-top-3-values-meeting-criteria
...
**![Sum of top 3 values meeting filtered criteria - how to calculate using Excel formulas?](https://img.chandoo.org/f/sum-of-top-3-values-meeting-filtered-criteria-excel.png)_Today, lets tackle an interesting problem._**
...
_This article is inspired from [a question asked by acpt22](http://chandoo.org/forums/topic/sum-of-top-3-records-based-on-filtered-criteria)
 in our forums.  
_
...
[Watch this video on our YouTube channel](http://youtu.be/rw7-E_sYkz4)
.

### Download Example Workbook

[**Click here to download example file**](https://img.chandoo.org/f/sum-of-top-3-values-meeting-criteria.xlsx)
 and play with it. Examine the formulas & pivot table settings to learn this technique better.

### Do you calculate sum of top ‘n’ values often?

Often, I have to calculate sum of top ‘n’ values and I use SUMPRODUCT + LARGE combination. SUMPRODUCT (or simply SUM) is such a versatile formula that you could _almost_ use it when your car breaks down on a free way.
...
*   [How to find 2nd largest item meeting a criteria?](http://chandoo.org/wp/2010/10/08/large-if-array-formula-tutorial/)
    
*   [Calculating average of top 5 values – howto?](http://chandoo.org/wp/2010/06/04/average-of-top-5-values/)
    
*   [Sum of values meeting multiple criteria – SUMIFS formula](http://chandoo.org/wp/2010/04/20/introduction-to-excel-sumifs-formula/)
...
*   [28 Comments](https://chandoo.org/wp/sum-of-top-3-values-meeting-criteria/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/sum-of-top-3-values-meeting-criteria/#respond)
...
[PrevPreviousHow to transpose a values in a row to column using formulas… \[Quick tip\]](https://chandoo.org/wp/how-to-transpose-a-values-in-a-row-to-column-using-formulas-quick-tip/)

[NextExcel Project Risk Map Generator – using VBANext](https://chandoo.org/wp/excel-risk-map/)
