# Extract URLs from an excel spreadsheet cell using UDFs » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/spreadsheet-cell-hyperlink-function
...
![extract-hyperlinks-from-cell-excel-spreadsheet-formula](https://chandoo.org/wp/wp-content/uploads/2008/07/extract-hyperlinks-from-cell-contens-spreadsheet-formula.gif "extract-hyperlinks-from-cell-contens-spreadsheet-formula")Often my work involves processing web page data in excel sheets. This includes extracting the hyperlinks from cell contents. There is no formula for extracting hyperlinks though, you can right click on cell and choose “edit hyperlink” to see which address the cell is linking to. But that is a tedious process especially if you are planning on using the hyperlink for something.

Here is a handy user defined function in VBA for getting hyperlinks from a spreadsheet cell:

> `    Function getURL(forThisCell As Range) As String   'VBA UDF for getting URLs from a cell if any   retVal = ""   If forThisCell.Hyperlinks(1).Address <> "" Then   retVal = forThisCell.Hyperlinks(1).Address   End If   getURL = retVal   End Function    `
...
*   [3 Comments](https://chandoo.org/wp/spreadsheet-cell-hyperlink-function/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/spreadsheet-cell-hyperlink-function/#respond)
...
[PrevPreviousChanging Sort Orientation in Excel – Sorting across columns instead of rows](https://chandoo.org/wp/change-sort-orientation-excel-columns/)

[NextWatch out if you are buying insurance online at GEICO – your password is not encryptedNext](https://chandoo.org/wp/geico-password-encryption-fail/)
