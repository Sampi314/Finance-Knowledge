# Solve Sudoku Puzzles using Excel Macros - Excel Games

**Source:** https://chandoo.org/wp/solve-sudoku-using-excel
...
_**Sanjay**_, my colleague is an avid programmer and excel enthusiast. In his spare time he wrote a small VBA macro to solve [Sudoku](http://en.wikipedia.org/wiki/Sudoku)
. Sudoku is a very famous number based puzzle with a 9×9 grid of cells. Each of the 9 rows, columns and 3×3 blocks should be filled in such a way that they have all the numbers from 1 to 9. Sudoku is a very effective way to keep your brain cells ticking. I am a huge sudoku fan and I solve sudoku whenever I have few minutes to kill. So naturally I jumped with joy when I saw Sanjay’s excel macro for solving sudoku. He is kind enough to let me share this with all of you.

![Solve Sudoku using Excel](https://chandoo.org/img/i/sudoku-solver-using-excel.gif)

**[Click here to download the sudoku solver workbook](http://chandoo.org/img/d/sudoku-solver-excel%202003.zip)
**. It has macros, so enable them when you download the file.

The file is unlocked, so if you are curious, go around and poke the code.

And if you are interested in writing your own sudoku solver, _**here is a basic algorithm:**_
...
*   [Simulate Monopoly board game to find best places to buy](http://chandoo.org/wp/2007/02/25/is-monopoly-fair/)
    
*   [Play Deal or No Deal using Excel](http://chandoo.org/wp/2008/10/03/download-excel-deal-or-no-deal-game-play/)
    
*   [Generating Bingo / Housie Tickets with Excel](http://chandoo.org/wp/2008/07/16/bingo-housie-ticket-generator-excel/)
...
*   [13 Comments](https://chandoo.org/wp/solve-sudoku-using-excel/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/solve-sudoku-using-excel/#respond)
    
*   Tagged under [downloads](https://chandoo.org/wp/tag/downloads/)
    , [excel fun](https://chandoo.org/wp/tag/excel-fun/)
    ...
    , [sudoku](https://chandoo.org/wp/tag/sudoku/)
    , [VBA](https://chandoo.org/wp/tag/vba/)
    
*   Category: [VBA Macros](https://chandoo.org/wp/category/vba-macros/)
    

[PrevPreviousGet a free copy of Project Management Bundle](https://chandoo.org/wp/pm-bundle-free-copy/)

[NextPrevent Duplicate Data Entry using Cell ValidationsNext](https://chandoo.org/wp/duplicate-data-entry/)
