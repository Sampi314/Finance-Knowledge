# Formula 1 Style Sorting of Times (Durations) in Excel » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/sorting-tricks-1
...
Not clear? See this:  
![formula1-style-sorting-of-numbers-dates-excel](https://chandoo.org/wp/wp-content/uploads/2009/07/formula1-style-sorting-of-numbers-dates-excel.png "formula1-style-sorting-of-numbers-dates-excel")
...
*   We are using [small()](http://chandoo.org/excel-formulas/small.html "SMALL excel formula help")
     to fetch the smallest value from the range of durations for the first formula.
*   For the subsequent formulas, we just subtract the smallest value form nth smallest value and use [TEXT()](http://chandoo.org/wp/2008/08/13/15-microsoft-excel-formulas/ "TEXT() Excel Formula")
     to show it in + xx.xx secs format.
*   We are using ROWS() for … ?

### If your brain needs a kick start to master excel formulas…

Go ahead and purchase my [Excel Formula 1 – the fastest (and the funnest) way to learn excel formulas e-book](http://chandoo.org/wp/excel-formula-helper-e-book/)
. You can learn 75 most frequenlty used excel formulas in no time.
...
*   [13 Comments](https://chandoo.org/wp/sorting-tricks-1/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/sorting-tricks-1/#respond)
...
[PrevPrevious14 Basic Skills for Chart Makers (Big question: How many do you have?)](https://chandoo.org/wp/chart-making-skills/)

[Next2 Great Pieces of Advice for Chart Makers, Dashboard Designers and Story Tellers EverywhereNext](https://chandoo.org/wp/charting-advice/)
