# Project Management Dashboard - Examples (and download)

**Source:** https://chandoo.org/wp/project-dashboard-example
...
I feel very happy to share this with you. Our blog reader and excel ninja _**Fernando**_ sent me this in e-mail.

![Project Dashboard Examples](https://chandoo.org/img/pm/project-dashboard-implementation-th.png)Based on your last post about Project Management, I did a tool to track project status at my company. I’ve included some things differently than your suggestion, and even added a Tweetboard (which turned out to be a great success – thanks a lot for the idea! 🙂 ) on another tab, to resume information about project status. I loaded it with your sample data, to protect our personal info (compliance stuff), and translated it to English (although I’m not pretty sure everything is well-translated – feel free to correct). …

All the best from Brazil! 🙂

See the implementation of the [project management dashboard](http://chandoo.org/wp/2009/10/06/project-status-dashboard/)
 along with the [tweetboard](http://chandoo.org/wp/2009/05/07/tweetboard/)
 below:

![Project Dashboard Implementation](https://chandoo.org/img/pm/project-dashboard-implementation.png)  
![Project Tweetboard Implementation](https://chandoo.org/img/pm/project-tweetboard-implementation.png)

### Download the dashboard + tweetboard example:

[Click here](http://chandoo.org/img/pm/project-dashboard-implementation.zip)
 to download the excel workbook and see it yourself.

I have locked the file as the [project dashboard is on sale](http://chandoo.org/wp/project-management-templates/project-dashboards/)
. If you want an unlocked version of the dashboard template (and 23 other excel templates for better project management) _**[click here](http://chandoo.org/wp/project-management-templates/ "Excel Templates for Project Management")
**_. You can be rolling out a similar dashboard in a couple hours using the project management bundle.

**Also checkout,**

Do check out the 6 part tutorial on [Project Management using Excel](http://chandoo.org/wp/tag/project-management/)
 and [Tweetboard implementations](http://chandoo.org/wp/2009/06/02/tweetboard-implementations/)
 as well.
...
_**Thank you Fernando, for sharing this with us.**_ More success to you and all our members.
...
*   [7 Comments](https://chandoo.org/wp/project-dashboard-example/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/project-dashboard-example/#respond)
...
*   Tagged under [charting](https://chandoo.org/wp/tag/charting/)
    ...
    , [tweetboards](https://chandoo.org/wp/tag/tweetboards/)
    
*   Category: [Charts and Graphs](https://chandoo.org/wp/category/visualization/)
    

[PrevPreviousPrevent Duplicate Data Entry using Cell Validations](https://chandoo.org/wp/duplicate-data-entry/)

[NextCopy Data Validations from one cell to another \[quick tip\]Next](https://chandoo.org/wp/copy-data-validations/)
