# Search a Spreadsheet Full of Data using Conditional Formatting » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/search-with-conditional-formatting
...
![Search a large spreadsheet of data using conditional formatting](https://i287.photobucket.com/albums/ll133/pointy-haired-dilbert/search-using-conditional-formatting.png)  
...
![Formulas in Conditional Formatting](https://i287.photobucket.com/albums/ll133/pointy-haired-dilbert/conditional-formatting-formula-sear.png)We will write a simple formula that returns true if a cell has the content you typed in the search bar (F4) and false if the cell doesnt. You can try something like `ISERROR(FIND(LOWER($F$4),LOWER(B7)))=FALSE`.
...
[5 Rock Star Conditional Formatting Tips](http://chandoo.org/wp/2008/03/13/want-to-be-an-excel-conditional-formatting-rock-star-read-this/)
...
*   [25 Comments](https://chandoo.org/wp/search-with-conditional-formatting/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/search-with-conditional-formatting/#respond)
...
[PrevPreviousInterview with John Walkenbach on Excel and Banjo Charts…](https://chandoo.org/wp/interview-john-walkenbach/)

[NextBudget vs. Actual Charts – 14 Charting Ideas You can UseNext](https://chandoo.org/wp/budget-vs-actual-charts/)
