# How-to: Skip weekends while autofilling dates in excel

**Source:** https://chandoo.org/wp/skip-weekends-while-autofill-dates-in-excel-howto
...
![skip-weekends-while-filling-dates-ms-excel-autofill](https://chandoo.org/wp/wp-content/uploads/2008/06/skip-weekends-while-filling-dates.gif "skip-weekends-while-filling-dates")Often you may **want to fill a column only with weekday dates instead of all dates**. Here is a simple trick you can use instead of writing nifty if formulas or manually entering the weekday dates.
...
![fill-weekdays-dates-in-excel-only-howto](https://chandoo.org/wp/wp-content/uploads/2008/06/fill-weekdays-only-howto.gif "fill-weekdays-only-howto")
...
*   [35 Comments](https://chandoo.org/wp/skip-weekends-while-autofill-dates-in-excel-howto/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/skip-weekends-while-autofill-dates-in-excel-howto/#respond)
...
[PrevPreviousGoogle maps 3d building outlines – wow](https://chandoo.org/wp/google-maps-3d-building-outlines/)

[NextExcel Paste Special Tricks & How toNext](https://chandoo.org/wp/17-excel-paste-special-tricks/)
