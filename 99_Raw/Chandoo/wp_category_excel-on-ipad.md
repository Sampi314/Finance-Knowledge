# Excel on iPad Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/category/excel-on-ipad

---

All articles in 'Excel on iPad' Category
========================================

{ [**9** Comments](https://chandoo.org/wp/excel-for-ipad-intro/#comments)
 }

[Excel for iPad – Demo & Introduction \[video\]](https://chandoo.org/wp/excel-for-ipad-intro/ "Excel for iPad – Demo & Introduction [video]")

----------------------------------------------------------------------------------------------------------------------------------------------

Published on Apr 11, 2014 _in_ [Excel on iPad](https://chandoo.org/wp/category/excel-on-ipad/)

[![Excel for iPad – Demo & Introduction [video]](https://img.chandoo.org/ipad-excel/excel-for-ipad-demo-introduction.png)](https://chandoo.org/wp/excel-for-ipad-intro/ "Excel for iPad – Demo & Introduction [video]")
...
Several years after iPad launch, Microsoft finally created apps for Word, Power Point, One Note & Excel. The Excel app is a miniature version of Excel on your iPad. It is capable of displaying _almost_ _all_ Excel workbooks with ease. You can even create your own workbooks using the app.

[Continue »](https://chandoo.org/wp/excel-for-ipad-intro/)
