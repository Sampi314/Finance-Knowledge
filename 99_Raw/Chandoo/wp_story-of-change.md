# Narrating the story of change using Excel charts - case study » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/story-of-change
...
_**Here are three questions you often hear from your boss:**_
...
Here is a recent chart from Bloomberg, depicting how America has changed its mind about various social & political issues between 1787 & 2015. ([Read the full article on Bloomberg](http://www.bloomberg.com/graphics/2015-pace-of-social-change/)
)

![how-fast-america-changes-its-mind](https://chandoo.org/wp/wp-content/uploads/2015/05/how-fast-america-changes-its-mind.png)
...
![market-share-changes-over-time](https://chandoo.org/wp/wp-content/uploads/2015/05/market-share-changes-over-time.png)

### Narrating change over time story with Excel charts – Video tutorial

If you like the above chart, watch below video to learn how to create it. As the process is somewhat elaborate, I made a video explaining various steps and techniques. Watch it below (or [click here to see it on our YouTube channel](https://youtu.be/B35GWNDm5W8)
)

### Download the Change over Time Excel Chart:

**[Please click here to download the workbook for this chart (Excel 2013 Version)](https://chandoo.org/wp/wp-content/uploads/2015/05/changes-over-time.xlsx)
**.

**[Please click here to download the workbook for this chart (Excel 2007/10 Version)](https://chandoo.org/wp/wp-content/uploads/2015/05/Changes-over-time-2010.xlsx)
**.
...
*   [Waterfall charts](http://chandoo.org/wp/2009/08/10/excel-waterfall-charts/)
    
*   [Scatter plots – case study](http://chandoo.org/wp/2010/10/25/competition-analysis-charts/)
    
*   [Conditional formatting](http://chandoo.org/wp/2013/07/11/never-use-simple-numbers-in-your-dashboards/)
     – usage in Dashboards
*   [Animated charts](http://chandoo.org/wp/2012/10/31/hurricane-sandy-animated-chart/)
     – Hurricane Sandy trajectory
*   [Interactive charts](http://chandoo.org/wp/2011/02/22/the-grammy-bump-chart-in-excel/)
     – Grammy bump chart
...
*   [13 Comments](https://chandoo.org/wp/story-of-change/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/story-of-change/#respond)
...
*   Tagged under [Advanced Charting](https://chandoo.org/wp/tag/advanced-charting/)
    ...
    , [chating](https://chandoo.org/wp/tag/chating/)
...
[PrevPreviousEnsure cleaner input dates with conditional formatting \[quick tip\]](https://chandoo.org/wp/cleaner-dates-with-conditional-formatting/)

[NextCP035: on Solver, its story and future – Interview with Dan FylstraNext](https://chandoo.org/wp/cp035-on-solver-its-story-and-future-interview-with-dan-fylstra/)
