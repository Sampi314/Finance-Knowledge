# Quickly Remove Data Validation Rules using Paste Special » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/quickly-remove-data-validation-rules-using-paste-special
...
![Excel Data Validation Rules - Example](https://img.chandoo.org/dv/data-validation-rules-example.png)
...
We all know that [data validation](http://chandoo.org/wp/tag/data-validation/)
 is a powerful feature in Excel to control what data is entered. But, sometimes, you may want to remove the rules from a set of cells. _**How would you do it?**_
...
_**We use Paste Special.**_

What ?!? Paste Special?!?

![Remove Data Validation Rules with Paste Special](https://chandoo.org/img/dv/remove-data-validation-settings-with-paste-special.png)That is right. A simple [paste special](http://chandoo.org/wp/2008/07/02/17-excel-paste-special-tricks/)
 can remove the data validation rules for us quickly. Here is how.
...
_PS: Paramdeep reminds me that Financial Modeling School enrollments close on March 8th – just 4 more days. [Sign-up already](http://chandoo.org/wp/financial-modeling/)
_.
...
*   [14 Comments](https://chandoo.org/wp/quickly-remove-data-validation-rules-using-paste-special/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/quickly-remove-data-validation-rules-using-paste-special/#respond)
...
[PrevPrevious3+1 Ways to Learn Advanced Excel](https://chandoo.org/wp/learn-advanced-excel/)

[NextFinancial Modeling School is closing in a Few Hours – Join Now!Next](https://chandoo.org/wp/financial-modeling-school-2-last-call/)
