# Reader Poll: Should the axis for bar charts always start at zero? » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/reader-poll-axis-scaling-bar-charts
...
It all began with my [Excel Dashboard Tutorial – Making a dashboard with player statistics](http://chandoo.org/wp/2008/10/20/excel-dashboard-tutorial/)
. I have used bar charts with axis whose minimum is not zero, to create a dramatic effect in the charts. See below:

![excel-barchart-rule-breaking](https://chandoo.org/wp/wp-content/uploads/2008/10/excel-barchart-rule-breaking.png "excel-barchart-rule-breaking")
...
**What do _I_ think about this visualization rule ?**
...
*   Breaking this rule helps in creating dramatic effect on your charts, one of the reasons we use them. Often when you use data with narrow range, creating dramatic effect could be difficult. Axis adjustments can help (you may want to try [logarithmic axis scale](http://peltiertech.com/WordPress/2008/09/16/logarithmic-axis-scales/)
     as well)
...
*   [24 Comments](https://chandoo.org/wp/reader-poll-axis-scaling-bar-charts/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/reader-poll-axis-scaling-bar-charts/#respond)
...
*   Tagged under [axis scaling](https://chandoo.org/wp/tag/axis-scaling/)
    ...
    , [questions](https://chandoo.org/wp/tag/questions/)
...
[PrevPreviousSports Dashboards in Excel – A Tutorial](https://chandoo.org/wp/excel-dashboard-tutorial/)

[NextSorting Text in Excel using FormulasNext](https://chandoo.org/wp/sorting-text-in-excel-using-formulas/)
