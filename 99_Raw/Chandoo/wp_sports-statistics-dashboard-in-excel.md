# Sports Statistics Dashboard in Excel - Few More Alternatives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/sports-statistics-dashboard-in-excel
...
First of all, thanks everyone for making the **[should you always start barcharts at zero?](http://chandoo.org/wp/2008/10/21/reader-poll-axis-scaling-bar-charts/)
** discussion lively. Almost everyone felt that we should start bar charts at zero.

After spending sometime with my initial **[test cricket statistics dashboard](http://chandoo.org/wp/2008/10/20/excel-dashboard-tutorial/)
**, I have created few alternatives. You can see them below.
...
Just use your imagination, come up with alternatives and share them in comments. You can get the [data here](http://in.rediff.com/cricket/2008/oct/17sachin.htm)
. The best ones will be shared with all readers in another post. 🙂

PS: You can share excel files / images with everyone by uploading them to a free hosting site ([flickr](http://flickr.com/)
, [photobucket](http://photobucket.com/)
 for images) and then paste the links in the comments box. Let me know if you have any difficulty. Also, if you want me to host the files, feel free to send them at chandoo.d at gmail.com. Happy Charting 🙂
...
![](https://chandoo.org/wp/wp-content/uploads/2008/10/original-dashboard-with-correct-axis-sclae-measures.png "original-dashboard-with-correct-axis-sclae-measures")

I have also tried to come up **in-cell chart variations**. But Nothing looked that great. Here is one that I liked:

![](https://chandoo.org/wp/wp-content/uploads/2008/10/incell-dashboard-excel-variation.png "incell-dashboard-excel-variation")
...
![](https://chandoo.org/wp/wp-content/uploads/2008/10/dashboard-with-vertical.png "dashboard-with-vertical")![](https://chandoo.org/wp/wp-content/uploads/2008/10/fewer-colors.png "fewer-colors")
...
*   [One Comment](https://chandoo.org/wp/sports-statistics-dashboard-in-excel/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/sports-statistics-dashboard-in-excel/#respond)
    
*   Tagged under [axis scaling](https://chandoo.org/wp/tag/axis-scaling/)
...
[PrevPreviousSorting Text in Excel using Formulas](https://chandoo.org/wp/sorting-text-in-excel-using-formulas/)

[Next5 Beautiful Visualizations \[Oct 24\]Next](https://chandoo.org/wp/beautiful-infographics/)
