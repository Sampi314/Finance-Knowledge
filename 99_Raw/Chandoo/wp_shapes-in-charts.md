# Use shapes to enhance your Excel charts [tip] » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/shapes-in-charts
...
![use-shapes-to-enhance-your-charts](https://chandoo.org/wp/wp-content/uploads/2015/08/use-shapes-to-enhance-your-charts.png)

_Looks interesting? Read on…_

### How to add drawing shapes / pictures to your charts

Watch this quick video tutorial to understand the process for adding shapes / pictures to your charts. We start by creating a simple chart filled with custom shape. Once the basic technique is clear, we then build an [interactive chart](http://chandoo.org/wp/tag/dynamic-charts/)
 that _moves_ an arrow symbol based on user input. Pretty sweet.

### Download shapes in your charts – Example workbook

[**Please download the example workbook**](https://chandoo.org/wp/wp-content/uploads/2015/08/shapes-in-charts.xlsx)
 and use it to understand this chart better.

### More ways to use shapes in your charts

Check out few more fun & informative ways you can use shapes in your charts

*   [Understanding the effect of Grammy award on album sales – Grammy Bump Chart in Excel](http://chandoo.org/wp/2011/02/22/the-grammy-bump-chart-in-excel/)
    
*   [Create a column chart with background image](http://chandoo.org/wp/2013/05/06/column-chart-with-background-image/)
    
*   [Use shapes to make pretty charts](http://chandoo.org/wp/2009/12/03/use-shapes-in-dashboards/)
    
*   Shapes in a dashboard – [Celebrating India’s cricket worldcup victory](http://chandoo.org/wp/2011/04/15/cricket-worldcup-dashboard/)
    

### Share your shapes in chart idea & you could win Amazon gift card

_This post is part of [Awesome August](http://chandoo.org/wp/resources/awesome-august/)
 Excel festival @ Chandoo.org._
...
*   [15 Comments](https://chandoo.org/wp/shapes-in-charts/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/shapes-in-charts/#respond)
...
[PrevPreviousRemove duplicate combinations in your data \[quick tip\]](https://chandoo.org/wp/remove-duplicate-combinations/)

[NextDeclutter your reports by showing icon onlyNext](https://chandoo.org/wp/show-icon-only-conditional-formatting/)
