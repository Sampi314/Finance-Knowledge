# Refresh All Pivot Tables at once [Quick Tip] » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/refresh-all-pivot-tables
...
**[Pivot Tables](http://chandoo.org/wp/excel-pivot-tables/)** are an integral part of Excel based reports. So it is no surprise that many of create multiple pivot reports in one Excel workbook.
...
![Refresh All Pivot Tables at Once](https://img.chandoo.org/q/refresh-all-pivots-at-once.png)
...
What about you? Do you use Refresh All feature? **What other Pivot Table Tricks you know? _Please share your experience & tips using comments._**

### More Quick Tips:

*   [10 Must have Excel Shortcuts](http://chandoo.org/wp/2011/08/08/must-have-excel-keyboard-shortcuts/)
    
*   [What are Pivot Table Report Filters & How to use them?](http://chandoo.org/wp/2011/04/20/pivot-table-report-filters/)
    
*   [Compare Data using Row Differences](http://chandoo.org/wp/2011/02/14/compare-data-row-differences/)
    
*   [Format Multiple Sheets with Grouping Option](http://chandoo.org/wp/2010/11/15/formatting-multiple-sheets/)
    
*   [_**More Quick Tips**_](http://chandoo.org/wp/tag/quick-tip/ "Microsoft Excel Quick Tips")
...
*   [41 Comments](https://chandoo.org/wp/refresh-all-pivot-tables/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/refresh-all-pivot-tables/#respond)
...
[PrevPreviousOur VBA Class Registrations Close in Few Hours, Join Now & Learn Excel VBA](https://chandoo.org/wp/vba-class-b2-last-call/)

[NextAnalyzing Performance of Stocks using Excel \[Example\]Next](https://chandoo.org/wp/analyzing-performance-of-stocks-using-excel-example/)
