# Sand Pendulums - Lissajous Patterns in Excel » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/sand-pendulums-lissajous-patterns-in-excel
...
Few days ago, I saw a beautiful homemade science experiment on [Sand Pendulums on Bruce Yeany’s YouTube channel](https://www.youtube.com/watch?v=uPbzhxYTioM)
. Go ahead and check it out. It is a cool project to do with your kids.
...
![sand-pendulums-excel-demo](https://chandoo.org/wp/wp-content/uploads/2017/04/sand-pendulums-excel-demo.gif)
...
*   d refers to degrees of shift (its a bit complex to explain here, but read about phase shift on [Lissajous curve Wikipedia page](https://en.wikipedia.org/wiki/Lissajous_curve)
    )
...
6.  Update the chart by using doEvents after every _n_ calculations. Try n=25 first and change as you see fit. Updating the chart after every calculation slows down the animation significantly.
...
[**Click here to download the Pendulum Sand patterns workbook**](https://chandoo.org/wp/wp-content/uploads/2017/04/pendulum-sand-art.xlsm)
. Play with the animate & random pattern buttons to see some cool patterns.
...
Also check out: [3D dancing pendulums post](http://chandoo.org/wp/2011/07/06/3d-dancing-pendulums/)
 to see some cool & clever animations. [Huge collection of spreadsheet tools & simulations for teachers](http://chandoo.org/wp/2011/02/03/spreadsheets-for-teachers/)
.
...
*   [No Comments](https://chandoo.org/wp/sand-pendulums-lissajous-patterns-in-excel/#respond)
    
*   [Ask a question or say something...](https://chandoo.org/wp/sand-pendulums-lissajous-patterns-in-excel/#respond)
...
[PrevPreviousReshaping your data easily – Case study \[Pivot tables FTW\]](https://chandoo.org/wp/reshaping-your-data-easily-case-study-pivot-tables-ftw/)

[NextHide columns one one tab same way as they were in another place \[quick tip\]Next](https://chandoo.org/wp/hide-columns-quickly-excel/)
