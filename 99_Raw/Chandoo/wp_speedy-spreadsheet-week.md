# This week, Speed up your Spreadsheets - Your Action Required » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/speedy-spreadsheet-week
...
In [recent installment of Customer Service Dashboard post](http://chandoo.org/wp/2012/03/14/calculations-for-customer-service-dashboard/ "Data and Calculations for our Customer Service Dashboard [Part 2 of 4]")
, our reader _Salmon_ asked an interesting question,

> I am struggling with data size with my dashboards…so many SQL data pulls and formulas to generate the Dashboard, the entire file is massive and sluggish. Perhaps a few tips from Chandoo Master for all us rookie dashboard designers regarding how to minimize file size and maximize calc speeds. [#](http://chandoo.org/wp/2012/03/14/calculations-for-customer-service-dashboard/#comment-221256)

Dan l & others chipped in and shared their ideas on **_speeding up Excel_**. But the topic is wide & has many solutions. So I am dedicating an entire week to discuss this. **Welcome to Speedy Spreadsheet Week.**

![Speedy Spreadsheet Week on Chandoo.org ](https://img.chandoo.org/polls/speedy-spreadsheet-week-chandoo.org.png "Speedy Spreadsheet Week on Chandoo.org")
...
**Use below form ([or click here](https://docs.google.com/spreadsheet/viewform?formkey=dDBRV3diSFM3c2lJNi01aUYyaERvS2c6MQ)
) to share your tips.**
...
*   [4 Comments](https://chandoo.org/wp/speedy-spreadsheet-week/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/speedy-spreadsheet-week/#respond)
    
*   Tagged under [advanced excel](https://chandoo.org/wp/tag/advanced-excel/)
    , [excel optimization](https://chandoo.org/wp/tag/excel-optimization/)
    , [excel speed](https://chandoo.org/wp/tag/excel-speed/)
    , [Learn Excel](https://chandoo.org/wp/tag/excel/)
    , [optimise](https://chandoo.org/wp/tag/optimise/)
    , [polls](https://chandoo.org/wp/tag/polls/)
    , [ssw](https://chandoo.org/wp/tag/ssw/)
    
*   Category: [Excel Howtos](https://chandoo.org/wp/category/excel-howtos/)
    

[PrevPreviousData and Calculations for our Customer Service Dashboard \[Part 2 of 4\]](https://chandoo.org/wp/calculations-for-customer-service-dashboard/)

[NextSpeeding up & Optimizing Excel – Tips for Charting & Formatting \[Speedy Spreadsheet Week\]Next](https://chandoo.org/wp/excel-optimization-charting-formatting-tips/)
