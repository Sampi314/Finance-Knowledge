# Say NO to Default Charts Forever! » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/say-no-to-default-charts-forever
...
![](https://phd.blog.googlepages.com/excel_charting_tips_1.JPG)**or Excel Charting Hacks # 2**  
  
Roughly 35-40% of my working time in office is spent with powerpoint. As one of my mentors said, **_powerpoint gives neither the power nor the point_**. Apart from writing truck loads of bullet points and using auto shapes, I also work alot with numbers and charts. Obviously I resort to excel for drawing the same, but over the last few months I have observed that, everytime I create a chart, I follow these steps mechanically,  
![](https://phd.blog.googlepages.com/excel_charting_tips_2.JPG)
...
**UDC**s is a very useful hidden feature in excel that saves a lot of time, easy to know and use and still lacks significant awareness. I think, excel is full of such things.

**How to define “User Defined Chart”:**

![](https://phd.blog.googlepages.com/excel_charting_tips_3.JPG)Once you have a chart formated to your need, you can add it user-defined charts list so that you can use it next time with a different set of data. To do that;

1.  Select the chart which you want to add to “user defined” list
2.  Click on menu options Chart->chart-type
3.  Go to Custom tab, select “user-defined” radio. Click on the add button and specify a title and description. (see the screenshots aside. Focus on the Red circles)  
    ![](https://phd.blog.googlepages.com/excel_charting_tips_4.JPG)

Now, for your use I have included all the 13 chart templates I have created in an excel. [Download excel charting hacks # 2](http://phd.blog.googlepages.com/chartinghacks2.xls)
 and say NO to default charts forever. Remember, you have to add my charts to your computer by manually clicking on the Add button for every chart. Thats one time process though.

\[Read [more excel charting hacks](http://www.chandoo.org/blog/2007/02/excel-charting-hacks-1.html)\
\]
...
*   [One Comment](https://chandoo.org/wp/say-no-to-default-charts-forever/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/say-no-to-default-charts-forever/#respond)
    
*   Tagged under [information](https://chandoo.org/wp/tag/information/)
    , [Learn Excel](https://chandoo.org/wp/tag/excel/)
    , [office](https://chandoo.org/wp/tag/office/)
    , [presentation](https://chandoo.org/wp/tag/presentation/)
    , [process](https://chandoo.org/wp/tag/process/)
...
[PrevPreviousBusy!](https://chandoo.org/wp/busy-6/)

[NextThe Calvin Fund!Next](https://chandoo.org/wp/the-calvin-fund/)
