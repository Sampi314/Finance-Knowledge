# Sorting Text Alphabetically using Excel Formulas

**Source:** https://chandoo.org/wp/sorting-text-in-excel-using-formulas
...
Sorting text is such a day to day activity that it always surprises me why Excel hasn’t provided a simple spreadsheet formula for doing it. Of course you can use the sorting menu command (menu > data > sort) but this requires manual steps (or VBA). Most of the times we get raw textual data from various sources and we need it to be sorted. While fooling with the [COUNTIF() formula](http://chandoo.org/wp/2008/06/09/what-the-if-learn-6-cool-things-you-can-do-with-excel-if-functions/)
, I have realized a powerful yet little known feature that can be exploited to sort text using formulas.

![sorting-text-using-excel-formulas](https://chandoo.org/wp/wp-content/uploads/2008/10/sorting-text-using-excel-formulas.png "sorting-text-using-excel-formulas")
...
![excel-countif-sorting-text-formulas](https://chandoo.org/wp/wp-content/uploads/2008/10/excel-countif-sorting-text-formulas.png "excel-countif-sorting-text-formulas")
...
**Download the workbook with [alphabetical text sorting using formulas](https://chandoo.org/wp/wp-content/uploads/2008/10/excel-sorting-text-alphabetically-wth-formulas.xls)
...
Also read: [Shuffling a list of cells in random order using formulas](http://chandoo.org/wp/2008/09/23/sort-in-random-order-excel-formulas/)
, [More analytics / text processing tweaks](http://chandoo.org/wp/category/analytics/)
...
*   [106 Comments](https://chandoo.org/wp/sorting-text-in-excel-using-formulas/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/sorting-text-in-excel-using-formulas/#respond)
    
*   Tagged under [cool](https://chandoo.org/wp/tag/cool/)
...
[PrevPreviousReader Poll: Should the axis for bar charts always start at zero?](https://chandoo.org/wp/reader-poll-axis-scaling-bar-charts/)

[NextSports Statistics Dashboard in Excel – Few More AlternativesNext](https://chandoo.org/wp/sports-statistics-dashboard-in-excel/)
