# Skip Blank doesnt skip blank cells ?!? » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/skp-blank-cells
...
![skip blanks - incorrectly interpreted](https://i287.photobucket.com/albums/ll133/pointy-haired-dilbert/8-paste-skip-blanks.gif)In our [excel paste tricks](http://chandoo.org/wp/2008/07/02/17-excel-paste-special-tricks/)
 post, I have mentioned a paste special feature called “skip blanks” that can apparently be used to skip blank cells when pasting data. I am writing about this again because, _I have received an email from Bruce saying,_
...
*   [26 Comments](https://chandoo.org/wp/skp-blank-cells/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/skp-blank-cells/#respond)
...
*   Tagged under [blogging](https://chandoo.org/wp/tag/blogging/)
    ...
    , [skip blanks](https://chandoo.org/wp/tag/skip-blanks/)
...
[PrevPreviousVisualization Challenge – Budget vs. Actual Performance](https://chandoo.org/wp/budget-vs-actual-performance/)

[NextExcel Links of The Week – Malmo EditionNext](https://chandoo.org/wp/excel-links-of-the-week-malmo-edition/)
