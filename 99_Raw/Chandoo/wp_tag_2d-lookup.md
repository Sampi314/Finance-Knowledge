# 2d lookup Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/tag/2d-lookup

---

All articles with '2d lookup' Tag
=================================

{ [**41** Comments](https://chandoo.org/wp/looking-up-when-the-data-wont-co-operate-case-study/#comments)
 }

[Looking up when the data won’t co-operate (case study)](https://chandoo.org/wp/looking-up-when-the-data-wont-co-operate-case-study/ "Looking up when the data won’t co-operate (case study)")

-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Published on Nov 4, 2014 _in_ [Excel Challenges](https://chandoo.org/wp/category/excel-challenges/)
, [Excel Howtos](https://chandoo.org/wp/category/excel-howtos/)

[![Looking up when the data won’t co-operate (case study)](https://img.chandoo.org/f/2d-lookup-problem-data-structure.png)](https://chandoo.org/wp/looking-up-when-the-data-wont-co-operate-case-study/ "Looking up when the data won’t co-operate (case study)")
...
[Continue »](https://chandoo.org/wp/looking-up-when-the-data-wont-co-operate-case-study/)
