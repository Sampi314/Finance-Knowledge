# Start your bar charts from zero - Excel geeks screaming at you from mountain top » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/start-your-bar-charts-from-zero
...
Over the weekend, _the_ [Jon Peltier](http://peltiertech.com/)
 visited Wellington. He is staying with Jeff (who occasionally guest blogs on Chandoo.org). On Sunday, we all decided to hike up a small mountain near my house for a leisurely family picnic.
...
![start-your-axis-at-zero-bar-charts](https://chandoo.org/wp/wp-content/uploads/2017/05/start-your-axis-at-zero-bar-charts.png)
...
Of course, the reality is somewhere between two pictures. It is difficult to conclude who is tall, who is short just looking at the pics simply because the _baseline is sloping._ 
...
![bar-chart-with-arbitrary-axis](https://chandoo.org/wp/wp-content/uploads/2017/05/bar-chart-with-arbitrary-axis.png)
...
![bar-chart-with-zero-axis](https://chandoo.org/wp/wp-content/uploads/2017/05/bar-chart-with-zero-axis.png)
...
*   [Don’t make your charts heavier than they should be](http://chandoo.org/wp/2016/01/13/dont-make-your-charts-heavier/)
    
*   [Give meaningful titles to your charts](http://chandoo.org/wp/2015/08/19/descriptive-titles-on-charts/)
    
*   [Use shapes to enhance your charts](http://chandoo.org/wp/2015/08/08/shapes-in-charts/)
    
*   [What is data to ink ratio and how to optimize it?](http://chandoo.org/wp/2015/07/09/cp038-data-to-ink-ratio/)
...
*   [25 Comments](https://chandoo.org/wp/start-your-bar-charts-from-zero/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/start-your-bar-charts-from-zero/#respond)
...
[PrevPreviousSelective Sub-totals in Pivot Tables \[Quick Tip\]](https://chandoo.org/wp/selective-subtotals-in-pivot-tables/)

[NextJo’s first keyboard shortcutNext](https://chandoo.org/wp/jos-first-keyboard-shortcut/)
