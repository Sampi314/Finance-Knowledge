...
**Source:** https://www.andypope.info/charts/floatinggap.htm
...
|     |     |
| --- | --- |
|     | ![](https://www.andypope.info/charts/floatinggap.GIF)<br>----------------------------------------------------- |
|     | ##### The [workbook](https://www.andypope.info/charts/floatinggap.zip)<br> contains an example of how to create a clustered column chart with a floating gap.  <br>The gap can be either positive or negative. |
|     |     |

    
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/charts/floatinggap.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/charts/floatinggap.htm#Top "Return to top of page")
