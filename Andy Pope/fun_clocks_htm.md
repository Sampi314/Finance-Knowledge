...
**Source:** https://www.andypope.info/fun/clocks.htm
...
[![](https://www.andypope.info/Site_Images/nav_pagereturn.png)](https://www.andypope.info/fun.htm "Go up a section")
 ![](https://www.andypope.info/Site_Images/nav_pageback.png "Go Back to previous page")

### Clocks

The [download](https://www.andypope.info/fun/clocks.zip)
 contains 3 variations on working clocks.  
  
The rotating clock is calculated using vba whilst the LED and standard clock use worksheet formula.  
  
The vba is available for view.[![Circulating clock that follows your mouse!](https://www.andypope.info/fun/clockrotate.jpg)  \
![Digital clock](https://www.andypope.info/fun/clockled.jpg)  \
![Analogue clock](https://www.andypope.info/fun/clockface.jpg)](https://www.andypope.info/fun/clocks.zip)
  
  
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/fun/clocks.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/fun/clocks.htm#Top "Return to top of page")
