...
**Source:** https://www.andypope.info/ngs/ng29.htm
...
|     |     |
| --- | --- |
|     | Re: Clustered stacked dual axis chart<br>------------------------------------- |
|     | ##### The stacked cluster chart is created by though the layout of the data. The dual axis is simply a case of formatting the required data series to use the secondary axis.<br><br>##### Here is a example data set<br><br>![](https://www.andypope.info/ngs/ng29pic4.gif)<br><br>##### Create a normal stacked column chart from the range B1:G3<br><br>![](https://www.andypope.info/ngs/ng29pic1.gif)<br><br>##### Use the format dialog to move the data series Y and Z to the secondary axis<br><br>![](https://www.andypope.info/ngs/ng29pic2.gif)<br><br>##### The change the chart type to stacked column for series Y<br><br>![](https://www.andypope.info/ngs/ng29pic3.gif) |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng29.htm#Top "Return to top of page")
