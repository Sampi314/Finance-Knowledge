...
**Source:** https://www.andypope.info/ngs/ng6.htm
...
|     |     |
| --- | --- |
|     | Re: Band or ribbon?<br>-------------------<br><br>![](https://www.andypope.info/ngs/lineband.GIF)<br>----------------------------------------------- |
|     | ##### The [workbook](https://www.andypope.info/ngs/lineband.zip)<br> contains an example of how to create a band around a set of lines.  <br>The line chart has additional data on the secondary axis charted as a stacked area to provided the band (ribbon). |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng6.htm#Top "Return to top of page")
