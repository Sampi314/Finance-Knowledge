...
**Source:** https://www.andypope.info/ngs/ng5.htm
...
|     |     |
| --- | --- |
|     | Re: How to determine when data is out of bounds on a chart?<br>-----------------------------------------------------------<br><br>![](https://www.andypope.info/ngs/pointinpolygon.GIF)<br>----------------------------------------------------- |
|     | ##### The [workbook](https://www.andypope.info/ngs/pointinpolygon.zip)<br> contains VBA code and a user defined function for testing whether a single point is within a closed polygon.  <br>  <br>Credit for the geometr routines is given in the workbook. I have only adapted them for use within Excel. |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng5.htm#Top "Return to top of page")
