...
**Source:** https://www.andypope.info/ngs/ng54.htm
...
|     |     |
| --- | --- |
|     | RE: Yes No count using named range<br>---------------------------------- |
|     | #####  ![](https://www.andypope.info/ngs/ng54.gif) |
| ##### Named formula<br><br>##### ChtData:<br><br>##### \=CHOOSE(ROW(Sheet1!$1:$2),COUNTIF(Sheet1!$A$2:$A$21,"Yes"),COUNTIF(Sheet1!$A$2:$A$21,"No")) |
|     | ##### Chart Series formula<br><br>##### \=SERIES(,{"Yes","No"},ng54.xls!ChtData,1) |
| ##### [Example file](https://www.andypope.info/ngs/ng54.zip) |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng54.htm#Top "Return to top of page")
