...
**Source:** https://www.andypope.info/ngs/ng4.htm
...
|     |     |
| --- | --- |
|     | Re: RADAR - Y axe distribution<br>------------------------------<br><br>![](https://www.andypope.info/ngs/spaced_radar.gif)<br>--------------------------------------------------- |
|     | ##### The [workbook](https://www.andypope.info/ngs/spacedradar.zip)<br> contains an example of a radar chart that has varying divisions in each of the 4 sectors. All the formula needed are contained in the worksheet. The chart itself is an XY Scatter. |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng4.htm#Top "Return to top of page")
