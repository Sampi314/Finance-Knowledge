...
**Source:** https://www.andypope.info/ngs/ng15.htm
...
|     |     |
| --- | --- |
|     | Re: Chart with two text axis<br>----------------------------<br><br>![](https://www.andypope.info/ngs/twotextaxis.gif)<br>-------------------------------------------------- |
|     | ##### The [workbook](https://www.andypope.info/ngs/twotextaxis.zip)<br> contains an example chart.  <br>Uses a second data series to display x axis category labels |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng15.htm#Top "Return to top of page")
