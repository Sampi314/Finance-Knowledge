...
**Source:** https://www.andypope.info/ngs/ng51.htm
...
|     |     |
| --- | --- |
|     | RE: Complex xy scatter MSGraph<br>------------------------------ |
|     | ##### ![](https://www.andypope.info/ngs/ng51.gif)<br><br>#####   <br>The chart is built using xy data series |
|     |
|     | ##### The y axis labels are data labels displaying series name.  <br>The error bars is a single series with gaps in the data to produce gaps in the line.<br><br>##### See example [presentation](https://www.andypope.info/ngs/ng51.zip)<br> of data layout. |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng51.htm#Top "Return to top of page")
