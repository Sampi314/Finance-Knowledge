...
**Source:** https://www.andypope.info/vba/hlist.htm
...
### Hierarchical Listbox v1.1

 

|     |     |
| --- | --- |
|     | ![](https://www.andypope.info/vba/hlist.gif)<br>-------------------------------------------- |
|     | ##### The class ajpHList allows you to use a normal userfrom Listbox in a similar way to a Treeview list.  <br>Where Nodes (listitems) are stored within other Nodes.   <br>Appropriate Nodes can be opened to reveal related nodes or closed to conceal them.  <br>  <br>Opening and closing of Nodes can be done either with double clicks or the Enter key.  <br>  <br>The [workbook](https://www.andypope.info/vba/hlist.zip)<br> ![](https://www.andypope.info/images/xl2000.gif) contains a userform that allows you to change the font and alter the characters used to build the nodes and connecting lines.<br><br>##### This [workbook](https://www.andypope.info/vba/hlist_xl97.zip)<br> ![](https://www.andypope.info/images/xl97.gif) contains a version that uses global procedures instead of raising events.<br><br>##### v1.1 12th Jan 2007 - Bug fix handling of last element |
|     |     |
|     |
...
Excel 2003 version  
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/vba/hlist.zip)
  
  
Excel 97 version  
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/vba/hlist_xl97.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/vba/hlist.htm#Top "Return to top of page")
