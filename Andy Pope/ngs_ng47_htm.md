...
**Source:** https://www.andypope.info/ngs/ng47.htm
...
|     |     |
| --- | --- |
|     | RE: Can I link timeline labels to a line chart?<br>----------------------------------------------- |
|     | ##### You can use data series plotted on the secondary axis using there own date values.<br><br>![](https://www.andypope.info/ngs/ng47.gif)<br><br>  <br>  <br><br>##### The [download](https://www.andypope.info/ngs/ng47.zip)<br> example contains instructions on how to build and format chart |
|     |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng47.htm#Top "Return to top of page")
