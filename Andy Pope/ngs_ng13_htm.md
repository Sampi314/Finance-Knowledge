...
**Source:** https://www.andypope.info/ngs/ng13.htm
...
|     |     |
| --- | --- |
|     | Re: Add Data To Table But Not Chart Area<br>----------------------------------------<br><br>![](https://www.andypope.info/ngs/datatable.gif)<br>------------------------------------------------ |
|     | ##### The [workbook](https://www.andypope.info/ngs/datatabletext.zip)<br> contains an example chart.  <br>The data table text is achieved using custom number formats |
|     |     |
|     |
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng13.htm#Top "Return to top of page")
