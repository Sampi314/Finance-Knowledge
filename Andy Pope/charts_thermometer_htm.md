...
**Source:** https://www.andypope.info/charts/thermometer.htm
...
##### Here is a collection of thermometer style charts.

|     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ##### Simple |     | ##### Basic |     | ##### Fancy |     | ##### Fancier |     | ##### Deluxe |
| ##### ![](https://www.andypope.info/charts/therm_simple.gif) |     | ##### ![](https://www.andypope.info/charts/therm_basic.gif) |     | ![](https://www.andypope.info/charts/therm_fancy.gif) |     | ##### ![](https://www.andypope.info/charts/therm_fancier.gif) |     | ##### ![](https://www.andypope.info/charts/therm_deluxe.gif) |

##### The simple, basic and fancy styles are based on column charts.

##### The fancier style uses a picture to provide the thermometer shape.

##### The deluxe style use an xy scatter chart with error bars.

##### The [download](https://www.andypope.info/charts/thermometer.zip)
 includes an explanation for each thermometer style.

    
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/charts/thermometer.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/charts/thermometer.htm#Top "Return to top of page")
