...
**Source:** https://www.andypope.info/fun/fireworks.htm
...
The [download](https://www.andypope.info/fun/fireworks.zip)
 contains vba code to generate a Firework display, well rockets to be precise.  
  
The user can control the number of rockets in a display, the number of sparks a rocket contains and the effect of gravity.  
  
The animation is displayed through use of an xy scatter chart.  
  
The code is unlocked and available to view.  
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/fun/fireworks.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/fun/fireworks.htm#Top "Return to top of page")
