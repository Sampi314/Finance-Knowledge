...
**Source:** https://www.andypope.info/ngs/ng63.htm
...
### Re: Conditional Chart

  
If you alter the Trait values from Yes to No the colour of the column will automatically update.  
  
The chart contains 2 series, with overlap set to 100%.  
The data for the 2 series is based on formula with an IF condition on the Trait value.  
You can download the [example file](https://skydrive.live.com/redir.aspx?cid=ead861c14bcc56b7&resid=EAD861C14BCC56B7!191&parid=EAD861C14BCC56B7!189)
 from here.  
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng63.htm#Top "Return to top of page")
