...
**Source:** https://www.andypope.info/charts/floatcluster.htm
...
### Floating bar cluster Chart

 

|     |     |
| --- | --- |
|     | [![Floating bar cluster chart](https://www.andypope.info/charts/float_cluster.jpg)](https://www.andypope.info/charts/floatcluster.zip)<br><br>--------------------------------------------------------------------------------------------------------------------------------------- |
|     | ##### This chart uses a second set of data to mask the bottom of the bar and give a floating effect.  <br>  <br>The [download](https://www.andypope.info/charts/floatcluster.zip)<br> contains a step by step example. |
|     |     |

   
[![](https://www.andypope.info/site_images/nav_download.png)](https://www.andypope.info/charts/floatcluster.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/charts/floatcluster.htm#Top "Return to top of page")
