...
**Source:** https://www.andypope.info/ngs/ng61.htm
...
### Re: Gridlines on Column Chart

Use Axis Options 'Intervals creates a coloured section within a donut chart depending upon the month status value.  
The valid values are R, A, G or blank.  
![](https://www.andypope.info/ngs/ng61a.gif)  
Select X axis and display Format Axis dialog. Within the Axis Options tab use the 'Interval between tick marks:' to determine major gridline spacing.  
![](https://www.andypope.info/ngs/ng61b.jpg)  
  
ng61.zip [![](https://www.andypope.info/Images/download.gif)](https://www.andypope.info/ngs/ng61.zip)
...
[![RSS feed](https://www.andypope.info/Site_Images/nav_rss.png)](https://www.andypope.info/feed/feed.xml "RSS Feed")
 [![Top of page](https://www.andypope.info/Site_Images/nav_top.png)](https://www.andypope.info/ngs/ng61.htm#Top "Return to top of page")
