...
**Source:** https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcot-function/
...
_Welcome back to our regular A to Z of Excel Functions blog. Today we look at the **IMCOT** function._
...
![](https://sumproduct.com/wp-content/uploads/2025/05/d74c06396490330b9a6f8847e68c44c8.jpg)
...
*   if **inumber** is a value that is not in the **x + yi** or **x + yj** text format, **IMCOT** returns the _#NUM!_ error value
*   if **inumber** is a logical value, **IMCOT** returns the _#VALUE!_ error value
*   if the complex number ends in +**i** or –**i** (or **j**), _i.e._ there is no coefficient between the operator and the imaginary unit, there must be no space, otherwise **IMCOT** will return an _#NUM!_ error.
...
*   [Log in](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcot-function/#0)
    
*   [Register](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcot-function/#0)
...
[Forgot your password?](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcot-function/#0)
...
[Back to login](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcot-function/#0)

[](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-imcot-function/#0 "close")
