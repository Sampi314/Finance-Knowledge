# A to Z of Excel Functions: The SORT Function

**Source:** https://sumproduct.com/blog/a-to-z-of-excel-functions-the-sort-function/
...
_Welcome back to our regular A to Z of Excel Functions blog.  Today we look at the **SORT** function._

**The SORT function**

**SORT** was one of seven functions heralding the new dawn of arrays – the Dynamic Array.

Before explaining **SORT**, let’s first consider what a Dynamic Array is.  Consider the following data:
...
_#SPILL!_ errors are returned when a formula returns multiple results, and Excel cannot return the results to the spreadsheet.  There are various reasons an _#SPILL!_ error could occur: **spill range is not blank:** as in my example _(above)_, this error occurs when one or more cells in the designated spill range are not blank and thus may not be populated.   
...
*   [Log in](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-sort-function/#0)
    
*   [Register](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-sort-function/#0)
...
[Forgot your password?](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-sort-function/#0)
...
[Back to login](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-sort-function/#0)

[](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-sort-function/#0 "close")
