# The A to Z of DAX Functions – INFO.PERSPECTIVEHIERARCHIES

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivehierarchies/
...
Power Pivot Principles: The A to Z of DAX Functions – INFO.PERSPECTIVEHIERARCHIES
=================================================================================

7 January 2025

_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (DAX) functions. This week, we look at **INFO.PERSPECTIVEHIERARCHIES**._

**_The_** _**INFO.PERSPECTIVEHIERARCHIES**_ **_function_**

![](https://sumproduct.com/wp-content/uploads/2025/05/67ab2682d1cd9cc07c6b062233be0645.jpg)
...
The **INFO.PERSPECTIVEHIERARCHIES** function is one of the system functions. It employs the following syntax:

**INFO.PERSPECTIVEHIERARCHIES(\[RestrictionName1\],\[ResctrictionValue1\],…)**
...
), the **PerspectiveHierarchy** object includes a **Hierarchy** object of a **Table** object into the Perspective object. It is a child of a **PerspectiveTable** object.

We can write this **INFO.PERSPECTIVEHIERARCHIES** function in the DAX query viewto get the sameinformation on the **TMSCHEMA\_PERSPECTIVE\_HIERARCHIES**:

![](<Base64-Image-Removed>)

Itwill query **$SYSTEM.****TMSCHEMA\_PERSPECTIVE\_HIERARCHIES** and return an entire table with four \[4\] columns:

![](<Base64-Image-Removed>)

*   **ID:** this is a reference to the object
*   **PerspectiveTableID:** this is an ID-based reference to a **PerspectiveTable** object
*   **HierarchyID:** this isan ID-based reference to a **Hierarchy** object
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivehierarchies/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivehierarchies/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivehierarchies/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivehierarchies/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivehierarchies/#0 "close")
