...
**Source:** https://sumproduct.com/blog/a-to-z-of-excel-functions-the-loginv-function/
...
_Welcome back to our regular A to Z of Excel Functions blog. Today we look at the **LOGINV** function._
...
The **LOGINV** function returns the inverse of the Lognormal cumulative distribution function of **x**, where **LN(x)** is Normally distributed with parameters **mean** and **standard\_deviation**.
...
**LOGINV(probability, mean, standard\_deviation)**
...
*   if any argument is nonnumeric, **LOGINV** returns the _#VALUE!_ error value
*   if **probability** ≤ 0 or **probability** ≥ 1, **LOGINV** returns the _#NUM!_ error value
*   if **x** ≤ 0 or if **standard\_deviation** ≤ 0, **LOGINV** returns the _#NUM!_ error value
...
*   [Log in](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-loginv-function/#0)
    
*   [Register](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-loginv-function/#0)
...
[Forgot your password?](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-loginv-function/#0)
...
[Back to login](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-loginv-function/#0)

[](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-loginv-function/#0 "close")
