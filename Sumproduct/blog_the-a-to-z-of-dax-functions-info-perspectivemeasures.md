# The A to Z of DAX Functions – INFO.PERSPECTIVEMEASURES

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivemeasures/
...
Power Pivot Principles: The A to Z of DAX Functions – INFO.PERSPECTIVEMEASURES
==============================================================================

14 January 2025

_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (DAX) functions. This week, we look at **INFO.PERSPECTIVEMEASURES**._

**_The_** _**INFO.PERSPECTIVEMEASURES**_ **_function_**
...
The **INFO.PERSPECTIVEMEASURES** function is one of the system functions. It employs the following syntax:

**INFO.PERSPECTIVEMEASURES(\[RestrictionName1\],\[RestrictionValue1\],…)**
...
), the **PerspectiveMeasure** object includes a **Measure** object of a **Table** object into the **Perspective** object. It is a child of a **PerspectiveTable** object.

We can write this **INFO.PERSPECTIVEMEASURES** function on DAX query viewto get the sameinformation on the **TMSCHEMA\_PERSPECTIVE\_MEASURES**:

![](<Base64-Image-Removed>)

Itwill query the **$SYSTEM.****TMSCHEMA\_PERSPECTIVE\_MEASURES** and return an entire table with four \[4\] columns:
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivemeasures/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivemeasures/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivemeasures/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivemeasures/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-perspectivemeasures/#0 "close")
