# The A to Z of DAX Functions – INFO.RELATIONSHIPINDEXSTORAGES

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-relationshipindexstorages/
...
Power Pivot Principles: The A to Z of DAX Functions – INFO.RELATIONSHIPINDEXSTORAGES
====================================================================================

4 March 2025

_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (DAX) functions. This week, we look at **INFO.RELATIONSHIPINDEXSTORAGES**._

**_The_** _**INFO.RELATIONSHIPINDEXSTORAGES**_ **_function_**
...
The **INFO.RELATIONSHIPINDEXSTORAGES**function is one of the system functions. It employs the following syntax:

**INFO.RELATIONSHIPINDEXSTORAGES(\[RestrictionName1\],\[RestrictionValue1\],…)**
...
Currently, there appears to neither be documentation for this **TMSCHEMA\_RELATIONSHIP\_INDEX\_STORAGES** nor **INFO.RELATIONSHIPINDEXSTORAGES**.

We can write this **INFO.RELATIONSHIPINDEXSTORAGES**function on DAX query viewto get the sameinformation on the **TMSCHEMA\_RELATIONSHIP\_INDEX\_STORAGES**:

![](<Base64-Image-Removed>)

Itwill query the **$SYSTEM.****TMSCHEMA\_RELATIONSHIP\_INDEX\_STORAGES** and return an entire table with 10 columns:
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-relationshipindexstorages/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-relationshipindexstorages/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-relationshipindexstorages/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-relationshipindexstorages/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-relationshipindexstorages/#0 "close")
