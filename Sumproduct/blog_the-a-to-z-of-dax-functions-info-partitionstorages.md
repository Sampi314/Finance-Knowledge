# The A to Z of DAX Functions – INFO.PARTITIONSTORAGES

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-partitionstorages/
...
Power Pivot Principles: The A to Z of DAX Functions – INFO.PARTITIONSTORAGES
============================================================================

24 December 2024

_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (DAX) functions. This week, we look at **INFO.PARTITIONSTORAGES**._

**_The_** _**INFO.PARTITIONSTORAGES**_ **_function_**
...
The **INFO.PARTITIONSTORAGES** function is one of the system functions. It employs the following syntax:

**INFO.PARTITIONSTORAGES()**

This function has no parameters.

Currently, there appears to neither be documentation for this **TMSCHEMA\_PARTITION\_STORAGES** nor **INFO.PARTITIONSTORAGES**_._

We can write this **INFO.PARTITIONSTORAGES** function on DAX query viewto get the sameinformation on the **TMSCHEMA\_PARTITION\_STORAGES**:

![](<Base64-Image-Removed>)

Itwill query the **$SYSTEM.****TMSCHEMA\_PARTITION\_STORAGES** and return an entire table with seven \[7\] columns:
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-partitionstorages/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-partitionstorages/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-partitionstorages/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-partitionstorages/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-partitionstorages/#0 "close")
