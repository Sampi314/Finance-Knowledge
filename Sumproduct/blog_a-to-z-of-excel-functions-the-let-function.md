# A to Z of Excel Functions: The LET Function

**Source:** https://sumproduct.com/blog/a-to-z-of-excel-functions-the-let-function/
...
_Welcome back to our regular A to Z of Excel Functions blog. Today we look at the **LET** function._

**The LET Function**

March 2020 saw Microsoft announce a new Excel function, **LET**, for Office 365, albeit at the time of writing, only to the Insiders Channel. This allows you to stop writing the same expressions time and time again in a formula or allows portability of segments of a computation for different formulae. As Microsoft puts it, it’s “…names on a formula level”.
...
*   Finally, the formula  
    **SUMPRODUCT(Selection\*SalesAmt^2)\*Commission/SUMPRODUCT(Selection)** calculates the commission similarly to the approach explained above. However, **Selection**, **SalesAmt** and **Commission** are merely referenced and neither need to be recalculated nor written out in full.
...
To be crystal clear, there are two key differences between defined range names and this new **LET** function:
...
*   [Log in](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-let-function/#0)
    
*   [Register](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-let-function/#0)
...
[Forgot your password?](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-let-function/#0)
...
[Back to login](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-let-function/#0)

[](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-let-function/#0 "close")
