# The A to Z of DAX Functions – INFO.STORAGEFILES

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-storagefiles/
...
Power Pivot Principles: The A to Z of DAX Functions – INFO.STORAGEFILES
=======================================================================

22 April 2025

_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (DAX) functions. This week, we look at **INFO.STORAGEFILES**._

**_The_** _**INFO.STORAGEFILES**_ **_function_**
...
The **INFO.STORAGEFILES** function is one of the system functions. It employs the following syntax:

**INFO.STORAGEFILES(\[RestrictionName1\],  
\[RestrictionValue1\], …)**
...
Currently, there appears to neither be documentation for this **TMSCHEMA\_STORAGE\_FILES** nor **INFO.STORAGE\_FILES**.

We can write this **INFO.STORAGEFILES** function on DAX query viewto get the sameinformation on the **TMSCHEMA\_STORAGE\_FILES**:

![](<Base64-Image-Removed>)

Itwill query the **$SYSTEM.****TMSCHEMA\_STORAGE\_FILES** and return an entire table with five \[5\] columns:
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-storagefiles/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-storagefiles/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-storagefiles/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-storagefiles/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-storagefiles/#0 "close")
