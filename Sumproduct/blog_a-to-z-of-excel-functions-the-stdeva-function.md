# A to Z of Excel Functions: The STDEVA Function

**Source:** https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdeva-function/
...
_Welcome back to our regular A to Z of Excel Functions blog.  Today we look at the **STDEVA** function._

**The STDEVA function**

![](https://sumproduct.com/wp-content/uploads/2025/12/image-41.png)
...
The **STDEVA** estimates the standard deviation based upon a sample of the population (it considers logical values and text).  It is a measure of how widely values are dispersed from the average value (the mean).  The function employs the following syntax to operate:

> **STDEVA(number1\[, number2, …\])**

The **STDEVA** function has the following argument(s):

*   **number1:** this is required and represents the first number argument corresponding to a sample of the population
*   **number2:** this is optional.  This denotes number arguments 2 to 255 corresponding to a sample of the population
...
*   **STDEVA** assumes that its arguments represent a sample of the entire population.  If your data represents the entire population, then compute the standard deviation using **STDEVPA**  
      
    
*   For larger sample sizes, **STDEVA** and **STDEVPA** return approximately equal values
*   the standard deviation is calculated using the “**n**\-1″ method, _i.e._ the number of elements in the sample, **n**, is noted but **n**\-1 is used in the calculation.  This is because **n**\-1 provides an unbiased estimate of the population standard deviation (**n** would underestimate this value) since **n**\-1 represents the degress of freedom in the sample  
...
*   arguments that contain TRUE evaluate as one \[1\]; arguments that contain text or FALSE evaluate as xero \[0\]

*   if an argument is an array, vector or reference, only text and values in that array, vector or reference are used.  Empty cells are ignored

*   arguments that are error values or cannot be translated into numbers cause errors

*   if you do not want to include logical values and text representations of numbers in a reference as part of the calculation, use the **STDEV.S** function
...
*   [Log in](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdeva-function/#0)
    
*   [Register](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdeva-function/#0)
...
[Forgot your password?](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdeva-function/#0)
...
[Back to login](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdeva-function/#0)

[](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdeva-function/#0 "close")
