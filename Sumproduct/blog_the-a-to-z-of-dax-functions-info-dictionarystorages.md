# The A to Z of DAX Functions – INFO.DICTIONARYSTORAGES

**Source:** https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-dictionarystorages/
...
Power Pivot Principles: The A to Z of DAX Functions – INFO.DICTIONARYSTORAGES
=============================================================================

20 August 2024

_In our long-established Power Pivot Principles articles, we continue our series on the A to Z of Data Analysis eXpression (DAX) functions. This week, we look at **INFO.DICTIONARYSTORAGES**._

**_The_** _**INFO.DICTIONARYSTORAGES**_ **_function_**
...
The **INFO.DICTIONARYSTORAGES** function is one of the system functions. It employs the following syntax:

**INFO.DICTIONARYSTORAGES()**

This function has no parameters.

Currently, there appears to neither be documentation for this **TMSCHEMA\_DICTIONARY\_STORAGES** nor **INFO.DICTIONARYSTORAGES**.

We can write this **INFO.DICTIONARYSTORAGES** function on DAX query viewto get the sameinformation on the **TMSCHEMA\_DICTIONARY\_STORAGES**:

![](<Base64-Image-Removed>)

Itwill query the **$SYSTEM.****TMSCHEMA\_DICTIONARY\_STORAGES** and return an entire table with 14 columns:
...
*   [Log in](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-dictionarystorages/#0)
    
*   [Register](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-dictionarystorages/#0)
...
[Forgot your password?](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-dictionarystorages/#0)
...
[Back to login](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-dictionarystorages/#0)

[](https://sumproduct.com/blog/the-a-to-z-of-dax-functions-info-dictionarystorages/#0 "close")
