# A to Z of Excel Functions: The STDEV Function

**Source:** https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdev-function/
...
Firstly the fraction below:

![](<Base64-Image-Removed>)

adjusts the height of the curve so that the total area under the curve equals one \[1\], as a probability distribution must.  
  
Secondly, the exponential term below:

![](<Base64-Image-Removed>)

ensures that data closer to the mean is more likely (higher on the curve) and data farther away is less likely (lower on the curve).
...
The **STDEV** estimates the standard deviation based upon a sample of the data.  It is a measure of how widely values are dispersed from the average value (the mean).  The function employs the following syntax to operate:

> **STDEV(number1\[, number2, …\])**

The **STDEV** function has the following argument(s):
...
*   **STDEV** assumes that its arguments are a sample of the population.  If your data represents the entire population, then compute the standard deviation using **STDEVP** _(also an older function)  
    _
...
*   [Log in](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdev-function/#0)
    
*   [Register](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdev-function/#0)
...
[Forgot your password?](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdev-function/#0)
...
[Back to login](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdev-function/#0)

[](https://sumproduct.com/blog/a-to-z-of-excel-functions-the-stdev-function/#0 "close")
