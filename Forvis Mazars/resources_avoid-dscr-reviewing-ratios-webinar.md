# Reviewing ratios by re-performance: Avoid DSCR nightmares

**Source:** https://financialmodelling.forvismazars.com/resources/avoid-dscr-reviewing-ratios-webinar
...
[](http://twitter.com/share?text=Reviewing+ratios+by+re-performance%3A+Avoid+DSCR+nightmares&url=https://financialmodelling.forvismazars.com/resources/avoid-dscr-reviewing-ratios-webinar/)
[](https://www.facebook.com/sharer/sharer.php?u=https://financialmodelling.forvismazars.com/resources/avoid-dscr-reviewing-ratios-webinar/)
[](https://www.linkedin.com/cws/share?url=https://financialmodelling.forvismazars.com/resources/avoid-dscr-reviewing-ratios-webinar/)
[](mailto:?subject=Reviewing%20ratios%20by%20re-performance:%20Avoid%20DSCR%20nightmares&body=https://financialmodelling.forvismazars.com/resources/avoid-dscr-reviewing-ratios-webinar/)

This webinar will explain how our world-leading model audit team provides assurance to lenders and investors on key financial ratios with respect to some of the largest and most important infrastructure and energy transactions globally.

**The learning objectives in this webinar:**

*   Understand how the #1 model auditor (by size and volume) reviews key financial ratios
*   Learn the most frequent errors that we see in DSCR modelling
*   Learn the most frequent errors that we see in LLCR/PLCR modelling
...
Some of these cookies are necessary, while others help us analyse our traffic, serve advertising and deliver customised experiences for you. For more information on the cookies we use, please refer to our [Privacy Policy](https://financialmodelling.forvismazars.com/resources/avoid-dscr-reviewing-ratios-webinar#)
.
