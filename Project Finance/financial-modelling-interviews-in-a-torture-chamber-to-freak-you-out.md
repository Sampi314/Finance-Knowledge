# Financial Modelling Interviews in a Torture Chamber to Freak You Out

**Source:** https://edbodmer.com/financial-modelling-interviews-in-a-torture-chamber-to-freak-you-out
...
I have some additional corprorate model case and LBO cases at the link below;

[https://edbodmer.com/hellish-corporate-modelling-interviews-to-make-you-nervous/](https://edbodmer.com/hellish-corporate-modelling-interviews-to-make-you-nervous/)

Some Examples of Understandable Comments
----------------------------------------

 Here is one comment: “_I’m so keen to get this new job but been modelling corporate finance and not energy for the past few years and not written an exam in 10 years! So I’m stressing out more than a teenager before high school finals_.”

I am recently invited for a 1-hour excel modelling test by an Infrastructure PE firm. _The model test is based on a typical infrastructure asset acquisition. In total you will need 1h30 for the test which will comprise ~10min briefing call at the start, 60mins to complete the test and ~20min debrief call at the end via video conference (Teams)._ I have about 1 week to prepare and I’m feeling very nervous as I’m unsure how I should prepare for it. I have done some PF modelling from my university degree but I’ve never done any acquisition/ valuation model.

.

I’ve just failed a simple project finance modelling test (toll road). I failed mainly on debt sizing (DSCR and leverage ratio).

First, if you want some examples I have collected:

If you send an email to [edwardbodmer@gmail.com](mailto:edwardbodmer@gmail.com)
 I will send a fairly large collection of exams that includes a lot of big companies including investment banks, private equity firms, energy companies and others.

Here is some advise I gave, you may disagree.

*   An acquisition on a project only means that you have one period of CapExp.  By this I mean that you can apply all of the project finance modelling you have learnt in university but think of the acquisition price as one period. Do not worry about anything like goodwill.
*   When Hedieh and I talk I, we think about the people making the evaluation. I think they want to see that you can make a quick and clearly structure spreadsheet. Please, the university profs are generally really bad at this. You need a clear timeline, a clear separation of project IRR before any financing and a very simple financing to get equity IRR.
*   Please do not get too fancy with something you may have seen from Mazars or F1 F9.  
*   Please also practice doing some basic stuff really fast and if you have a question about something that seems complex, skip to the next item.
*   I am now sending you some of the cases in Chapter 1.  But please do not worry about the complex stuff.

![](https://edbodmer.com/wp-content/uploads/2023/06/image-13.png)
...
1.  Determining the debt size. They will often give you a debt to capital ratio, but they may give you a DSCR applied to cash flow. One way or another you should have a uses and sources of funds that works through the debt sizing.
2.  The second item is funding. If they give you an annutal model and one period of construction, you do not have to worry about this. Sometimes they may give you a test with more than one construction period and you have to work through how the debt is financed.
3.  The third item is debt repayment. They generally give you the debt tenure and they may put the sculpting here.
4.  The fourth item is the interest rate that can include fees. You need the debt balance to compute this, meaning that the interest and fees should be included after the other debt components are developed.
...
.\
\
**[PDF File with Instructions for Creating a Bureacuratic Model Using the FAST Modelling Standard](https://edbodmer.com/wp-content/uploads/2022/05/Sample_ProjectFM_test-1.pdf)\
**\
\
.\
\
**[Excel File with example of FAST Standard Applied to Project Finance Model for Solar Case](https://edbodmer.com/wp-content/uploads/2022/05/Bond-Example-Excel-Prison.pdf)\
**\
\
.\
\
...
\
![](https://edbodmer.com/wp-content/uploads/2021/04/image-52.png)\
\
...
\
![](https://edbodmer.com/wp-content/uploads/2019/04/long-formula.png)\
\
.\
\
...
.\
\
**[Excel File with Exercise for Different Types of Functions and Problems Such as Countif to Find Duplicates and Cond Formatting](https://edbodmer.com/wp-content/uploads/2022/06/Advanced_Spreadsheet_Skills_for_Finance_Exercises_2.xls)\
**\
\
.\
\
**[Excel File with Completed Exercises Made By Me With a Lot of TRUE FALSE Flags and LOOKUP Functions](https://edbodmer.com/wp-content/uploads/2022/06/Advanced_Spreadsheet_Skills_for_Finance_Exercises_EB.xlsx)\
**\
\
.\
\
...
.\
\
**[Excel File with Case Study Exercise on Solar Project for Interview Example Used in Video Explanation](https://edbodmer.com/wp-content/uploads/2021/04/Interviews-from-Hell.xlsm)\
**\
\
.\
\
...
.\
\
**[PDF File with Instructions for Creating a Solar Project Finance Model with Taxes and Sculpting of Debt](https://edbodmer.com/wp-content/uploads/2022/05/Project-Finance-Modeling-Test-v2.pdf)\
**\
\
.\
\
...
.\
\
This bond financing case is a pretty advanced exam. To do it I think it is essential to create a sources and uses of funds analysis. When you first read the case you head may be spinning a bit, but don’t worry and make sure to always begin with the time line and the operations. You can find what I define as crimes at [https://edbodmer.com/high-crimes-in-project-finance-modelling/](https://edbodmer.com/high-crimes-in-project-finance-modelling/)\
. I have made a video about this one because my friend Jose asked for a bond financing case. The instruction file and the excel file for this case is attached to the buttons below. The first button is attached to test write-up with the bond financing. The second button includes the completed spreadsheet.\
\
.\
\
**[PDF file with Interview Test using Bonds in Project Finance; Test Solutions is in Video Below](https://edbodmer.com/wp-content/uploads/2022/05/Bond-Example-Excel-Prison.pdf)\
**\
\
.\
\
**[Excel File with with Case Study for Interview with PPP and Bond Financing and Monthly Cash Flow](https://edbodmer.com/wp-content/uploads/2021/05/Bond-Financing-Case2.xlsb)\
**\
\
.\
\
...
.\
\
![](https://edbodmer.com/wp-content/uploads/2022/05/image.png)\
\
.\
\
...
\
**[Excel File with Inputs for Tollway Example with Inputs that are Very Badly Set-up and Should be Re-Structured](https://edbodmer.com/wp-content/uploads/2022/05/Tollway-Inputs.xlsx)\
**\
\
.\
\
**[PDF File with Instructions for Model of Toll Road Case with Inputs the Should be Set-up in Organised Manner](https://edbodmer.com/wp-content/uploads/2022/05/Tollroad-Test.pdf)\
**\
\
.\
\
...
.\
\
**[PDF File with Instructions for Model that Includes U.S. Tax Complications and Monthly Construction](https://edbodmer.com/wp-content/uploads/2022/05/US-Tax-Example.pdf)\
**\
\
...
.\
\
**[PDF File with Instructions for Model that Includes Natural Gas Electricity Plant with Capacity Charge](https://edbodmer.com/wp-content/uploads/2022/05/Gas-Plant-Example.pdf)\
**\
\
.\
\
**[Excel File with Case Study Exercise on Thermal Project for Interview Example Used in Video Explanation](https://edbodmer.com/wp-content/uploads/2021/04/Thermal-Example.xlsx)\
**\
\
.\
\
...
\
**[PDF File with Instructions for Mini Grid Model that is Confusing and Requires Clarification Before Excel Analysis](https://edbodmer.com/wp-content/uploads/2022/05/Stormy-Daniels-Mini-Grid.pdf)\
**\
\
...
.\
\
**[Power Point with Instruuctions on How to Create Port Model with Mixed Corporate and Project Analysis](https://edbodmer.com/wp-content/uploads/2022/06/AustralianSuper-Infrastructure-debt-case-study.pptx)\
**\
\
.\
\
**[Excel Fine for Port Model with Mixed Corporate and Project Analysis with Bad Practise](https://edbodmer.com/wp-content/uploads/2022/06/AustralianSuper-Infrastructure-debt-case-study.pptx)\
**\
\
.\
\
...
\
**[PDF File with Instructions for Creating a Model for a Shipping Ocean Rig Case with Corporate Finance](https://edbodmer.com/wp-content/uploads/2022/05/Ocean-Rig-Case-Study.pdf)\
**\
\
.\
\
Transport Case that I Failed to Complete in Two Hours\
-----------------------------------------------------\
\
.\
\
This example demonstrates a painful case were you compute the subsidy from an after-tax project IRR and then you compute the equity IRR from financing assumptions. As with other cases, you compute some inflation indices and time lines. This time there is a little tricky issue with heavy maintenance expenditures and with residual value which can be time consuming. The way it was written with a terminal sale value that was not equal to the book value was painful from a tax standpoint and the way they wanted you to complete a three statement model instead of a project finance model took a little time.\
\
.\
\
**[Transport Case Instructions for Three Statement Financial Model with Compuation of Target Subsidy](https://edbodmer.com/wp-content/uploads/2023/06/Word-Case.pdf)\
**\
\
.\
\
**[Transport Case with Target Subsidy for Torture Interviews that I Could Not Complete in the Time Limit of Two Hours](https://edbodmer.com/wp-content/uploads/2023/06/Transport-Case-Study.xlsm)\
**\
\
.\
\
...
.\
\
**[Private Equity Interview Case Study Blank Excel with Acquision Analysis and Financing with Cash Sweep and Refinance](https://edbodmer.com/wp-content/uploads/2023/08/Advisory-Modelling-Test-Blank.xlsx)\
**\
\
.\
\
.\
\
**[Private Equity Interview Case Study write-up with Acquision Analysis and Financing with Cash Sweep and Refinance](https://edbodmer.com/wp-content/uploads/2023/08/Advisory-Infrastructure-Modelling-Test-latest.docx)\
**\
\
.\
\
.\
\
**[Private Equity Interview Case Study Complete Excel with Acquision Analysis and Financing with Cash Sweep and Refinance](https://edbodmer.com/wp-content/uploads/2023/08/Advisory-Modelling-Test-Completed.xlsx)\
**\
\
.\
\
...
\
This is the only info provided, “I would like to move you to the excel modeling test round. It will be a 3-hour test where you will be provided with a document to create a short excel model. The test will be evaluated based on three criteria which will carry different weight: Methodology, Presentation, and Answer. An independent person will evaluate the test and based on that we will decide if you are moving to the final round of interview with two of my colleagues.” \
\
![](https://pixel.wp.com/g.gif?v=ext&blog=182904628&post=8209&tz=0&srv=edbodmer.com&j=1%3A13.2.3&host=edbodmer.com&ref=&fcp=12928&rand=0.6626991191573356)