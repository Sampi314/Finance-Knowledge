...
**Source:** https://chandoo.org/wp/resources/ways-to-analyze-business-data
...
Want more? 50 Ways to Analyze Data is for you:
...
We are re-opening this program for new students on 11th of April 2018 (Wednesday). Check out [50 ways to analyze data program course page](http://chandoo.org/wp/resources/50-ways-to-analyze-data/)
 for more information and enrollment process. If you are keen, click below button to join the course waiting list.

[**Join Waiting List**](http://forms.aweber.com/form/95/1834602295.htm)
.