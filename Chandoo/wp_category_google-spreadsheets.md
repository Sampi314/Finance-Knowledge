# Google Spreadsheets - Tip & Tricks Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/category/google-spreadsheets

---

All articles in 'Google Spreadsheets – Tip & Tricks' Category
=============================================================

{ [**8** Comments](https://chandoo.org/wp/now-edit-google-spreadsheets-using-ms-excel/#comments)
 }

[Now Edit Google Spreadsheets using MS Excel](https://chandoo.org/wp/now-edit-google-spreadsheets-using-ms-excel/ "Now Edit Google Spreadsheets using MS Excel")

-----------------------------------------------------------------------------------------------------------------------------------------------------------------

Published on May 21, 2009 _in_ [Excel Howtos](https://chandoo.org/wp/category/excel-howtos/)
, [Google Spreadsheets - Tip & Tricks](https://chandoo.org/wp/category/google-spreadsheets/)

[![Now Edit Google Spreadsheets using MS Excel](https://chandoo.org/img/n/offisync-toolbar-for-excel-th.png)](https://chandoo.org/wp/now-edit-google-spreadsheets-using-ms-excel/ "Now Edit Google Spreadsheets using MS Excel")
...
[Continue »](https://chandoo.org/wp/now-edit-google-spreadsheets-using-ms-excel/)

{ [**4** Comments](https://chandoo.org/wp/google-spreadsheets-introduces-data-validation-sweet/#comments)
 }

[Google Spreadsheets Introduces Data Validation, Sweet!](https://chandoo.org/wp/google-spreadsheets-introduces-data-validation-sweet/ "Google Spreadsheets Introduces Data Validation, Sweet!")

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Published on Feb 18, 2009 _in_ [Google Spreadsheets - Tip & Tricks](https://chandoo.org/wp/category/google-spreadsheets/)

[![Google Spreadsheets Introduces Data Validation, Sweet!](https://chandoo.org/img/a/google-spreadsheets-validation.png)](https://chandoo.org/wp/google-spreadsheets-introduces-data-validation-sweet/ "Google Spreadsheets Introduces Data Validation, Sweet!")
...
[Continue »](https://chandoo.org/wp/google-spreadsheets-introduces-data-validation-sweet/)
