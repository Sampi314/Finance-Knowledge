# activerange Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/tag/activerange

---

All articles with 'activerange' Tag
===================================

{ [**207** Comments](https://chandoo.org/wp/excel-stock-quotes/#comments)
 }

[Get Stock Quotes using Excel Macros \[and a Crash Course in VBA\]](https://chandoo.org/wp/excel-stock-quotes/ "Get Stock Quotes using Excel Macros [and a Crash Course in VBA]")

----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Published on Jun 2, 2010 _in_ [Learn Excel](https://chandoo.org/wp/category/excel/)
, [VBA Macros](https://chandoo.org/wp/category/vba-macros/)

[![Get Stock Quotes using Excel Macros [and a Crash Course in VBA]](https://img.chandoo.org/vba/stock-quotes-in-excel-macro.png)](https://chandoo.org/wp/excel-stock-quotes/ "Get Stock Quotes using Excel Macros [and a Crash Course in VBA]")
...
[Continue »](https://chandoo.org/wp/excel-stock-quotes/)
