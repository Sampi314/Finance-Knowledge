# 3d references Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/tag/3d-references

---

All articles with '3d references' Tag
=====================================

{ [**4** Comments](https://chandoo.org/wp/3d-max-formula-for-excel/#comments)
 }

[3D Max Formula for Excel](https://chandoo.org/wp/3d-max-formula-for-excel/ "3D Max Formula for Excel")

--------------------------------------------------------------------------------------------------------

Published on Sep 9, 2014 _in_ [Excel Howtos](https://chandoo.org/wp/category/excel-howtos/)
, [Learn Excel](https://chandoo.org/wp/category/excel/)

[![3D Max Formula for Excel](https://img.chandoo.org/f/3d-max-formula-what-is-the-maximum-of-all-months.png)](https://chandoo.org/wp/3d-max-formula-for-excel/ "3D Max Formula for Excel")
...
[Continue »](https://chandoo.org/wp/3d-max-formula-for-excel/)

{ [**50** Comments](https://chandoo.org/wp/excel-consolidate-data/#comments)
 }

[How do you consolidate data from multiple sheets in to one? \[open thread\]](https://chandoo.org/wp/excel-consolidate-data/ "How do you consolidate data from multiple sheets in to one? [open thread]")

----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Published on Feb 19, 2010 _in_ [Excel Howtos](https://chandoo.org/wp/category/excel-howtos/)

[![How do you consolidate data from multiple sheets in to one? [open thread]](https://chandoo.org/img/dlt/howto-consolidate-data-from-multiple-excels.png)](https://chandoo.org/wp/excel-consolidate-data/ "How do you consolidate data from multiple sheets in to one? [open thread]")
...
[Continue »](https://chandoo.org/wp/excel-consolidate-data/)
