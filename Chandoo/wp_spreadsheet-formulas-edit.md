# Spreadsheet Formulas : Edit Using Find / Replace

**Source:** https://chandoo.org/wp/spreadsheet-formulas-edit
...
![Find replace formulas to change them quickly in Excel.](https://chandoo.org/wp/wp-content/uploads/2019/02/find-replace-formulas.png)

What are you still waiting for? Go get that espresso!

**Do you know that you can [use find / replace to change spreadsheet formatting](http://chandoo.org/wp/2008/04/04/change-cell-formats-with-find-replace-in-excel/)
 too ?**

_This post is part of our quick tips series – [Learn more Excel quick tips](http://chandoo.org/wp/tag/quick-tip)
.  
_

**Excel Formulas Too Confusing ? You should [join Excel School](https://chandoo.org/wp/excel-school-program/)
.**
...
*   [37 Comments](https://chandoo.org/wp/spreadsheet-formulas-edit/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/spreadsheet-formulas-edit/#respond)
...
[PrevPreviousQuickly change charts from one to another with this trick](https://chandoo.org/wp/howto-change-excel-chart/)

[NextEmployee Turnover Dashboard – Power BI for HRNext](https://chandoo.org/wp/employee-turnover-dashboard-powerbi/)
