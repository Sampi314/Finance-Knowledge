# Show Months & Years in Charts without Cluttering » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/show-months-years-in-charts
...
![Date Axis with Months & Years - An example excel chart](https://img.chandoo.org/c/date-axis-with-month.png)
...
Now, there is nothing much I can do about donut consumption. **But I can tell you how to fix that axis so it looks a lot better**, _may be like this:_

![Date Axis with Grouped Months & Years - An Excel Chart Example](https://chandoo.org/img/c/date-axis-with-month-year.png)

### Interested? Follow this simple recipe:

1.  **Process your data:** Assuming your data looks like what I shown to left, just use simple formulas to make it look like the table to right. \[related: [how to work with dates & times in excel](http://chandoo.org/wp/2008/08/26/date-time-tips-ms-excel/)\
    \]![Date Axis with Months & Years - Sample Data](https://chandoo.org/img/c/date-axis-with-month-year-data.png)
...
_**Pretty simple, eh?**_

### Download the Excel Chart Template

[Click here to download excel chart template & workbook showing this technique](http://cid-b663e096d6c08c74.office.live.com/view.aspx/Public/date-axis-months-years-trick.xls)
. Play with the formulas & chart formatting to learn.
...
**2\. Further reduce clutter by unchecking _Multi Level Category Labels_ option**
...
![Grouped Axis Examples - Excel Charts](https://img.chandoo.org/c/grouped-axis-in-charts-examples.png)
...
*   [How to change data labels in charts to whatever you want](http://chandoo.org/wp/2010/05/05/change-data-labels-in-charts/)
    
*   [Making your chart legends look awesome](http://chandoo.org/wp/2010/04/08/smart-chart-legends/)
    
*   [Use paste special to Speed up chart formatting](http://chandoo.org/wp/2010/02/24/paste-special-chart-formatting/)
    
*   … More [chart formatting tips](http://chandoo.org/wp/tag/chart-formatting/)
...
*   [33 Comments](https://chandoo.org/wp/show-months-years-in-charts/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/show-months-years-in-charts/#respond)
...
*   Tagged under [axis formatting](https://chandoo.org/wp/tag/axis-formatting/)
    ...
    , [charting tips](https://chandoo.org/wp/tag/charting-tips/)
...
[PrevPreviousWelcome to Chandoo.org. A short introduction to this website](https://chandoo.org/wp/welcome-to-chandoo-dot-org/)

[NextScheduling Variable Feed SourcesNext](https://chandoo.org/wp/scheduling-variable-sources/)
