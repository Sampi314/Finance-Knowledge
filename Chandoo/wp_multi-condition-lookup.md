# How to Look up Based on Multiple Conditions » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/multi-condition-lookup
...
![Data for this Example -Looing up Based on More than One Value](https://chandoo.org/img/f/vw/vlookup-data-2.png)
...
|     |     |
| --- | --- |
| **Using SUMIFS Formula** \[[help](http://chandoo.org/wp/2010/04/20/introduction-to-excel-sumifs-formula/ "Using SUMIFS Formula")<br>\] |     |
| Formula | `=SUMIFS(lstSales, lstSalesman,valSalesman, lstMonths,valMonth, lstRegion,valRegion, lstProduct,valProduct)` |
| Result | 1592 |
|     |     |
| **Using SUMPRODUCT Formula** \[[help](http://chandoo.org/wp/2009/11/10/excel-sumproduct-formula/ "Using SUMPRODUCT Formula")<br>\] |     |
| Formula | `=SUMPRODUCT(lstSales,(lstSalesman=valSalesman)*(lstMonths=valMonth)*(lstRegion=valRegion)* (lstProduct=valProduct))` |
| Result | 1592 |
|     |     |
| **Using INDEX & Match Formulas (Array Formula)** \[[help](http://chandoo.org/wp/2008/11/19/vlookup-match-and-offset-explained-in-plain-english-spreadcheats/ "Using INDEX & Match Formulas (Array Formula)")<br>\] |     |
| Formula | `{=INDEX(lstSales,MATCH(valSalesman&valMonth&valRegion&valProduct, lstSalesman&lstMonths&lstRegion&lstProduct,0))}` |
| Result | 1592 |
|     |     |
| **Using VLOOKUP Formula** \[[help](http://chandoo.org/wp/2010/11/01/vlookup-excel-formula/ "Using VLOOKUP Formula")<br>\] |     |
...
|     |     |
| **Using SUM (Array Formula)** \[[help](http://chandoo.org/wp/2009/07/22/sumif-with-multiple-conditions/ "Using SUM (Array Formula)")<br>\] |     |
| Formula | `{=SUM(lstSales*(lstSalesman=valSalesman)*(lstMonths=valMonth)* (lstRegion=valRegion)*(lstProduct=valProduct))}` |
| Result | 1592 |

### Sample File

[Download Example File – Looking up Based on More than One Value](https://img.chandoo.org/f/vw/vlookup-on-multiple-conditions.xls)

Go ahead and download the file. **It also has some homework for you to practice these formula tricks.**

Also [checkout the examples](http://cid-9fbb85221c1cb69c.office.live.com/self.aspx/public/MultipleLookup-multipleways.xlsx)
 _**Vinod**_ has prepared.

### Special Thanks to

[Rohit1409](http://chandoo.org/wp/2010/10/05/bad-news-vlookup-contest/#comment-131572)
, [dan l](http://chandoo.org/wp/2010/10/05/bad-news-vlookup-contest/#comment-131505)
, [John](http://chandoo.org/wp/2010/10/05/bad-news-vlookup-contest/#comment-132024)
, [Godzilla](http://chandoo.org/wp/2010/10/05/bad-news-vlookup-contest/#comment-131468)
, [Vinod](http://chandoo.org/wp/2010/10/05/bad-news-vlookup-contest/#comment-132267)

### Similar Tips

*   [Excel SUMIFS Formula – What is it, how to use it & examples](http://chandoo.org/wp/2010/04/20/introduction-to-excel-sumifs-formula/)
...
*   [63 Comments](https://chandoo.org/wp/multi-condition-lookup/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/multi-condition-lookup/#respond)
...
[PrevPreviousHow to Lookup Values to Left?](https://chandoo.org/wp/how-to-lookup-values-to-left/)

[Next6 Tips for Writing Better VLOOKUPsNext](https://chandoo.org/wp/excel-vlookup-tips/)
...
1.  ![](https://secure.gravatar.com/avatar/009649ad2a9f58f64a563b208b196d4e78b4e506bf2eeb2ab4c84a820fd0aa0e?s=64&d=mm&r=g) Montu says:
    ...
    [Reply](https://chandoo.org/wp/multi-condition-lookup/#comment-2107616)
    ...
    *   ![](https://secure.gravatar.com/avatar/534f3043f65d0d27072d17a5dc64da8425eaf628f6915bb23d453d3f6cd3e5df?s=64&d=mm&r=g) [Chandoo](http://chandoo.org/wp)
        ...
        [Reply](https://chandoo.org/wp/multi-condition-lookup/#comment-2107623)
...
2.  ![](https://secure.gravatar.com/avatar/b466b5dcbff92562675873cda426fd5244289b247a4fa8c9018f1ab2867b509d?s=64&d=mm&r=g) [Raphael](http://nil/)
    ...
    [Reply](https://chandoo.org/wp/multi-condition-lookup/#comment-2122498)
