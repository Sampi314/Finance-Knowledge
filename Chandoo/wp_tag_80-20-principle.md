# 80 20 principle Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/tag/80-20-principle

---

All articles with '80 20 principle' Tag
=======================================

{ [**56** Comments](https://chandoo.org/wp/pareto-charts/#comments)
 }

[Pareto Charts – How to do pareto analysis using Excel?](https://chandoo.org/wp/pareto-charts/ "Pareto Charts – How to do pareto analysis using Excel?")

---------------------------------------------------------------------------------------------------------------------------------------------------------

Published on Sep 2, 2009 _in_ [Analytics](https://chandoo.org/wp/category/analytics/)
, [Charts and Graphs](https://chandoo.org/wp/category/visualization/)
, [Featured](https://chandoo.org/wp/category/best-of-phd/)

[![Pareto Charts – How to do pareto analysis using Excel?](https://chandoo.org/img/p/pareto-chart-template.png)](https://chandoo.org/wp/pareto-charts/ "Pareto Charts – How to do pareto analysis using Excel?")
...
[Continue »](https://chandoo.org/wp/pareto-charts/)
