# applications Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/tag/applications

---

All articles with 'applications' Tag
====================================

{ [**24** Comments](https://chandoo.org/wp/satisfaction-surveys-excel/#comments)
 }

[Employee Satisfaction Surveys using MS Excel](https://chandoo.org/wp/satisfaction-surveys-excel/ "Employee Satisfaction Surveys using MS Excel")

--------------------------------------------------------------------------------------------------------------------------------------------------

Published on Feb 4, 2009 _in_ [Excel Howtos](https://chandoo.org/wp/category/excel-howtos/)
, [Learn Excel](https://chandoo.org/wp/category/excel/)

[![Employee Satisfaction Surveys using MS Excel](https://chandoo.org/img/a/satisfaction-surveys.png)](https://chandoo.org/wp/satisfaction-surveys-excel/ "Employee Satisfaction Surveys using MS Excel")

Today we will learn how to make an employee satisfaction survey and consolidate the data using excel.

[Continue »](https://chandoo.org/wp/satisfaction-surveys-excel/)

{ [**21** Comments](https://chandoo.org/wp/simple-todo-list-using-excel/#comments)
 }

[Simple Todo List application using Excel – Download and become productive](https://chandoo.org/wp/simple-todo-list-using-excel/ "Simple Todo List application using Excel – Download and become productive")

--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Published on Oct 1, 2008 _in_ [Learn Excel](https://chandoo.org/wp/category/excel/)

[![Simple Todo List application using Excel – Download and become productive](https://chandoo.org/wp/wp-content/uploads/2008/10/excel-to-do-list-thumb.png)](https://chandoo.org/wp/simple-todo-list-using-excel/ "Simple Todo List application using Excel – Download and become productive")
...
[Continue »](https://chandoo.org/wp/simple-todo-list-using-excel/)
