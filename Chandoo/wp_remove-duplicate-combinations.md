# Remove duplicate combinations in your data [quick tip] » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/remove-duplicate-combinations
...
By now, we know how to remove duplicates from data. You can [use the **Remove Duplicates** button](http://chandoo.org/wp/2009/06/22/remove-duplicates/)
 to do that.

But do you know that we can use _remove duplicates button to get rid off duplicate combinations too?_
...
![Remove duplicate combinations in your data - how to?](https://chandoo.org/wp/wp-content/uploads/2015/08/remove-duplicate-combinations-v2.gif)

### How to remove duplicate combinations in _some of the columns_
...
![Remove duplicate combinations using Excel - tip](https://chandoo.org/wp/wp-content/uploads/2015/08/remove-duplicate-combinations-excel-tip.png)
...
*   **Advanced & array formula approaches:**
    *   [How to extract unique, duplicate & missing items](http://chandoo.org/wp/2008/11/06/unique-duplicate-missing-items-excel-help/)
        
    *   [Find if a list has duplicates in it](http://chandoo.org/wp/2009/03/25/using-array-formulas-example1/)
        
    *   [Prevent duplicate data entry](http://chandoo.org/wp/2009/10/26/duplicate-data-entry/)
        
*   **Pivot Tables & other techniques:**
    *   [Remove duplicates & sort a list](http://chandoo.org/wp/2010/09/27/remove-duplicates-using-pivot-tables/)
        
    *   [How to use Remove Duplicates button](http://chandoo.org/wp/2009/06/22/remove-duplicates/)
        
*   **Highlighting duplicate entries:**
    *   [Highlighting common values / duplicates between 2 lists](http://chandoo.org/wp/2010/07/01/compare-lists-excel-tip/)
        
    *   [Highlight repeat customers](http://chandoo.org/wp/2010/01/06/highlight-repeat-customers/)
        
    *   Compare 2 lists – [more techniques](http://chandoo.org/wp/2010/06/17/compare-2-lists-in-excel/)
        , [even more techniques](http://chandoo.org/wp/2011/10/27/compare-2-lists-visually-and-highlight-matches/)
        , [a podcast](http://chandoo.org/wp/2014/10/02/cp021-how-to-quickly-compare-2-lists-in-excel/)
...
_This post is part of [Awesome August Excel Festival](http://chandoo.org/wp/resources/awesome-august/)
._
...
*   [7 Comments](https://chandoo.org/wp/remove-duplicate-combinations/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/remove-duplicate-combinations/#respond)
...
[PrevPreviousCP041: 6 charts you’ll see in hell – v2.0](https://chandoo.org/wp/6-charts-youll-see-in-hell-v2/)

[NextUse shapes to enhance your Excel charts \[tip\]Next](https://chandoo.org/wp/shapes-in-charts/)
