# Show all named ranges in Excel - Spreadsheet Audit & Maintenance Tip

**Source:** https://chandoo.org/wp/show-all-names-excel
...
_**Now, how do you keep track of all these names?**_

Thankfully, there is just the feature for this, called as “_**paste names**_“.

This is how it works.

![Paste All Named Ranges - Excel](https://chandoo.org/img/q/paste-all-named-ranges-excel.gif)
...
![How to show all the named ranges in excel?](https://chandoo.org/img/q/how-to-paste-names-excel.png)

That is all. Go back to eating spaghetti, now.

**More tips on spreadsheet maintenance:**

*   [What to do if you have too many worksheets?](http://chandoo.org/wp/2009/02/16/excel-table-of-contents-etc/)
    
*   [How to consolidate data from multiple workbooks](http://chandoo.org/wp/2010/02/19/excel-consolidate-data/)
    

PS: Here is a [great recipe](http://chandoo.org/wp/excel-school/ "Excel School Online Training Program")
 if you don’t know how to make awesome spaghetti.
...
*   [12 Comments](https://chandoo.org/wp/show-all-names-excel/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/show-all-names-excel/#respond)
...
*   Tagged under [Excel Howtos](https://chandoo.org/wp/tag/excel-howtos/)
    ...
    , [spreadsheet maintenance](https://chandoo.org/wp/tag/spreadsheet-maintenance/)
    , [spreadsheets](https://chandoo.org/wp/tag/spreadsheets/)
    
*   Category: [Excel Howtos](https://chandoo.org/wp/category/excel-howtos/)
    

[PrevPreviousYou are invited \[personal\]](https://chandoo.org/wp/birthday-invitation/)

[NextPutting it all together – Final Project Evaluation Model \[Part 6 of 6\]Next](https://chandoo.org/wp/project-valuation-model-in-excel/)
