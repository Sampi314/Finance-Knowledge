# Statistical Distributions in Excel - How to calculate frequency distributions?

**Source:** https://chandoo.org/wp/statistical-distributions
...
_This is a part of our spreadcheats series of posts where we aim to solve 30 common work related excel problems, one at a time. [Read the earlier spreadcheats here](http://chandoo.org/wp/tag/spreadcheats)
._

Just follow the below 2 steps to create statistical distribution / frequency of any set of values using excel. Also, [download the statistical distributions example workbook](http://chandoo.org/img/n/test-scores-distribution.zip)
 and play with it.
...
_How do you do that?_ Simple, select a range of cells, enter the formula in the first cell by start typing =frequency… and when you are done, just press ctrl+shift+enter and excel takes care of the rest.
...
![Statistical Distributions in Excel using Frequency Formula](https://chandoo.org/img/n/statistical-distributions-using-frequency.gif)

That is all. So simple isn’ t it?

[Download the statistical distributions example workbook](http://chandoo.org/img/n/test-scores-distribution.zip)
 and play with the formulas yourself.

_**More on statistics and excel:**_

[Simulate dice throws in excel](http://chandoo.org/wp/2008/08/13/simulate-dice-throws/)

[Shuffling a list of numbers in excel](http://chandoo.org/wp/2008/09/23/sort-in-random-order-excel-formulas/)
...
*   [72 Comments](https://chandoo.org/wp/statistical-distributions/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/statistical-distributions/#respond)
...
[PrevPreviousArray formula to check if a number is prime \[just for fun\]](https://chandoo.org/wp/array-formula-to-check-if-a-number-is-prime-just-for-fun/)

[NextTweetboard Implementations – Download and make your twitter style dashboard todayNext](https://chandoo.org/wp/tweetboard-implementations/)
