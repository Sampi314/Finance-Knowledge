# Remove Duplicates [Quick Video Tip] » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/remove-duplicates
...
![remove-duplicates-excel](https://chandoo.org/img/i/6-remove-duplicates-excel.png) It is very surprising that so many of us are still not aware of this extremely powerful tool in Excel 2007. Just with a click of the button, you can remove all the duplicate values from a list / table. To remove duplicates,
...
[Click here](http://www.youtube.com/watch?v=8kd8IgyJIcw)
 to watch on youtube.

PS: 15 second tutorials idea inspired from google tutorials.

PPS: [Learn more quick tips](http://chandoo.org/wp/tag/quick-tip/ "Learn MS Excel Quick Tips")
, they make you blazing fast.

PPPS: There are 4 more ways to remove duplicates: [1](http://chandoo.org/wp/2006/09/04/how-to-get-unique-items-using-excel/)
 [2](http://chandoo.org/wp/2008/06/19/quickly-display-unique-items-in-an-excel-list-using-advanced-filters/)
 [3](http://chandoo.org/wp/2008/11/06/unique-duplicate-missing-items-excel-help/)
 [4](http://chandoo.org/wp/2009/02/03/excel-pivot-tables-unique-items/)
...
*   [Ask a question or say something...](https://chandoo.org/wp/remove-duplicates/#respond)
    
*   Tagged under [15sectuts](https://chandoo.org/wp/tag/15sectuts/)
...
[PrevPreviousAsset Allocation Chart Turns Zombie \[ChartBusters #1\]](https://chandoo.org/wp/bad-asset-allocation-chart/)

[NextExcel Links – Bacon bits are good editionNext](https://chandoo.org/wp/excel-links-bacon-edition/)
