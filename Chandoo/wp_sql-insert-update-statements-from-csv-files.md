# SQL Queries from Excel: How to generate SQL Insert / Update queries from CSV / XLS data using formulas?

**Source:** https://chandoo.org/wp/sql-insert-update-statements-from-csv-files
...
![sql-insert-update-query-from-csv-xls-files-data](https://chandoo.org/wp/wp-content/uploads/2008/09/sql-insert-update-query-from-csv-xls-files-data.png "sql-insert-update-query-from-csv-xls-files-data")
...
![sql-insert-update-query-from-csv-xls-files-final](https://chandoo.org/wp/wp-content/uploads/2008/09/sql-insert-update-query-from-csv-xls-files-final.png "sql-insert-update-query-from-csv-xls-files-final")

There are a few practical ways to improve this:

*   Cleaning up data using [countif(), sumif(), if() formulas](http://chandoo.org/wp/2008/06/09/what-the-if-learn-6-cool-things-you-can-do-with-excel-if-functions/)
...
*   [41 Comments](https://chandoo.org/wp/sql-insert-update-statements-from-csv-files/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/sql-insert-update-statements-from-csv-files/#respond)
    
*   Tagged under [development](https://chandoo.org/wp/tag/development/)
    , [howto](https://chandoo.org/wp/tag/howto/)
    , [Learn Excel](https://chandoo.org/wp/tag/excel/)
    , [Microsoft Excel Formulas](https://chandoo.org/wp/tag/formulas/)
    , [programming](https://chandoo.org/wp/tag/programming/)
    , [software](https://chandoo.org/wp/tag/software/)
...
[PrevPreviousWeekly Excel Links – Moved to Seattle Edition](https://chandoo.org/wp/weekly-excel-links-moved-to-seattle-edition/)

[NextGmail Labs 2 new useful features – Mark as Read, Label Auto SuggestNext](https://chandoo.org/wp/gmail-labs-2-new-useful-features-mark-as-read-label-auto-suggest/)
