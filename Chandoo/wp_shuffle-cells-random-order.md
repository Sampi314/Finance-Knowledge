# Shuffle a list of numbers / items in excel spreadsheet » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/shuffle-cells-random-order
...
![shuffle a list of numbers / items in random order in excel ](https://chandoo.org/wp/wp-content/uploads/2008/07/shuffle-list-random-order-spreadsheet.gif "shuffle-list-random-order-spreadsheet")
...
*   First insert a column next to the list you want to shuffle and enter random numbers in each cell in using `=rand()`. See below: ![shuffle-cells-using-random-excel-function](https://chandoo.org/wp/wp-content/uploads/2008/07/shuffle-cells-using-random-excel-function.gif "shuffle-cells-using-random-excel-function")
...
_**Like this? Also learn**_ [how to sort horizontally](http://chandoo.org/wp/2008/07/22/change-sort-orientation-excel-columns/)
, [fill only weekdays while auto-filling dates](http://chandoo.org/wp/2008/06/30/skip-weekends-while-autofill-dates-in-excel-howto/)
...
*   [50 Comments](https://chandoo.org/wp/shuffle-cells-random-order/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/shuffle-cells-random-order/#respond)
...
[PrevPreviousDear Microsoft, Blog is a real word](https://chandoo.org/wp/microsoft-add-blog-dictionary/)

[NextWhich teacher inspired you most?Next](https://chandoo.org/wp/randy-pausch-last-lecture/)
