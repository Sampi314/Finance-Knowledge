# Reverse a List in Excel - Howto? (using INDEX() Formula to reverse a list of values in Excel - Formula Tutorial)

**Source:** https://chandoo.org/wp/reverse-a-list-in-excel
...
![Reverse a list in excel - howto](https://chandoo.org/img/l/reverse-list-in-excel.png)Here is a simple yet novel use of formulas. Let us say you have a list of values in range A1:A5 and you want to reverse the list.
...
*   ROWS($A$1:A1) gives running numbers from 1 thru 5 when copied in any range of 5 cells. Read more on [using ROWS() formula](http://chandoo.org/wp/2009/08/17/rows-and-columns-excel-formulas/)
    .

**More on lists**: [Shuffle a list of numbers](http://chandoo.org/wp/2008/09/23/sort-in-random-order-excel-formulas/)
 | [Sort a list of texts using formulas](http://chandoo.org/wp/2008/10/22/sorting-text-in-excel-using-formulas/)
 |  [Remove duplicates from a list](http://chandoo.org/wp/2008/11/06/unique-duplicate-missing-items-excel-help/)
...
*   [30 Comments](https://chandoo.org/wp/reverse-a-list-in-excel/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/reverse-a-list-in-excel/#respond)
...
*   Tagged under [Excel Howtos](https://chandoo.org/wp/tag/excel-howtos/)
    ...
    , [reverse](https://chandoo.org/wp/tag/reverse/)
...
[PrevPreviousDownload Excel 2010 Beta today \[Office 2010 Updates\]](https://chandoo.org/wp/download-excel-2010-beta/)

[NextOne Hundred Project Managers have chosen to be better, what about you?Next](https://chandoo.org/wp/project-management-templates-100/)
