...
**Source:** https://chandoo.org/wp/excel-formulas-round-sort
...
![round-and-sort-using-excel-array-formulas](https://chandoo.org/wp/wp-content/uploads/2009/07/round-and-sort-array-formulas.png "round-and-sort-using-excel-array-formulas")  
...
*   \=SMALL(ROUNDDOWN($B$1:$B$9,0),ROW(B1)), array enter in cell C1 and drag in the entire range. _**Thanks to Chrisham**_.
*   Instead of using ROW() as Chrisham did above, we can also use ROWS() function. This will let you add rows on top without having to change formulas. _**Elias**_ recommends using this formula: =SMALL(INDEX(INT($C$3:$C$12),0),ROWS($D$3:D3)). **Thank you.**
*   _**Since we are only sorting numbers, it shouldn’t matter whether we sort and round or round and sort, as Jeff pointed.**_ So, we can use the normal formula =ROUNDDOWN(SMALL($B$3:$B$12,ROWS(B$3:B3)),0) in cell C3 and copy in the entire range. _**Thanks Jeff**_

More resources: **[Learn excel array formulas](http://chandoo.org/wp/tag/array-formulas)
** | **[Online Help on Excel Formulas](http://chandoo.org/excel-formulas/)
**
...
*   [31 Comments](https://chandoo.org/wp/excel-formulas-round-sort/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/excel-formulas-round-sort/#respond)
...
[PrevPreviousCreate a Combination Chart, Add Secondary Axis in Excel \[15 Second Tutorial\]](https://chandoo.org/wp/secondary-axis-combination-charts-howto/)

[NextProject Management: Show Milestones in a Timeline \[Part 3 of 6\]Next](https://chandoo.org/wp/project-milestones-in-timeline/)
...
1.  ![](https://secure.gravatar.com/avatar/009649ad2a9f58f64a563b208b196d4e78b4e506bf2eeb2ab4c84a820fd0aa0e?s=64&d=mm&r=g) Montu says:
    ...
    [Reply](https://chandoo.org/wp/excel-formulas-round-sort/#comment-2107616)
    ...
    *   ![](https://secure.gravatar.com/avatar/534f3043f65d0d27072d17a5dc64da8425eaf628f6915bb23d453d3f6cd3e5df?s=64&d=mm&r=g) [Chandoo](http://chandoo.org/wp)
        ...
        [Reply](https://chandoo.org/wp/excel-formulas-round-sort/#comment-2107623)
...
2.  ![](https://secure.gravatar.com/avatar/b466b5dcbff92562675873cda426fd5244289b247a4fa8c9018f1ab2867b509d?s=64&d=mm&r=g) [Raphael](http://nil/)
    ...
    [Reply](https://chandoo.org/wp/excel-formulas-round-sort/#comment-2122498)
