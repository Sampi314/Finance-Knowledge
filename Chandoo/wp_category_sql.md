# SQL Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/category/sql

---

All articles in 'SQL' Category
==============================

{ [**1** Comment](https://chandoo.org/wp/sql-vs-power-query/#comments)
 }

[SQL vs. Power Query – The Ultimate Comparison](https://chandoo.org/wp/sql-vs-power-query/ "SQL vs. Power Query – The Ultimate Comparison")

--------------------------------------------------------------------------------------------------------------------------------------------

Published on Oct 13, 2023 _in_ [Chandoo.org Podcast Sessions](https://chandoo.org/wp/category/podcast/)
, [Power Query](https://chandoo.org/wp/category/power-query/)
, [SQL](https://chandoo.org/wp/category/sql/)

[![SQL vs. Power Query – The Ultimate Comparison](https://chandoo.org/wp/wp-content/uploads/2023/10/sql-vs-powerquery-sqr.jpg)](https://chandoo.org/wp/sql-vs-power-query/ "SQL vs. Power Query – The Ultimate Comparison")

[https://traffic.libsyn.com/chandoo/CP104.mp3](https://traffic.libsyn.com/chandoo/CP104.mp3)

Podcast: [Play in new window](https://traffic.libsyn.com/chandoo/CP104.mp3 "Play in new window")
 | [Download](https://traffic.libsyn.com/chandoo/CP104.mp3 "Download")

Subscribe: [Apple Podcasts](https://itunes.apple.com/us/podcast/chandoo.org-podcast-become/id835954043?mt=2&ls=1#episodeGuid=https%3A%2F%2Fchandoo.org%2Fwp%2F%3Fp%3D17624 "Subscribe on Apple Podcasts")
...
[Continue »](https://chandoo.org/wp/sql-vs-power-query/)

{ [**23** Comments](https://chandoo.org/wp/learn-sql-for-data-analysis/#comments)
 }

[Learn SQL for Data Analysis in one hour](https://chandoo.org/wp/learn-sql-for-data-analysis/ "Learn SQL for Data Analysis in one hour")

-----------------------------------------------------------------------------------------------------------------------------------------

Published on Aug 23, 2022 _in_ [Learn Excel](https://chandoo.org/wp/category/excel/)
, [SQL](https://chandoo.org/wp/category/sql/)

[![Learn SQL for Data Analysis in one hour](https://chandoo.org/wp/wp-content/uploads/2022/08/SNAG-2251.png)](https://chandoo.org/wp/learn-sql-for-data-analysis/ "Learn SQL for Data Analysis in one hour")
...
[Continue »](https://chandoo.org/wp/learn-sql-for-data-analysis/)
