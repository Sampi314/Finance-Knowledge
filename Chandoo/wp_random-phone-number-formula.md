# Generating Random Phone Numbers for testing, coding purposes - Use Excel formuals

**Source:** https://chandoo.org/wp/random-phone-number-formula
...
![random-phone-number-generator-excel](https://chandoo.org/wp/wp-content/uploads/2008/11/random-phone-number-generator-excel.png "random-phone-number-generator-excel")Often when you are writing code or testing an application, it might be helpful to have random phone numbers generated for you.
...
Here is a [shared Google docs spreadsheet](http://spreadsheets.google.com/ccc?key=pMQawX6inE8pheacbPXnFQA)
 with 200 random phone numbers generated for you. I am not sure how often Google refreshes the formulas on shared workbooks, so please be patient if you see same numbers generated twice.
...
*   [13 Comments](https://chandoo.org/wp/random-phone-number-formula/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/random-phone-number-formula/#respond)
...
*   Tagged under [Analytics](https://chandoo.org/wp/tag/analytics/)
    ...
    , [test data](https://chandoo.org/wp/tag/test-data/)
    , [value()](https://chandoo.org/wp/tag/value/)
    
*   Category: [Analytics](https://chandoo.org/wp/category/analytics/)
    , [Learn Excel](https://chandoo.org/wp/category/excel/)
    

[PrevPreviousThe new Mac vs. PC web ad by Apple is really cool](https://chandoo.org/wp/the-new-mac-vs-pc-web-ad/)

[Next5 visualizations to inspire you \[Nov 21\]Next](https://chandoo.org/wp/5-visualizations-to-inspire-you/)
