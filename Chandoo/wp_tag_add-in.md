# add-in Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/tag/add-in

---

All articles with 'add-in' Tag
==============================

{ [**144** Comments](https://chandoo.org/wp/how-to-add-a-range-of-cells-in-excel-concat/#comments)
 }

[How to add a range of cells in excel – concat()](https://chandoo.org/wp/how-to-add-a-range-of-cells-in-excel-concat/ "How to add a range of cells in excel – concat()")

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Published on May 28, 2008 _in_ [hacks](https://chandoo.org/wp/category/hacks/)
...
[Continue »](https://chandoo.org/wp/how-to-add-a-range-of-cells-in-excel-concat/)
