# Super(b) Tuesday! » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/superb-tuesday
...
And you almost knew why it is a superb tuesday, well, we got Shimla delivered today. Still going through initial learning curve of getting used to mac. Here is the screen cap, isnt it looking gorgeous? We know :), but the important thing is the it feels gorgeous.

![Shimla Screen Cap](https://phd.images.googlepages.com/screen_cap.jpg)

PS: regular posting @ PHD should resume with immediate effect.
...
*   [Ask a question or say something...](https://chandoo.org/wp/superb-tuesday/#respond)
    
*   Tagged under [apple](https://chandoo.org/wp/tag/apple/)
    , [gadgets](https://chandoo.org/wp/tag/gadgets/)
    , [macbook](https://chandoo.org/wp/tag/macbook/)
    , [os x](https://chandoo.org/wp/tag/os-x/)
    , [personal](https://chandoo.org/wp/tag/personal/)
    , [shimla](https://chandoo.org/wp/tag/shimla/)
    
*   Category: [gadgets](https://chandoo.org/wp/category/gadgets/)
    , [personal](https://chandoo.org/wp/category/personal/)
    

[PrevPreviousProud owners of Macbook](https://chandoo.org/wp/proud-owners-of-macbook/)

[NextNationwide Paintbucket Guerrilla ad – nicely doneNext](https://chandoo.org/wp/nationwide-paintbucket-guerrilla-ad-nicely-done/)
