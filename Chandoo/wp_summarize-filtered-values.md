# Summarize only filtered values using SUBTOTAL & AGGREGATE formulas » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/summarize-filtered-values
...
![summarize-filtered-values-demo](https://chandoo.org/wp/wp-content/uploads/2015/08/summarize-filtered-values-demo.gif)

### Summarize filtered values using SUBTOTAL & AGGREGATE Formulas – video

You may watch this video on [our YouTube channel too](https://www.youtube.com/watch?v=pSSKh59Nbks)
.

### Download Example Workbook

[Please click here to download the example workbook](https://chandoo.org/wp/wp-content/uploads/2015/08/filtered-values.xlsx)
. Examine the formulas and play with filters to learn more.
...
*   [Introduction to SUBTOTAL Formula](http://chandoo.org/wp/2010/02/09/subtotal-formula-excel/)
    
*   [Introduction to Excel Slicers – Visual Filters](http://chandoo.org/wp/2015/06/24/introduction-to-slicers/)
    
*   [Make dynamic charts with filters](http://chandoo.org/wp/2009/02/12/make-a-dynamic-chart-using-data-filters/)
    

**Advanced Stuff:**

*   [How to count & sum filtered tables](http://chandoo.org/wp/2014/07/23/formula-forensics-no-037-how-to-count-and-sum-filtered-tables/)
    ,
*   [Count & sum with criteria on a filtered list](http://chandoo.org/wp/2012/06/07/formula-forensics-023/)
    
*   [Sum up top 3 filtered values using AGGREGATE](http://chandoo.org/wp/2013/05/17/sum-of-top-3-values-meeting-criteria/)
    
*   [Check if a table is filtered or not using formulas](http://chandoo.org/wp/2010/03/29/data-filter-formula-test/)
    
*   [Case study – Christmas shopping list](http://chandoo.org/wp/2009/12/07/christmas-gift-list/)
...
*   [4 Comments](https://chandoo.org/wp/summarize-filtered-values/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/summarize-filtered-values/#respond)
...
[PrevPreviousDynamic Print Areas](https://chandoo.org/wp/dynamic-print-areas/)

[NextHow to use GETPIVOTDATA with Excel Pivot TablesNext](https://chandoo.org/wp/getpivotdata-in-dashboards/)
