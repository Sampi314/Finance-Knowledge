# How to pick a random date? [Formulas] » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/random-dates
...
![Random Dates in Excel](https://chandoo.org/img/i/random-date-time.png)Often when you need to generate a sample from large data set, you may want to pick data from a random date. In such cases, you can use excel’s RAND() and RANDBETWEEN() formulas \[[syntax and help](http://chandoo.org/excel-formulas/rand.html "Excel RAND() formula - Syntax and help")\
...
[Random phone number](http://chandoo.org/wp/2008/11/20/random-phone-number-formula/)
 | [Shuffle a list](http://chandoo.org/wp/2008/07/28/shuffle-cells-random-order/)
 | [More on Random Formulas](http://chandoo.org/wp/?s=rand%28%29)

[More excel formula tutorials](http://chandoo.org/wp/tag/formulas/)

PS: If you are looking to pick _**up**_ a random date, what are you doing here?
...
*   [5 Comments](https://chandoo.org/wp/random-dates/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/random-dates/#respond)
...
[PrevPreviousChristmas Gift List – Set your budget and track gifts using Excel](https://chandoo.org/wp/christmas-gift-list/)

[NextUse CTRL+F1 to collapse ribbon \[super-mini-quick-tip\]Next](https://chandoo.org/wp/collapse-ribbon-office/)
