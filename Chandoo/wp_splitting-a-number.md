# Splitting a number into integer and decimal portions » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/splitting-a-number
...
![Splitting Numbers in to Decimal and Integer Portions using Excel](https://chandoo.org/img/q/splitting-numbers-using-excel.png)Here is a quick formula tip to start another awesome week.
...
_**These formulas work whenever my data has only positive numbers**_ (which is the case 90% 0f time). But if I am dealing with a mix of positive and negative numbers, I use,

*   Integer part ~\=INT(A1) +(A1<0)~\=TRUNC(A1,0) _\[thanks to **Somnath** for suggesting this\]_  
    
*   Decimal part =MOD(A1,SIGN(A1))

### What formulas do you use to process numbers?

I use a lot of formulas while working with numbers. But my favorite ones are [MOD](http://chandoo.org/excel-formulas/mod.html)
, [INT](http://chandoo.org/excel-formulas/int.html)
, SIGN, ABS, [RAND](http://chandoo.org/excel-formulas/rand.html)
 and RANDBETWEEN (new in Excel 2007, _requires Analysis toolpak in earlier versions_).

What about you? _**What formulas do you use and how do you process your numbers? Please share using comments.**_

**Learn more [quick tips](http://chandoo.org/wp/tag/quick-tip/)
 & [formula examples](http://chandoo.org/wp/tag/formulas/)
.**
...
*   [49 Comments](https://chandoo.org/wp/splitting-a-number/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/splitting-a-number/#respond)
    
*   Tagged under [INT()](https://chandoo.org/wp/tag/int/)
    , [Learn Excel](https://chandoo.org/wp/tag/excel/)
    , [Microsoft Excel Formulas](https://chandoo.org/wp/tag/formulas/)
    , [MOD()](https://chandoo.org/wp/tag/mod/)
    , [quick tip](https://chandoo.org/wp/tag/quick-tip/)
    , [sign](https://chandoo.org/wp/tag/sign/)
...
[PrevPreviousVLOOKUP Formula Cheat-sheet – FREE Download](https://chandoo.org/wp/download-vlookup-cheatsheet/)

[NextAn Excel Dashboard to Visualize 10,007 Comments \[Dashboard Tutorial\]Next](https://chandoo.org/wp/10k-comments-excel-dashboard/)
