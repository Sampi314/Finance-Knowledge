# Replace formulas with values with a simple wiggle » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/replace-formulas-with-values-with-a-simple-wiggle
...
(Earlier, we talked about [how to do this with keyboard](http://chandoo.org/wp/2013/11/11/replace-formulas-with-values/ "Replace formulas with values using this shortcut [quick tip]")
)
...
### ![Replace formulas with values using a simple wiggle trick](https://img.chandoo.org/q/replace%20formulas%20with%20values%20-%20tip.gif)Follow these steps
...
3.  Right click + Drag the selection a few cells away and drop them back at original place (_ie wiggle_)
...
*   [5 areas where mouse kicks keyboard’s butt](http://chandoo.org/wp/2009/03/02/using-mouse-excel/)
    
*   [Do you know these double click tricks](http://chandoo.org/wp/2009/06/12/excel-mouse-tricks/)
    
*   [Use mouse to edit formula ranges quickly](http://chandoo.org/wp/2009/05/05/edit-formulas-with-mouse/)
    
*   [Insert multiple columns at once with mouse](http://chandoo.org/wp/2013/01/15/insert-multiple-columns-excel-tip/)
    

### Say thanks to John if you like this tip

This is one of the most fun mouse shortcuts I have ever learned. Thanks to [John for teaching](http://chandoo.org/wp/2014/09/05/teach-me-something/#comment-691832)
 me this wiggle technique.

If you too enjoyed it, please say thanks to _John_.
...
*   [17 Comments](https://chandoo.org/wp/replace-formulas-with-values-with-a-simple-wiggle/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/replace-formulas-with-values-with-a-simple-wiggle/#respond)
    
*   Tagged under [mouse shortcuts](https://chandoo.org/wp/tag/mouse-shortcuts/)
    , [productivity](https://chandoo.org/wp/tag/productivity/)
    , [quick](https://chandoo.org/wp/tag/quick/)
    , [using excel](https://chandoo.org/wp/tag/using-excel/)
    
*   Category: [Excel Howtos](https://chandoo.org/wp/category/excel-howtos/)
    

[PrevPreviousTeach me (and rest of our community) something this Teachers’ Day](https://chandoo.org/wp/teach-me-something/)

[Next3D Max Formula for ExcelNext](https://chandoo.org/wp/3d-max-formula-for-excel/)
