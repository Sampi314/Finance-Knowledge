# Select Expressions to Find their Values [Macro Debugging Tip] » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/select-expressions-to-find-values-macro-debugging-tip
...
![Debug Expressions in VBA - Excel Macro Tip](https://chandoo.org/img/vba/debug-expressions-marco.gif)
...
![Adding Breakpoint - VBA](https://chandoo.org/img/vba/adding-breakpoint-vba.gif)
...
I am thinking of compiling all the debugging techniques people use in one post. _**So please share your tricks thru comments.**_

### Learn More:

*   [More articles on Macros](http://chandoo.org/wp/tag/macros/)
    
*   [More Excel Quick Tips](http://chandoo.org/wp/tag/quick-tip/)
    
*   [Debugging Excel Formulas](http://chandoo.org/wp/tag/debugging/)
...
*   [12 Comments](https://chandoo.org/wp/select-expressions-to-find-values-macro-debugging-tip/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/select-expressions-to-find-values-macro-debugging-tip/#respond)
...
[PrevPrevious7 Personal Expense Trackers using Excel – Download Today](https://chandoo.org/wp/download-expense-trackers/)

[NextIntroduction to Financial Modeling using Excel \[Part 1 of 6\]Next](https://chandoo.org/wp/financial-modeling-introduction/)
