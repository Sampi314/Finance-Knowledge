# Selective Sub-totals in Pivot Tables [Quick Tip] » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/selective-subtotals-in-pivot-tables
...
Recently I was creating a pivot report with multiple items in row labels area. I had to _**show sub-totals, but only for one of the fields**_. Something like this:

![selective-subtotals-excel-pivots](https://chandoo.org/wp/wp-content/uploads/2017/05/selective-subtotals-excel-pivots.png)
...
![disabling-subtotals-for-field](https://chandoo.org/wp/wp-content/uploads/2017/05/disabling-subtotals-for-field.png)  
Happy Pivoting. I am off to a short spin on my cycle before heading to work.

[Click here for more pivot table tips & tricks](http://chandoo.org/wp/excel-pivot-tables/)
.
...
*   [7 Comments](https://chandoo.org/wp/selective-subtotals-in-pivot-tables/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/selective-subtotals-in-pivot-tables/#respond)
...
[PrevPreviousAvoid Hiring Boo-boos with Excel – COUNTIFS for the win](https://chandoo.org/wp/avoid-hiring-boo-boos-with-excel-countifs-for-the-win-video/)

[NextStart your bar charts from zero – Excel geeks screaming at you from mountain topNext](https://chandoo.org/wp/start-your-bar-charts-from-zero/)
