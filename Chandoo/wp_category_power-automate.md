# Power Automate Archives » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/category/power-automate

---

All articles in 'Power Automate' Category
=========================================

{ [**2** Comments](https://chandoo.org/wp/send-email-from-excel-with-office-scripts-power-automate/#comments)
 }

[Send Email from Excel with Office Scripts & Power Automate](https://chandoo.org/wp/send-email-from-excel-with-office-scripts-power-automate/ "Send Email from Excel with Office Scripts & Power Automate")

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Published on Mar 21, 2023 _in_ [Automation](https://chandoo.org/wp/category/automation/)
...
[![Send Email from Excel with Office Scripts & Power Automate](https://chandoo.org/wp/wp-content/uploads/2023/03/SNAG-2544.png)](https://chandoo.org/wp/send-email-from-excel-with-office-scripts-power-automate/ "Send Email from Excel with Office Scripts & Power Automate")

Do you have an Excel report or graphs that need to be emailed to various people every month? We can use Excel automation features to do this task quite easily. The inspiration – A client request for Excel Email Solution The idea for this came from a recent project I did for a client. They \[…\]

[Continue »](https://chandoo.org/wp/send-email-from-excel-with-office-scripts-power-automate/)
