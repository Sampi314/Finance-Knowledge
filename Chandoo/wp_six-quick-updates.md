# Six Quick Updates » Chandoo.org - Learn Excel, Power BI & Charting Online

**Source:** https://chandoo.org/wp/six-quick-updates
...
During last few weeks, I have spent several hours organizing all the VBA material on Chandoo.org. I am happy to announce our brand to [**Excel VBA area of the site**](http://chandoo.org/wp/excel-vba/ "Excel VBA - Information, Examples, Resources & Downloads")
.

This section has [Excel VBA overview](http://chandoo.org/wp/excel-vba/ "Excel VBA – Information, Tutorials, Examples & Resources")
, [examples](http://chandoo.org/wp/excel-vba/examples/ "Excel VBA Examples")
, [videos](http://chandoo.org/wp/excel-vba/videos/ "Excel VBA Videos & Tutorials")
, [tips](http://chandoo.org/wp/excel-vba/vba-tips/ "Excel VBA Tips & Tricks")
, [books](http://chandoo.org/wp/excel-vba/books/ "Recommended Excel VBA Books")
, [references](http://chandoo.org/wp/excel-vba/references/ "References on Excel VBA")
 & more. _Check it out._

### Improved Chandoo.org Homepage

One of my goals for 2012 is to improve the navigability of Chandoo.org so that new visitors & regulars can become awesome in Excel faster. As the first step in this direction, I have added a welcome navigation area to our home page. You can see it in action on [**our home page**](http://chandoo.org/wp/)
.
...
Ok, this is available for a while. But not many of you know. So here we go. You can find a ton of useful information, tips, examples & downloads on [**our Excel Pivot Tables page**](http://chandoo.org/wp/excel-pivot-tables/)
.
...
[**Click here to join our VBA classes**](http://chandoo.org/wp/vba-classes/)
.
...
*   [4 Comments](https://chandoo.org/wp/six-quick-updates/#comments)
    
*   [Ask a question or say something...](https://chandoo.org/wp/six-quick-updates/#respond)
...
[PrevPreviousFinding Friday the 13th using Excel (and learning cool formulas along way)](https://chandoo.org/wp/finding-friday-the-13th-excel/)

[NextFormula Forensics. 009 – Pradhishnair’s Chainage ProblemNext](https://chandoo.org/wp/formula-forensics-no-009-2/)
