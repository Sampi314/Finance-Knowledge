# Operating Income Template - Download Free Excel Template

**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/operating-income-template
...
This is what the operating income template looks like:

![Operating Income Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/00203-Operating-Income-Example.png)
...
Operating income, also referred to as [Earnings Before Interest & Taxes (EBIT)](https://corporatefinanceinstitute.com/resources/valuation/ebit/)
, is the amount of revenue left after deducting the operational direct and indirect costs from sales revenue. This can also be computed using gross income less depreciation, amortization, and operating expenses not directly attributable to the production of goods. Interest expense, interest income, and other non-operational revenue sources are not considered in computing for operating income.
...
Another way to calculate income from operations is to start at the bottom of the income statement at Net Earnings and then add back interest expense and taxes.  This is a common method used by an analyst to calculate [EBIT](https://corporatefinanceinstitute.com/resources/valuation/ebit/)
, which can then be used for valuation in the [EV/EBIT ratio](https://corporatefinanceinstitute.com/resources/valuation/comparable-company-analysis/)
.
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Foperating-income-template%2F&summary=Operating+Income+Template "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Foperating-income-template%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Operating+Income+Template&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Foperating-income-template%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Foperating-income-template%2F&summary=Operating+Income+Template "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/operating-income-template/ "Copy link")
