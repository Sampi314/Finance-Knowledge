# Sensitivity Analysis Table Template - Download

**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/sensitivity-analysis-table-template
...
Below is a screenshot of the sensitivity analysis table template:

![Sensitivity Analysis Table Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/00049-Sensitivity-Analysis-Table.png)
...
Sensitivity Analysis is a tool used in [financial modeling](https://corporatefinanceinstitute.com/resources/financial-modeling/what-is-financial-modeling/)
 to analyze how the different values of a set of independent variables affect a specific dependent variable under certain specific conditions. In general, Sensitivity Analysis is used in a wide range of fields – from biology and geography to economics and engineering.

A Financial Sensitivity Analysis, also known as a What-If analysis or a What-If simulation exercise, is most commonly used by [financial analysts](https://corporatefinanceinstitute.com/resources/financial-modeling/analyst-trifecta-ebook-pdf/)
 to predict the outcome of a specific action when performed under certain conditions. It is done within defined boundaries that are determined by the set of independent (input) variables.
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fsensitivity-analysis-table-template%2F&summary=Sensitivity+Analysis+Table+Template "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fsensitivity-analysis-table-template%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Sensitivity+Analysis+Table+Template&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fsensitivity-analysis-table-template%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fsensitivity-analysis-table-template%2F&summary=Sensitivity+Analysis+Table+Template "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/sensitivity-analysis-table-template/ "Copy link")
