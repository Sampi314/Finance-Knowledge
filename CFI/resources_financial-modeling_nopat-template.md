# NOPAT Template - Download Free Excel Template

**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/nopat-template
...
The following NOPAT template shows you how to calculate the net operating profit after tax using the income statement.

Below is a preview of the NOPAT template:

![NOPAT Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/00236-NOPAT-Template.png)

### Download the Free NOPAT Template

   Download NowDownload Now

  
NOPAT stands for **N**et **O**perating **P**rofit **A**fter **T**ax and represents a company’s theoretical income from operations if it had no debt (no interest expense). NOPAT is used to make companies more [comparable](https://corporatefinanceinstitute.com/resources/valuation/comparable-company-analysis/)
 by removing the impact of their capital structure.  In this way, it’s easier to compare two companies in the same industry (i.e., one with no leverage and the other with significant leverage).
...
, Net Operating Profit After Tax is used as the starting point for calculating unlevered free cash flow (a.k.a. free cash flow to the firm, FCFF).
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnopat-template%2F&summary=NOPAT+Template "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnopat-template%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=NOPAT+Template&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnopat-template%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fnopat-template%2F&summary=NOPAT+Template "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/nopat-template/ "Copy link")
