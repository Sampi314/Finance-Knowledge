...
**Source:** https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt

---

Table of Contents

*   [What is Distressed Debt?](https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt#what-is-distressed-debt)
    

*   [How Does Distressed Debt Arise?](https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt#how-does-distressed-debt-arise)
    
*   [When are Securities Classified as Distressed?](https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt#when-are-securities-classified-as-distressed)
    
*   [Rate of Return](https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt#rate-of-return)
    
*   [Why Invest in Distressed Debt?](https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt#why-invest-in-distressed-debt)
    
*   [Tips for Investing in Distressed Debt](https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt#tips-for-investing-in-distressed-debt)
    
*   [Applications in Financial Modeling](https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt#applications-in-financial-modeling)
    
*   [Learn More](https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt#learn-more)
    

Distressed Debt
===============

Debt of a company that is likely to default
...
Distressed debt refers to the securities of a government or company that has either defaulted, is under bankruptcy protection, or is in financial distress and moving toward the aforementioned situations in the near future. It includes all credit instruments that are trading at a significant discount and have a spread substantially wider than the industry average.

Distressed debt is a part of the [leveraged](https://corporatefinanceinstitute.com/resources/knowledge/finance/leverage-ratios/)
 and high-yield loan market, and is rated below investment grade debt. The most common distressed debt securities are bank debt, bonds, trade claims, and [common](https://corporatefinanceinstitute.com/resources/equities/what-is-a-stock/)
 and [preferred shares.](https://corporatefinanceinstitute.com/resources/valuation/cost-of-preferred-stock/)

![distressed debt investor](https://cdn.corporatefinanceinstitute.com/assets/distressed-debt.jpeg)

### How Does Distressed Debt Arise?

So circling back to our question: What is distressed debt? Distressed [debt](https://corporatefinanceinstitute.com/resources/fixed-income/fixed-income-trading/)
 is not issued deliberately by an entity – it is only issued when the entity is in a situation of financial distress due to the [market economy](https://corporatefinanceinstitute.com/resources/economics/definition-market-economy/)
 or industry-wide trends, internal mismanagement, or both.
...
Furthermore, fixed income securities having a yield-to-maturity that is 1000 [basis points](https://corporatefinanceinstitute.com/resources/knowledge/finance/basis-points-bps-definition/)
 greater than the risk-free rate of return are classified as distressed debt (Note: a related category, stressed debt, has a yield-to-maturity that is 600-800 basis points greater than the risk-free rate of return).

### Rate of Return

Distressed debt is sold for a very small fraction of its [par value](https://corporatefinanceinstitute.com/resources/accounting/par-value-overview/)
 and offers a rate of return 1000 [basis points](https://corporatefinanceinstitute.com/resources/knowledge/finance/basis-points-bps-definition/)
 higher than the risk-free rate of return. This is because distressed debt is a high risk/high return debt security. Given the financially distressed position of the issuer, the potential for default is high.
...
So what is distressed debt used for in terms of investments? Distressed debt firms become a major creditor of the distressed issuer by purchasing a large number of the issuer’s securities. They then have the leverage to prescribe the terms for the reorganization.

If the reorganization is successful, they get a positive return on investment. Should the company be liquidated, distressed debt firms may recover the entire amount invested because they are entitled to be repaid before equity holders.

[Hedge funds](https://corporatefinanceinstitute.com/resources/career-map/sell-side/capital-markets/hedge-fund-strategies/)
, mutual funds, brokerage firms, specialized debt funds (like Collateralized Loan Obligations), and [private equity](https://corporatefinanceinstitute.com/resources/career-map/buy-side/private-equity/)
 firms are the dominant players in this market. Thus, only investors with a high appetite for risk should invest in distressed securities. However, it should be noted that distressed stocks are riskier than distressed senior debt instruments.
...
*   Complete understanding of bankruptcies, [restructuring](https://corporatefinanceinstitute.com/)
    , and [reorganization](https://corporatefinanceinstitute.com/resources/valuation/type-a-reorganization/)
    .
*   [Credit research](https://corporatefinanceinstitute.com/resources/career/credit-analyst-job-description/)
     platform consisting of experienced and well-informed analysts.
...
For professionals in investment banking or other areas of corporate finance, it’s important to factor in the impact of financial distress on the entire capital structure of a firm.  In order to do this, an analyst must build a [financial model](https://corporatefinanceinstitute.com/resources/financial-modeling/what-is-financial-modeling/)
 to fully capture the impact.

Below is an example of a financial model showing the balance sheet of the business.

![](https://cdn.corporatefinanceinstitute.com/assets/financial-model.png)

### Learn More

Learn more about financial modeling in our online [financial analyst courses](https://corporatefinanceinstitute.com/collections/)
, and see the CFI resources below for more information on debt and risk.

*   [Risk Averse](https://corporatefinanceinstitute.com/resources/wealth-management/risk-averse-definition/)
    
*   [Distressed Securities](https://corporatefinanceinstitute.com/resources/fixed-income/distressed-securities/)
    
*   [Liquidation Value](https://corporatefinanceinstitute.com/resources/valuation/liquidation-value/)
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffixed-income%2Fwhat-is-distressed-debt%2F&summary=Distressed+Debt "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffixed-income%2Fwhat-is-distressed-debt%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Distressed+Debt&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffixed-income%2Fwhat-is-distressed-debt%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffixed-income%2Fwhat-is-distressed-debt%2F&summary=Distressed+Debt "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/fixed-income/what-is-distressed-debt/ "Copy link")
