# Salvage Value Template - Download Free Excel Template

**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/salvage-value-template
...
This salvage value template shows the calculation of the salvage value of equipment.

Here is what the salvage value template looks like:

![Salvage Value Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/00179-Salvage-Value.png)
...
Salvage value is the estimated amount that an [asset](https://corporatefinanceinstitute.com/resources/valuation/net-identifiable-assets/)
 is worth at the end of its useful life. It is also known as scrap value or residual value and is used to determine the annual [depreciation](https://corporatefinanceinstitute.com/resources/financial-modeling/depreciation-schedule/)
 of an asset.

The [Internal Revenue Service (IRS)](https://www.irs.gov/)
 requires companies to estimate a “reasonable” salvage value. The value depends on how long the company expects to use the asset and how hard the asset is used. For example, if a company sells an asset before its useful life, a higher value can be justified. Typically, companies would set a salvage value of zero on assets that are used for a long time and are inexpensive (5-year-old printer, 4-year-old laptop, etc.).
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fsalvage-value-template%2F&summary=Salvage+Value+Template "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fsalvage-value-template%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Salvage+Value+Template&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fsalvage-value-template%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Fsalvage-value-template%2F&summary=Salvage+Value+Template "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/salvage-value-template/ "Copy link")
