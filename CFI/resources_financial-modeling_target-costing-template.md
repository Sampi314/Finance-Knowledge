# Target Costing Template - Download Free Excel Template

**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/target-costing-template
...
![Target Costing Template Screenshot](https://cdn.corporatefinanceinstitute.com/assets/00201-Target-Costing-Example.png)

### Download the Free Template

   Download NowDownload Now

Target costing is a management technique where prices are determined by market conditions brought about by several factors – such as homogeneous products, level of competition, no/low [switching costs](https://corporatefinanceinstitute.com/resources/accounting/cost-of-goods-manufactured-cogm/)
 for the end customer, etc. When these factors come into the picture, management wants to control the costs, as they have little or no control over the [selling price](https://corporatefinanceinstitute.com/resources/accounting/cost-of-goods-sold-cogs/)
.
...
[![Financial Analyst certification curriculum](https://corporatefinanceinstitute.com/resources/financial-modeling/target-costing-template)](https://corporatefinanceinstitute.com/certifications/financial-modeling-valuation-analyst-fmva-program/)
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Ftarget-costing-template%2F&summary=Target+Costing+Template "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Ftarget-costing-template%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Target+Costing+Template&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Ftarget-costing-template%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Ftarget-costing-template%2F&summary=Target+Costing+Template "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/target-costing-template/ "Copy link")
