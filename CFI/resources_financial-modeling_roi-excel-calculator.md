# Return on Investment Excel Calculator - Free excel Calculator

**Source:** https://corporatefinanceinstitute.com/resources/financial-modeling/roi-excel-calculator

---

Return on Investment Excel Calculator
=====================================

The benefit from investing in a certain resource
...
This Return on Investment Excel Calculator will aid you in calculating the return on investment for different scenarios. Return on investment is one of the most important profitability ratios to assess a company’s performance.

Here is a snippet of the template:

![Return on Investment Excel Calculator](https://cdn.corporatefinanceinstitute.com/assets/ROI-Calculator-.png)

### Download the Free Template

   Download NowDownload Now

CFI is a global provider of [financial modeling courses](https://corporatefinanceinstitute.com/collections/)
 and [financial analyst certification](https://corporatefinanceinstitute.com/certifications/financial-modeling-valuation-analyst-fmva-program/)
. To learn more about evaluating investments, see the following additional resources:

### The Return on Investment (ROI) formula:

![Return on Investment Formula](https://cdn.corporatefinanceinstitute.com/assets/return-on-investment-formula.png)

Where “Gain from Investment” refers to the money generated from the sale of the investment or the increase in the value of the investment regardless of whether it is sold or not.

The Return on Investment Excel calculator will be a great tool to visualize how changing different elements of the Return on Investment calculation affects its final outcome.
...
*   [Transaction Document Templates](https://corporatefinanceinstitute.com/topic/career/)
...
[![Financial Analyst certification curriculum](https://corporatefinanceinstitute.com/resources/financial-modeling/roi-excel-calculator)](https://corporatefinanceinstitute.com/certifications/financial-modeling-valuation-analyst-fmva-program/)
...
*   Share this article
*   [![Share on LinkedIn](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Froi-excel-calculator%2F&summary=Return+on+Investment+Excel+Calculator "Share on LinkedIn")
    
*   [![Share on Facebook](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Froi-excel-calculator%2F "Share on Facebook")
    
*   [![Share on Twitter](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://twitter.com/intent/tweet?text=Return+on+Investment+Excel+Calculator&url=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Froi-excel-calculator%2F "Share on Twitter")
    
*   [![Share on WhatsApp](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://wa.me/?text=https%3A%2F%2Fcorporatefinanceinstitute.com%2Fresources%2Ffinancial-modeling%2Froi-excel-calculator%2F&summary=Return+on+Investment+Excel+Calculator "Share on WhatsApp")
    
*   [![Copy link](data:image/svg+xml,<svg id="L4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 32 32" xml:space="preserve"></svg>)](https://corporatefinanceinstitute.com/resources/financial-modeling/roi-excel-calculator/ "Copy link")
