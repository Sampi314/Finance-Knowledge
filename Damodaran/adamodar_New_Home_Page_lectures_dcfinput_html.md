...
**Source:** https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/dcfinput.html
...
**_Models of Risk and Return  
The Capital Asset Pricing Model_**
...
**_Beta:_** The non-diversifiable risk for any asset can be measured by the covariance of its returns with returns on a market index, which is defined to be the asset's beta.  
...
_Using the Capital Asset Pricing Model_

_\* Inputs required to use the CAPM -_  
...
_Practical issues in using the CAPM --  
1\. Measurement of the risk premium_
...
_Magnitude of the risk premium_
...
_A Warning: If you add a default premium to the risk premium, do not add a risk premium to the risk free rate. That would be double counting.  
_
...
_Illustration 3: Using the CAPM to calculate cost of equity_  
...
*   Wellcome is planning an acquisition of Glaxo. Wellcome has a beta of 0.65. Which beta would you use in valuing Glaxo?

* * *

  

_Determinants of Betas_

_I. Type of Business:_  
...
*   Pharmaceutical companies are increasingly looking at expanding into biotechnology, either through acquisitions or through projects. Biotechnology firms have an average beta of 1.8. What would the impact of these actions be on pharmaceutical firmsí betas?

* * *

  
  
_II. Degree of Operating Leverage:_  
...
*   Sticking again with pharmaceutical firms, there are some firms which have very high fixed costs, either because they focus heavily on research, or because of the nature of their business. (Synergen, for instance, had a beta of 1.65 in 1994. It had research and development expenses which were 670% of sales in 1994.) These firms will have higher betas than other firms which have more traditional cost structures. (Wellcome is a good example.)

* * *

  
  
_III. Financial Leverage:_  
...
_Illustration 4: Effects of Financial Leverage on Betas_  
...
_Other approaches to estimating Betas_

_I. Using comparable firms:_  
...
_Illustration 5: Using comparable firms to estimate betas_  
...
_II. Using fundamental factors:_  
...
_Illustration 6: Using fundamental information to predict betas_  
...
**_The Arbitrage Pricing Model_**

\* Logic behind the arbitrage pricing model (APM) same as the logic behind the CAPM, i.e., _investors get rewarded for taking on non-diversifiable risk_.  
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image12.gif)  
...
_Using the Arbitrage Pricing Model_

_Illustration 7: Using the APM to estimate the cost of equity_  
...
_Considerations on the use of the APM_
...
**_Multi-factor Models for risk and return_**
...
_Illustration 8: Using the Dividend Growth Model to estimate the cost of equity: Southwestern Bell_  
...
**_Definition of the Weighted Average Cost of Capital (WACC)_**  
...
_Illustration 9: Calculating the Cost of Capital: Genzyme Corporation._  
...
**_Cash flows to Equity for a Levered Firm_**  
...
**_Levered Firm at Desired Leverage_**  
...
_Illustration 10: Estimating the cash flow to equity for a firm at its desired leverage: Warner-Lambert_  
  
The following is an estimation of free cash flows to equity for Warner-Lambert in 1994 and for 1995 (projected).

*   The company had $1.5 billion in debt outstanding and $ 9 billion in market value of equity, leading to a debt to capital ratio (ìdebt ratioî) of 14%. This debt ratio is assumed to be stable. (How does one know?)
*   The company reported net income of $695 million in 1994 and is projected to have a net income of $765 million in 1995.
*   The company reported depreciation of $180 million in 1994 and is expected to have depreciation of $200 million in 1995.
*   The company had capital expenditures of $362 million in 1994 and is expected to have capital expenditures of $400 million in 1995.
*   The companyís working capital increased to $225 million in 1994 from $203 million in 1993. It is expected to maintain working capital at the same percentage of sales in 1995, and sales are expected to increase from $6420 million in 1994 to $7100 million in 1995.
...
| \- ( Change in Working Capital) (1-DR) | $ 18.92 | $ 20.50 | (DR = 14%) |
| FCFE | $ 519.56 | $ 572.50 |     |
...
_Illustration 11: Sensitivity to Debt Ratio - Warner Lambert Corporation_  
...
| \- ( Change in Working Capital) (1-DR) | $ 13.20 | $ 14.30 | (DR = 40%) |
| FCFE | $ 572.60 | $ 630.70 |     |
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image13.gif)  
...
_Illustration 12: Estimating the expected cash flow to the firm - Siemens_  
...
_Illustration 13: The Effect of Inflation on Cash flows and Discount Rates_  
...
|     |     |     |     |     |
| --- | --- | --- | --- | --- |
|     | _Real Cash flows_ |     | _Nominal Cash flows_ |     |
| _Year_ | _CF to Equity_ | _Terminal Value_ | _Nominal Cash flows_ | _Terminal Value_ |
| 1   | $105 |     | $108 |     |
| 2   | $110 |     | $117 |     |
...
_Illustration 13A: The Effect of mismatching cash flows and discount rates_

|     |     |     |     |     |
| --- | --- | --- | --- | --- |
|     | _Real Cash flows@ Nominal rate_ |     | _Nominal Cash flows@ Real rate_ |     |
| _Year_ | _CF to Equity_ | _Terminal Value_ | _Nominal Cash flows_ | _Terminal Value_ |
| 1   | $105 |     | $108 |     |
| 2   | $110 |     | $117 |     |
...
_Illustration 14: Effect of personal taxes on cash flows and discount rates: Eli Lilly_  
...
|     |     |     |     |     |
| --- | --- | --- | --- | --- |
|     | _Before personal taxes_ |     | _After personal taxes_ |     |
| _Year_ | _Dividends per share_ | _Terminal price_ | _Dividends per share_ | _Terminal price_ |
| 1   | $2.27 |     | $1.36 |     |
| 2   | $2.60 |     | $1.56 |     |
| 3   | $2.98 |     | $1.79 |     |
| 4   | $3.41 |     | $2.05 |     |
...
**_I. Estimating and Using Historical Growth Rates_**
...
_Illustration 15: Using arithmetic average versus geometric average: Autodesk_  
...
_Illustration 16: Sensitivity of historical growth rates to the length of the estimation period: Glaxo_  
...
_Illustration 17: Linear and Log-linear models of growth: Glaxo Inc._  
...
_Dealing with negative earnings_  
...
_Illustration 18: Dealing with negative earnings: Sterling Chemicals._  
  
The following series lists earnings per share from 1988 to 1994 for Sterling Chemicalsñ

|     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- |
| Time (t) | Year | EPS | log(EPS) | Growth Rate | Modified Growth Rate |
| 1   | 1988 | $3.56 | 1.27 |     |     |
| 2   | 1989 | $1.77 | 0.57 | \-50.28% | \-50.28% |
| 3   | 1990 | $1.07 | 0.07 | \-39.55% | \-39.55% |
| 4   | 1991 | $0.67 | \-0.40 | \-37.38% | \-37.38% |
| 5   | 1992 | $0.08 | \-2.53 | \-88.06% | \-88.06% |
| 6   | 1993 | ($0.10) | NMF | \-225.00% | \-225.00% |
| 7   | 1994 | $0.34 | \-1.08 | \-440.00% | 129.41% |

  
  
_Approach 1:_ Using the slope coefficient from the linear regression  
...
_Approach 2:_ Using the minimum or maximum of earnings as the denominator  
  
Arithmetic average, using modified growth rates = - 51.81%  
  
_Illustration 19: The Effect of size on growth: Amgen_  
...
|     |     |     |     |
| --- | --- | --- | --- |
| _Year_ | _Net Income_ | _% Growth Rate_ | _Æ Net Income_ |
| 1989 | $19.10 |     |     |
...
**_II. Analystsí Forecasts Of Earnings: How Good Are They?_**  
...
_Mean Relative Absolute Error_  
  
_Study Analyst Group Analyst Mechanical_  
...
_Are some analysts more equal than others?_  
...
*   On average, analysts affect stock prices with their recommendations; Buy recommendations affect prices less than sell recommendations. The prices tend to drift back to their original levels.
*   The recommendations made by the ëbestí analysts (Institutional Investorís All American Analysts) have a greater impact on stock prices (3% on buys; 4.7% on sells). For these recommendations the price changes are sustained, and they continue to rise in the following period (2.4% for buys; 13.8% for the sells).

  
  
**_III. Expected Growth And Fundamentals_**  
  
**_Retention Ratio and Return on Equity_**  
...
_Illustration 20: Changes in ROE and growth rates: Merck Inc._  
...
**_Return on Assets, Profit Margin and Asset Turnover_**  
...
_Illustration 22: Evaluating the effects of corporate strategy on growth rate and value: Procter and Gamble_  
...
_1992 After shift in strategy_  
...
_Growth Rate 10.66% 10.74%  
  
Illustration 23: Adjusting inputs for firm type: Neutrogena Inc._  
...
_Illustration 24: Weighting based upon standard deviations: Autodesk Inc._  
...
_Historical EPS Analyst Estimates_
