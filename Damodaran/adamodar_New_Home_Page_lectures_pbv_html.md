...
**Source:** https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/pbv.html
...
**_Book Value versus Market Value_**
...
**_Advantages of using price/book value ratios_**
...
**_Disadvantages of using price-book value ratios_**
...
**_PBV Ratio for a stable firm_**

The value of equity for a stable firm, using the Gordon growth model is:

![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image68.gif)

Defining the return on equity (ROE) = EPS0 / Book Value of Equity, the value of equity can be written as:

![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image69.gif)  
  
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image70.gif)

If the return on equity is based upon expected earnings in the next time period, this can be simplified to,

![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image71.gif)  
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image72.gif)
...
_Illustration 13: Estimating the PBV ratio for a stable firm with dividends- Amoco_  
...
_P/BV and ROE for Oil Companies - 1995_
...
_Illustration 14: Estimating the price-book value ratio for a 'privatization' candidate - Jenapharm (Germany)_
...
**_PBV Ratio for a high growth firm_**
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image73.gif)
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image74.gif)

_Illustration 15: Estimating the PBV ratio for a high growth firm in the two-stage model_  
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image75.gif)  
  
The estimated PBV ratio for this firm is 7.89.  
  
_Illustration 16: Estimating the Price/Book Value Ratio for a high growth firm - Bertelsmann AG  
  
_Bertelsmann AG is a German publishing company which is involved in a wide range of media.  
  
_High Growth Period Stable Growth Period_  
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image76.gif)

**_PBV Ratios and Return on Equity_**
...
_Illustration 17: Return on Equity and Price-Book Value_  
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image77.gif)  
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image78.gif)
...
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image79.gif)  
  
Note that when the return on equity is equal to the required return, the price is equal to the book value.  
  
![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image80.gif)

_Looking for undervalued securities - PBV Ratios and ROE_
...
_![](https://pages.stern.nyu.edu/~adamodar/New_Home_Page/lectures/Image82.gif)_

_A Simple Control for ROE ñ PBV / ROE_

A simple way of controlling for differences in Return on Equity is to calculate the ratio of P/BV ratios to return on equity, and ranking firms on that basis. Using that approach, the financial service firms which had the lowest PBV/ROE ratios were ñ

|     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
| _MOST OVERVALUED FIRMS_ |     |     |     | _MOST UNDERVALUED FIRMS_ |     |     |     |
| _Company Name_ | _ROE_ | _P/BV_ | _PBV/ROE_ | _Company Name_ | _ROE_ | _P/BV_ | _PBV/ROE_ |
| MIDLANTIC CORP. | 6.5 | 1.28 | 0.19692308 | MORGAN (J.P.) | 17.5 | 1.15 | 0.06571429 |
| CHASE | 5.7 | 0.95 | 0.16666667 | PNC BANK CORP. | 17.2 | 1.18 | 0.06860465 |
| WELLS FARGO | 14.2 | 2.2 | 0.15492958 | CHEMICAL BANK. | 14.1 | 0.97 | 0.06879433 |
| U.S. TRUST | 18.5 | 2.56 | 0.13837838 | BANKAMERICA | 11.4 | 1   | 0.0877193 |
| SUNTRUST BANKS | 13.1 | 1.64 | 0.12519084 | FIRST UNION CRP | 15.7 | 1.38 | 0.08789809 |

  

  
**Estimating price-book value ratios from comparables**

_Year Regression R squared_  
  
1987 PBV = 0.1841 + .00200 PAYOUT - 0.3940 BETA + 1.3389 EGR + 9.35 ROE 0.8617  
  
1988 PBV = 0.7113 + 0.00007 PAYOUT - 0.5082 BETA + 0.4605 EGR + 6.9374 ROE 0.8405  
  
1989 PBV = 0.4119 + 0.0063 PAYOUT - 0.6406 BETA + 1.0038 EGR+ 9.55 ROE 0.8851  
  
1990 PBV = 0.8124 + 0.0099 PAYOUT - 0.1857 BETA + 1.1130 EGR+ 6.61 ROE 0.8846  
  
1991 PBV =1.1065 + 0.3505 PAYOUT - 0.6471 BETA + 1.0087 EGR + 10.51 ROE 0.8601  
  
where,  
  
PBV = Price / Book Value Ratio at the end of the year PAYOUT = Dividend Payout ratio at end of the year  
  
BETA = Beta of the stock EGR = Growth rate in earnings over prior five years  
  
ROE = Return on Equity = Net Income / Book Value of Equity  
  
1995 Regression: PBV = 0.4138 + 0.3194 PAYOUT - 0.3418 BETA + 0.3549 EGR+ 14.75 ROE R2\=0.7726  
  
EGR = Expected earnings growth rate over next five years  
  
_Illustration 19 : Valuing aan initial public offering using the cross-sectional regression_  
  
Assume that you had been asked to value Semitool, a company which manufactures equipment used in the fabrication of semiconductors early in 1995 and that you had obtained the following data on the company:  
  
Book Value of Equity = $ 29.60 million  
  
Net Income in 1994 = $3.60 million  
  
Beta based upon comparable firms = 1.40 (This is the average beta for comparable firms)  
  
Free Cash Flow to Equity in 1994 = - 2.50 million  
  
Expected growth rate over next five years = 20%  
  
First compute the variables in the desired units,  
  
Payout = 0% (Assume that this company will not pay dividends) Earnings Growth Rate = 20%  
  
Return on Equity = 3.60/29.60 = 12.16% Beta = 1.40  
  
Predicted PBV Ratio = 0.4138 + 0.3194(0) - 0.3418 (1.40) + 0.3549 (.20)+ 14.75 (.1216) = 1.80  
  
Predicted Market Value of Equity in Semitool Inc. = 1.80 \* $ 29.60 million= $53.28 million  

**Price-Book Value Ratios and Investment Strategies**

**_Price-Book Value Ratios and Excess Returns_**

*   Several studies have established a relationship between price-book value ratios and excess returns.
*   The discussion in the preceding section emphasized the importance of return on equity in determining the price/book value ratio, and noted that only firms with high return on equity and low price-book value ratio could be considered undervalued.
*   This proposition was tested by screening all NYSE stocks from 1981 to 1990, on the basis of both price-book value ratios and returns on equity and creating two portfolios - an 'undervalued' portfolio with low price-book value ratios (in bottom 25% of universe) and high returns on equity (in top 25% of universe) and an overvalued portfolio with high price-book value ratios (in top 25% of universe) and low returns on equity (in bottom 25%)- each year, and then estimating excess returns on each portfolio in the following year.
*   The undervalued portfolio made an average return on 25.60% over the ten year period compared to the S&P 500 return of 17.49%. The overvalued portfolio made 10.61% annually.