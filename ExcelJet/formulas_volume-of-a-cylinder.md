...
**Source:** https://exceljet.net/formulas/volume-of-a-cylinder

---

[Skip to main content](https://exceljet.net/formulas/volume-of-a-cylinder#main-content)

[](https://exceljet.net/formulas/volume-of-a-cylinder#)

*   [Previous](https://exceljet.net/formulas/volume-of-a-cone)
    
*   [Next](https://exceljet.net/formulas/volume-of-a-rectangular-prism)
...
![Excel formula: Volume of a cylinder](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/volume%20of%20a%20cylinder.png "Excel formula: Volume of a cylinder")

Summary
-------

To calculate the volume of a cylinder, you can use the [PI function](https://exceljet.net/functions/pi-function)
...
which returns the volume of a cylinder with the radius given in column B and the height given in column C. Units are indicated generically with "u", and the resulting volume is units cubed (u3).
