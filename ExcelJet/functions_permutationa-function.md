# Excel PERMUTATIONA function | Exceljet

**Source:** https://exceljet.net/functions/permutationa-function

---

[Skip to main content](https://exceljet.net/functions/permutationa-function#main-content)

[](https://exceljet.net/functions/permutationa-function#)

*   [Previous](https://exceljet.net/functions/permut-function)
    
*   [Next](https://exceljet.net/functions/phi-function)
...
![Excel PERMUTATIONA function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet%20permutationa.png "Excel PERMUTATIONA function")

Summary
-------

The Excel PERMUTATIONA function returns the number of permutations (combinations where order is significant) for a given number of items. The PERMUTATIONA function _allows_ repetitions. To calculate the number of permutations _without_ repetitions, use the [PERMUT function](https://exceljet.net/functions/permut-function)
.
...
A permutation is a combination where order matters. In other words, a permutation is an _ordered_ combination. There are two types of permutations:

1.  Permutations where repetition _is not_ allowed (i.e. 123)
2.  Permutations where repetition _is_ allowed (i.e. 333)

The PERMUTATIONA function calculates permutations where repetitions _are_ allowed. To calculate permutations where repetitions are _not_ allowed, use the [PERMUT function](https://exceljet.net/functions/permut-function)
.

### Example

To use PERMUTATIONA, specify the total number of items and "_number\_chosen_", which represents the number of items in each combination. For -example, to calculate 3-number permutations for the numbers 0-9, there are 10 numbers and 3 chosen, so the formula is:
...
*   [Microsoft PERMUTATIONA function documentation](https://support.office.com/en-us/article/permutationa-function-6c7d7fdc-d657-44e6-aa19-2857b25cae4e)
