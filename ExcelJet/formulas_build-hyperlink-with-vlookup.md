...
**Source:** https://exceljet.net/formulas/build-hyperlink-with-vlookup

---

[Skip to main content](https://exceljet.net/formulas/build-hyperlink-with-vlookup#main-content)

[](https://exceljet.net/formulas/build-hyperlink-with-vlookup#)

*   [Previous](https://exceljet.net/formulas/bmi-calculation-formula)
    
*   [Next](https://exceljet.net/formulas/calculate-a-ratio-from-two-numbers)
...
![Excel formula: Build hyperlink with VLOOKUP](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/build%20hyperlink%20with%20VLOOKUP.png "Excel formula: Build hyperlink with VLOOKUP")
...
The hyperlink function allows you to create a working link with a formula. It takes two arguments: **link\_location** and, optionally, **friendly\_name**.

Working from the inside out, VLOOKUP looks up and retrieves a link value from column 2 of the named range "link\_table" (B5:C8). The lookup value comes from column E, and VLOOKUP is configured for exact match.

The result is fed into HYPERLINK as **link\_location**, and the text in column E is used for **friendly\_name**.
