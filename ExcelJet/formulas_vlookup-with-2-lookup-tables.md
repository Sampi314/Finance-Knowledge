...
**Source:** https://exceljet.net/formulas/vlookup-with-2-lookup-tables

---

[Skip to main content](https://exceljet.net/formulas/vlookup-with-2-lookup-tables#main-content)

[](https://exceljet.net/formulas/vlookup-with-2-lookup-tables#)

*   [Previous](https://exceljet.net/formulas/vlookup-variable-commission-split)
    
*   [Next](https://exceljet.net/formulas/vlookup-with-multiple-criteria)
...
![Excel formula: VLOOKUP with 2 lookup tables](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/VLOOKUP%20with%20two%20lookup%20tables.png "Excel formula: VLOOKUP with 2 lookup tables")
