# Gantt chart - Excel formula | Exceljet

**Source:** https://exceljet.net/formulas/gantt-chart

---

[Skip to main content](https://exceljet.net/formulas/gantt-chart#main-content)

[](https://exceljet.net/formulas/gantt-chart#)

*   [Previous](https://exceljet.net/formulas/find-duplicate-values-in-two-columns)
    
*   [Next](https://exceljet.net/formulas/gantt-chart-by-week)
...
![Excel formula: Gantt chart](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/conditional%20formatting%20gantt%20chart.png "Excel formula: Gantt chart")
...
The trick with this approach is the calendar header (row 4), which is just a series of valid dates, formatted with the [custom number format](https://exceljet.net/articles/custom-number-formats)
 "d". With a static date in D4, you can use =D4+1 to populate the calendar. This makes it easy to set up a conditional formatting rule that compares the date associated with each column with the dates in columns B and C.
...
_Note: both conditions use [mixed references](https://exceljet.net/glossary/mixed-reference)
 to ensure that the references update correctly as conditional formatting is applied to the calendar grid._
