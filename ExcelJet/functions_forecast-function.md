...
**Source:** https://exceljet.net/functions/forecast-function

---

[Skip to main content](https://exceljet.net/functions/forecast-function#main-content)

[](https://exceljet.net/functions/forecast-function#)

*   [Previous](https://exceljet.net/functions/expondist-function)
    
*   [Next](https://exceljet.net/functions/forecast.ets-function)
...
![Excel FORECAST function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/forecast%20function.png "Excel FORECAST function")
...
_Note: Starting with Excel 2016, the FORECAST function was replaced with the [FORECAST.LINEAR function](https://exceljet.net/functions/forecast.linear-function)
. Microsoft recommends replacing FORECAST with FORECAST.LINEAR, since FORECAST will eventually be deprecated._
...
. With these inputs, the FORECAST function returns 1505.36 in cell D13. As the formula is copied down the table, FORECAST returns predicted values in D13:D16, using values in column B for x.
...
*   If _x_ is not numeric, FORECAST returns a #VALUE! error.
*   If _known\_ys_ and _known\_xs_ are not the same size, FORECAST will return an #N/A error.
*   If the variance of _known\_x_ values is zero, FORECAST will return a #DIV/0! error.
...
*   [Microsoft FORECAST function documentation](https://support.office.com/en-us/article/forecast-function-50ca49c9-7b40-4892-94e4-7ad38bbeda99)
