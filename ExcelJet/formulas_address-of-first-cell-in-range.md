# Address of first cell in range - Excel formula | Exceljet

**Source:** https://exceljet.net/formulas/address-of-first-cell-in-range

---

[Skip to main content](https://exceljet.net/formulas/address-of-first-cell-in-range#main-content)

[](https://exceljet.net/formulas/address-of-first-cell-in-range#)

*   [Previous](https://exceljet.net/formulas/add-row-numbers-and-skip-blanks)
    
*   [Next](https://exceljet.net/formulas/address-of-last-cell-in-range)
...
![Excel formula: Address of first cell in range](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/address%20of%20first%20cell%20in%20range.png "Excel formula: Address of first cell in range")
...
The [ADDRESS function](https://exceljet.net/functions/address-function)
 creates a reference based on a given row and column number. In this case, we want to get the first row and the first column used by the [named range](https://exceljet.net/glossary/named-range)
 **data** (B5:D14). To get the first row used, we use the [ROW function](https://exceljet.net/functions/row-function)
...
To get the first column, we use the [COLUMN function](https://exceljet.net/functions/column-function)
 in the same way:
...
Although it's not obvious, the [INDEX function](https://exceljet.net/functions/index-function)
 ...
 with INDEX to get the address of the first cell in a range like this:
...
>  that can cause performance problems in large or complex workbooks._
