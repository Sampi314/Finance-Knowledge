# Volume of a cone - Excel formula | Exceljet

**Source:** https://exceljet.net/formulas/volume-of-a-cone

---

[Skip to main content](https://exceljet.net/formulas/volume-of-a-cone#main-content)

[](https://exceljet.net/formulas/volume-of-a-cone#)

*   [Previous](https://exceljet.net/formulas/surface-area-of-a-sphere)
    
*   [Next](https://exceljet.net/formulas/volume-of-a-cylinder)
...
![Excel formula: Volume of a cone](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/volume%20of%20a%20cone.png "Excel formula: Volume of a cone")

Summary
-------

To calculate the volume of a cone, you can use the [PI function](https://exceljet.net/functions/pi-function)
...
The formula for calculating the volume of a cone is based on the formula for calculating the volume of a pyramid. Since the base of a cone is a circular, the formula for [area of a circle](https://exceljet.net/formulas/area-of-a-circle)
 is included.
...
Rewriting the formula for volume of a cone with Excel's [math operators](https://exceljet.net/glossary/math-operators)
, we get:
