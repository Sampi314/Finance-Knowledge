# Excel SKEW function | Exceljet

**Source:** https://exceljet.net/functions/skew-function

---

[Skip to main content](https://exceljet.net/functions/skew-function#main-content)

[](https://exceljet.net/functions/skew-function#)

*   [Previous](https://exceljet.net/functions/rank.eq-function)
    
*   [Next](https://exceljet.net/functions/skew.p-function)
...
[SKEW.P](https://exceljet.net/functions/skew.p-function)

![Excel SKEW function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet%20skew%20function.png "Excel SKEW function")
...
Excel also contains the SKEW.P function, which measures _population_ skewness. The difference in calculation is related to an adjustment (n-1) made when data represents a sample versus the entire population. [More details here](https://exceljet.net/formulas/standard-deviation-calculation)
.

Related functions
-----------------

[![Excel SKEW.P function](https://exceljet.net/sites/default/files/styles/card/public/images/functions/main/exceljet%20skew.p%20function.png "Excel SKEW.P function")](https://exceljet.net/functions/skew.p-function)

### [SKEW.P Function](https://exceljet.net/functions/skew.p-function)
...
*   [Microsoft SKEW function documentation](https://support.office.com/en-us/article/skew-function-bdf49d86-b1ef-4804-a046-28eaea69c9fa)
