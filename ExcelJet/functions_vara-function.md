# Excel VARA function | Exceljet

**Source:** https://exceljet.net/functions/vara-function

---

[Skip to main content](https://exceljet.net/functions/vara-function#main-content)

[](https://exceljet.net/functions/vara-function#)

*   [Previous](https://exceljet.net/functions/var.s-function)
    
*   [Next](https://exceljet.net/functions/varp-function)
...
![Excel VARA function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_vara.png "Excel VARA function")
...
Like [VAR](https://exceljet.net/functions/var-function)
, VARA also evaluates logical values, and text representations of numbers when they are hardcoded directly into the function as arguments.
...
*   [Microsoft VARA function documentation](https://support.office.com/en-us/article/vara-function-3de77469-fa3a-47b4-85fd-81758a1e1d07)
