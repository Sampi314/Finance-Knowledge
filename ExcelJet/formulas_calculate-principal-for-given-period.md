# Calculate principal for given period - Excel formula | Exceljet

**Source:** https://exceljet.net/formulas/calculate-principal-for-given-period

---

[Skip to main content](https://exceljet.net/formulas/calculate-principal-for-given-period#main-content)

[](https://exceljet.net/formulas/calculate-principal-for-given-period#)

*   [Previous](https://exceljet.net/formulas/calculate-periods-for-annuity)
    
*   [Next](https://exceljet.net/formulas/calculate-simple-interest)
...
![Excel formula: Calculate principal for given period](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/Calculate%20principal%20for%20given%20period.png "Excel formula: Calculate principal for given period")

Summary
-------

To calculate the principal portion of a loan payment in a given period, you can use the [PPMT function](https://exceljet.net/functions/ppmt-function)
...
With these inputs, the PPMT function returns 74.465, which is automatically rounded to $74.47 when the [Currency number format](https://exceljet.net/videos/how-to-use-currency-formatting-in-excel)
 is applied.
