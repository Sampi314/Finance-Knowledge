...
**Source:** https://exceljet.net/functions/dmax-function

---

[Skip to main content](https://exceljet.net/functions/dmax-function#main-content)

[](https://exceljet.net/functions/dmax-function#)

*   [Previous](https://exceljet.net/functions/dget-function)
    
*   [Next](https://exceljet.net/functions/dmin-function)
...
![Excel DMAX function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_dmax.png "Excel DMAX function")
...
*   DMAX supports some [wildcards](https://exceljet.net/glossary/wildcard)
     in criteria
...
*   [Microsoft DMAX function documentation](https://support.office.com/en-us/article/dmax-function-f4e8209d-8958-4c3d-a1ee-6351665d41c2)
