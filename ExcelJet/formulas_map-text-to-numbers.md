# Map text to numbers - Excel formula | Exceljet

**Source:** https://exceljet.net/formulas/map-text-to-numbers

---

[Skip to main content](https://exceljet.net/formulas/map-text-to-numbers#main-content)

[](https://exceljet.net/formulas/map-text-to-numbers#)

*   [Previous](https://exceljet.net/formulas/map-inputs-to-arbitrary-values)
    
*   [Next](https://exceljet.net/formulas/running-count-group-by-n-size)
...
![Excel formula: Map text to numbers](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/formulas/map%20text%20to%20numbers.png "Excel formula: Map text to numbers")
