...
**Source:** https://exceljet.net/functions/imsum-function

---

[Skip to main content](https://exceljet.net/functions/imsum-function#main-content)

[](https://exceljet.net/functions/imsum-function#)

*   [Previous](https://exceljet.net/functions/imsub-function)
    
*   [Next](https://exceljet.net/functions/imtan-function)
...
[IMSUB](https://exceljet.net/functions/imsub-function)
...
![Excel IMSUM function](https://exceljet.net/sites/default/files/styles/original_with_watermark/public/images/functions/main/exceljet_imsum_function_0.png "Excel IMSUM function")
...
The IMSUM function takes in two or more arguments in the form _inumber1_, _inumber2_, _inumber3,_ and so on. Arguments can be hard-coded values, cell references, or a range. Use the IMSUM function in a range like this:
...
![Visualization of complex addition by adding the arrows representing complex numbers tip-to-tail together.](https://exceljet.net/sites/default/files/images/functions/inline/ComplexAddition.png "Visualization of complex addition.")

_Image courtesy of_ [_wumbo.net_](https://wumbo.net/)
_._  
 
...
[![Excel IMSUB function](https://exceljet.net/sites/default/files/styles/card/public/images/functions/main/exceljet_imsub_function.png "Excel IMSUB function")](https://exceljet.net/functions/imsub-function)

### [IMSUB Function](https://exceljet.net/functions/imsub-function)
...
*   [Microsoft IMSUM function documentation](https://support.office.com/en-us/article/imsum-function-81542999-5f1c-4da6-9ffe-f1d7aaa9457f)
